    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                ...
                & (
                    dataframe["rsi"]
                    < (dataframe["resample_{}_rsi".format(self.get_ticker_indicator() * 3)] - 5)
                )
                & (dataframe["volume"] > 0)
            ),
            "enter_long",
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                ...
                & (
                    dataframe["rsi"]
                    > dataframe["resample_{}_rsi".format(self.get_ticker_indicator() * 6)]
                )
                & (
                    dataframe["rsi"]
                    > dataframe["resample_{}_rsi".format(self.get_ticker_indicator() * 10)]
                )
                & (dataframe["volume"] > 0)
            ),
            "exit_long",
