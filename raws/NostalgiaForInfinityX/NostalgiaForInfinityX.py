...
class NostalgiaForInfinityX(IStrategy):
    ...
    def sell_r(
        ...
        if 0.01 > current_profit > 0.001:
            if (
                (last_candle["r_96"] < -90.0)
                and (last_candle["rsi_14"] < 39.0)
                and (last_candle["cmf"] < -0.3)
                and (last_candle["cmf_15m"] < -0.1)
                ...
                and (last_candle["r_96"] < -90.0)
                and (last_candle["sma_200_dec_20"])
                and (last_candle["cmf_15m"] < -0.3)
                and (last_candle["rsi_14_1h"] < 40.0)
            ):
                return True, "sell_profit_w_0_2"
            elif (
                (last_candle["rsi_14"] < 28.0)
                and (last_candle["cmf"] < -0.5)
                and (last_candle["cmf_15m"] < -0.0)
                and (last_candle["cmf_1h"] < -0.0)
    ...
    def normal_tf_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe["bb20_width"] = (dataframe["bb20_2_upp"] - dataframe["bb20_2_low"]) / dataframe[
            "bb20_2_mid"
        ]
        dataframe["bb20_delta"] = (dataframe["bb20_2_low"] - dataframe["bb20_3_low"]) / dataframe[
            "bb20_2_low"
        ]
        ...
        for index in self.buy_protection_params:
            ...
            if self.buy_params[f"buy_condition_{index}_enable"]:
                ...
                # Condition #10 - Semi swing. Local dip.
                    ...
                    item_buy_logic.append(dataframe["ema_26"] > dataframe["ema_12"])
                    item_buy_logic.append(
                        (dataframe["ema_26"] - dataframe["ema_12"]) > (dataframe["open"] * 0.017)
                    )
                    item_buy_logic.append(
                        (dataframe["ema_26"].shift() - dataframe["ema_12"].shift())
                        > (dataframe["open"] / 100)
                ...
                # Condition #20 - Semi swing. Uptrend. Local dip.
                    ...
                    # Logic
                    item_buy_logic.append(
                        dataframe["close"].shift(1) < (dataframe["sma_15"].shift(1) * 0.942)
                    )
                ...
                # Condition #22 - Swing. Uptrend. Bounce from daily support level
                    ...
                    item_buy_logic.append(
                        dataframe["open_sha_1d"].shift(288) < dataframe["close_sha_1d"].shift(288)
                    )
                    item_buy_logic.append(
                        dataframe["pivot_1d"] > dataframe["pivot_1d"].shift(288) * 0.95
                    )
                ...
                # reverse deadfish
                    ...
                    item_buy_logic.append(
                        dataframe["volume_mean_12"] > dataframe["volume_mean_24"] * 1.59
                    )
                ...
                # Condition #43 - 15m. Semi swing. Local dip. 1h uptrend.
                    ...
                    item_buy_logic.append(
                        dataframe["bb40_2_delta_15m"].gt(dataframe["close_15m"] * 0.045)
                    )
                    item_buy_logic.append(
                        dataframe["closedelta_15m"].gt(dataframe["close_15m"] * 0.034)
                    )
                    item_buy_logic.append(
                        dataframe["tail_15m"].lt(dataframe["bb40_2_delta_15m"] * 0.18)
                    )
                    item_buy_logic.append(
                        dataframe["close_15m"].lt(dataframe["bb40_2_low_15m"].shift())
                    )
                ...
                # Condition #44 - 15m. Semi swing. Local deeper dip. 15m uptrend.
                    ...
                    # Non-Standard protections
                    item_buy_logic.append(
                        dataframe["ema_200_15m"] > (dataframe["ema_200_15m"].shift(36) * 1.01)
                    )
                ...
                # Condition #55 - 15m. Semi swing. Uptrend. Local dip.
                    ...
                    item_buy_logic.append(
                        dataframe["close_15m"] > (dataframe["close_15m"].shift(3))
                    )
                    item_buy_logic.append(
                        dataframe["close_15m"].shift(3)
                        < (dataframe["bb20_2_low_15m"].shift(3) * 0.986)
                    )
                ...
                # Condition #57 - 15m. Semi swing. Strong uptrend. Local dip. BTC not downtrend.
                    ...
                    item_buy_logic.append(
                        dataframe["close_15m"].shift(3) < (dataframe["sma_30_15m"].shift(3) * 0.988)
                    )
                    item_buy_logic.append(
                        dataframe["close_15m"].shift(3)
                        < (dataframe["bb20_2_low_15m"].shift(3) * 0.996)
                    )
                ...
                # Condition #58 - Semi swing. Local dip.
                    ...
                    item_buy_logic.append(dataframe["bb20_width"] > 0.095)
                    item_buy_logic.append(
                        dataframe["close_delta"] > dataframe["close"] * 10.0 / 1000.0
                    )
