...
class ClucHAnix_BB_RPB_MOD_CTT(IStrategy):
    ...
    clucha_rocr_1h = DecimalParameter(
        0.1, 1.0, default=buy_params["clucha_rocr_1h"], decimals=5, space="entry", optimize=True
    )
    ...
    lambo1_rsi_4_limit = IntParameter(
        5, 60, default=buy_params["lambo1_rsi_4_limit"], space="entry", optimize=True
    )
    lambo1_rsi_14_limit = IntParameter(
        5, 60, default=buy_params["lambo1_rsi_14_limit"], space="entry", optimize=True
    )
    ...
    lambo2_rsi_4_limit = IntParameter(
        5, 60, default=buy_params["lambo2_rsi_4_limit"], space="entry", optimize=True
    )
    lambo2_rsi_14_limit = IntParameter(
        5, 60, default=buy_params["lambo2_rsi_14_limit"], space="entry", optimize=True
    )

    # local_uptrend
    local_trend_ema_diff = DecimalParameter(
        0, 0.2, default=buy_params["local_trend_ema_diff"], space="entry", optimize=True
    )
    local_trend_bb_factor = DecimalParameter(
        0.8, 1.2, default=buy_params["local_trend_bb_factor"], space="entry", optimize=True
    )
    local_trend_closedelta = DecimalParameter(
        5.0, 30.0, default=buy_params["local_trend_closedelta"], space="entry", optimize=True
    )

    # ewo_1 and ewo_low
    ewo_candles_buy = IntParameter(
        2, 30, default=buy_params["ewo_candles_buy"], space="entry", optimize=True
    )
    ewo_candles_sell = IntParameter(
        2, 35, default=buy_params["ewo_candles_sell"], space="entry", optimize=True
    )
    ewo_low_offset = DecimalParameter(
        0.7, 1.2, default=buy_params["ewo_low_offset"], decimals=5, space="entry", optimize=True
    )
    ewo_high_offset = DecimalParameter(
        0.75, 1.5, default=buy_params["ewo_high_offset"], decimals=5, space="entry", optimize=True
    )
    ewo_high = DecimalParameter(
        2.0, 15.0, default=buy_params["ewo_high"], space="entry", optimize=True
    )
    ewo_1_rsi_14 = IntParameter(
        10, 100, default=buy_params["ewo_1_rsi_14"], space="entry", optimize=True
    )
    ewo_1_rsi_4 = IntParameter(
        1, 50, default=buy_params["ewo_1_rsi_4"], space="entry", optimize=True
    )
    ewo_low_rsi_4 = IntParameter(
        1, 50, default=buy_params["ewo_low_rsi_4"], space="entry", optimize=True
    )
    ...
    cofi_ema = DecimalParameter(
        0.6, 1.4, default=buy_params["cofi_ema"], space="entry", optimize=True
    )
    cofi_fastk = IntParameter(
        1, 100, default=buy_params["cofi_fastk"], space="entry", optimize=True
    )
    cofi_fastd = IntParameter(
        1, 100, default=buy_params["cofi_fastd"], space="entry", optimize=True
    )
    cofi_adx = IntParameter(1, 100, default=buy_params["cofi_adx"], space="entry", optimize=True)
    cofi_ewo_high = DecimalParameter(
        1.0, 15.0, default=buy_params["cofi_ewo_high"], space="entry", optimize=True
    )

    # nfi32
    nfi32_rsi_4 = IntParameter(
        1, 100, default=buy_params["nfi32_rsi_4"], space="entry", optimize=True
    )
    nfi32_rsi_14 = IntParameter(
        1, 100, default=buy_params["nfi32_rsi_4"], space="entry", optimize=True
    )
    nfi32_sma_factor = DecimalParameter(
        0.7, 1.2, default=buy_params["nfi32_sma_factor"], decimals=5, space="entry", optimize=True
    )
    nfi32_cti_limit = DecimalParameter(
        -1.2, 0, default=buy_params["nfi32_cti_limit"], decimals=5, space="entry", optimize=True
    )
    ...
    antipump_threshold = DecimalParameter(
        0, 0.4, default=buy_params["antipump_threshold"], space="entry", optimize=True
    )

    ewo_1_enabled = BooleanParameter(
        default=buy_params["ewo_1_enabled"], space="entry", optimize=True
    )
    ewo_low_enabled = BooleanParameter(
        default=buy_params["ewo_low_enabled"], space="entry", optimize=True
    )
    cofi_enabled = BooleanParameter(
        default=buy_params["cofi_enabled"], space="entry", optimize=True
    )
    lambo1_enabled = BooleanParameter(
        default=buy_params["lambo1_enabled"], space="entry", optimize=True
    )
    lambo2_enabled = BooleanParameter(
        default=buy_params["lambo2_enabled"], space="entry", optimize=True
    )
    local_trend_enabled = BooleanParameter(
        default=buy_params["local_trend_enabled"], space="entry", optimize=True
    )
    nfi32_enabled = BooleanParameter(
        default=buy_params["nfi32_enabled"], space="entry", optimize=True
    )
    clucha_enabled = BooleanParameter(
        default=buy_params["clucha_enabled"], space="entry", optimize=True
    )
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe["vroc_bool"] = (dataframe["avg_volume"] > dataframe["avg_volume"].shift(1)) & (
            dataframe["close"] > dataframe["close"].shift(1)
        )
        dataframe["vroc"] = np.where(
            dataframe["vroc_bool"] is True,
            (
                (dataframe["avg_volume"] - dataframe["avg_volume"].shift(1))
                * (100 / dataframe["avg_volume"].shift(1))
            ),
            0,
        )
        ...
        dataframe["recent_pump"] = (
            (dataframe["vroc_normalized"].rolling(96).max() > 90)
            | (dataframe["vroc_normalized"].rolling(48).max() > 10)
            | (dataframe["vroc_normalized"].rolling(24).max() > 5)
        ) & (dataframe["vroc_bool"] is True)
        ...
        dataframe["norm_perc"] = (dataframe["perc"] - dataframe["perc"].rolling(50).min()) / (
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        is_btc_safe = (
            (
                pct_change(dataframe["btc_1d"], dataframe["btc_1m"]).fillna(0)
        ...
        ewo_1 = (
            ...
            & (
                dataframe["close"]
                < (dataframe[f"ma_buy_{self.ewo_candles_buy.value}"] * self.ewo_low_offset.value)
            )
        ...
        dataframe.loc[
            # is_btc_safe &  # broken?
            # is_pump_safe &
            reduce(lambda x, y: x | y, conditions), "entry"
        ] = 1
...
class ClucHAnix_BB_RPB_MOD_CTT_DTB(ClucHAnix_BB_RPB_MOD_CTT):
    ...
    debug_mode = True
    trailing_buy_max_stop = (
        0.01  # stop trailing buy if current_price > starting_price * (1+trailing_buy_max_stop)
    )
