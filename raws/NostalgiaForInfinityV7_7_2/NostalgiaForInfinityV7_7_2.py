...
try:
    ...
    log.error(
        "IMPORTANT - please install the pandas_ta python module which is needed for this strategy. If you're running Docker, add RUN pip install pandas_ta to your Dockerfile, otherwise run: pip install pandas_ta"
    )
else:
        ...
        for index in self.buy_protection_params:
            ...
            if self.buy_params["buy_condition_" + str(index) + "_enable"]:
                ...
                # Condition #23
                    ...
                    # Logic
                    item_buy_logic.append(
                        dataframe["close"] < (dataframe["bb20_2_low"] * self.buy_23_bb_offset)
                    )
