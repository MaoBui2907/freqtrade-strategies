...
class NostalgiaForInfinityV4(IStrategy):
    ...
    sell_rsi_diff_5 = DecimalParameter(
        0.0, 20.0, default=4.382, space="exit", optimize=False, load=True
    )
    ...
    sell_custom_rsi_0 = DecimalParameter(
        30.0, 40.0, default=30.0, space="exit", decimals=3, optimize=False, load=True
    )
    ...
    sell_custom_under_profit_2 = DecimalParameter(
        0.01, 0.10, default=0.035, space="exit", decimals=3, optimize=False, load=True
    )
