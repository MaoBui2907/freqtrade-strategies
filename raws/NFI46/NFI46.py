...
class NFI46(IStrategy):
    ...
    buy_rsi_1h_max_1 = DecimalParameter(
        70.0, 90.0, default=80.0, space="entry", decimals=1, optimize=False, load=True
    )
    ...
    buy_mfi_1 = DecimalParameter(
        20.0, 56.0, default=26.0, space="entry", decimals=1, optimize=False, load=True
    )
    ...
    buy_rsi_1h_min_2 = DecimalParameter(
        30.0, 40.0, default=36.0, space="entry", decimals=1, optimize=False, load=True
    )
    buy_rsi_1h_max_2 = DecimalParameter(
        70.0, 95.0, default=90.0, space="entry", decimals=1, optimize=False, load=True
    )
    buy_rsi_1h_diff_2 = DecimalParameter(
        30.0, 50.0, default=34.0, space="entry", decimals=1, optimize=False, load=True
    )
    buy_mfi_2 = DecimalParameter(
        30.0, 65.0, default=56.0, space="entry", decimals=1, optimize=False, load=True
    )
    buy_bb_offset_2 = DecimalParameter(
        0.97, 0.99, default=0.983, space="entry", decimals=3, optimize=False, load=True
    )
    ...
    buy_bb20_close_bblowerband_4 = DecimalParameter(
        0.9, 0.99, default=0.979, space="entry", optimize=False, load=True
    )
    buy_bb20_volume_4 = IntParameter(16, 35, default=18, space="entry", optimize=False, load=True)

    buy_volume_5 = DecimalParameter(
        1.0, 10.0, default=6.0, space="entry", decimals=1, optimize=False, load=True
    )
    ...
    buy_volume_6 = DecimalParameter(
        1.0, 10.0, default=1.5, space="entry", decimals=1, optimize=False, load=True
    )
    buy_ema_open_mult_6 = DecimalParameter(
        0.03, 0.04, default=0.025, space="entry", decimals=3, optimize=False, load=True
    )
    buy_bb_offset_6 = DecimalParameter(
        0.98, 0.999, default=0.995, space="entry", decimals=3, optimize=False, load=True
    )
    ...
    buy_rsi_8 = DecimalParameter(
        30.0, 50.0, default=46.0, space="entry", decimals=1, optimize=False, load=True
    )
    ...
    buy_volume_9 = DecimalParameter(
        1.0, 4.0, default=2.0, space="entry", decimals=2, optimize=False, load=True
    )
    buy_ma_offset_9 = DecimalParameter(
        0.94, 0.99, default=0.958, space="entry", decimals=3, optimize=False, load=True
    )
    buy_bb_offset_9 = DecimalParameter(
        0.97, 0.99, default=0.984, space="entry", decimals=3, optimize=False, load=True
    )
    ...
    buy_mfi_9 = DecimalParameter(
        36.0, 65.0, default=56.0, space="entry", decimals=1, optimize=False, load=True
    )

    buy_volume_10 = DecimalParameter(
        1.0, 26.0, default=23.0, space="entry", decimals=1, optimize=False, load=True
    )
    buy_ma_offset_10 = DecimalParameter(
        0.93, 0.97, default=0.94, space="entry", decimals=3, optimize=False, load=True
    )
    ...
    buy_rsi_1h_10 = DecimalParameter(
        20.0, 40.0, default=39.0, space="entry", decimals=1, optimize=False, load=True
    )

    buy_ma_offset_11 = DecimalParameter(
        0.93, 0.99, default=0.938, space="entry", decimals=3, optimize=False, load=True
    )
    ...
    buy_rsi_1h_max_11 = DecimalParameter(
        70.0, 90.0, default=82.0, space="entry", decimals=1, optimize=False, load=True
    )
    buy_rsi_11 = DecimalParameter(
        30.0, 48.0, default=46.0, space="entry", decimals=1, optimize=False, load=True
    )
    ...
    buy_ewo_13 = DecimalParameter(
        -14.0, -7.0, default=-7.9, space="entry", decimals=1, optimize=False, load=True
    )
    ...
    buy_bb_offset_14 = DecimalParameter(
        0.98, 1.0, default=0.992, space="entry", decimals=3, optimize=False, load=True
    )
    buy_ma_offset_14 = DecimalParameter(
        0.93, 0.99, default=0.998, space="entry", decimals=3, optimize=False, load=True
    )

    buy_ema_open_mult_15 = DecimalParameter(
        0.02, 0.04, default=0.026, space="entry", decimals=3, optimize=False, load=True
    )
    buy_ma_offset_15 = DecimalParameter(
        0.93, 0.99, default=0.985, space="entry", decimals=3, optimize=False, load=True
    )
    buy_rsi_15 = DecimalParameter(
        30.0, 50.0, default=32.0, space="entry", decimals=1, optimize=False, load=True
    )
    ...
    buy_ma_offset_16 = DecimalParameter(
        0.93, 0.97, default=0.95, space="entry", decimals=3, optimize=False, load=True
    )
    buy_rsi_16 = DecimalParameter(
        26.0, 50.0, default=38.0, space="entry", decimals=1, optimize=False, load=True
    )
    buy_ewo_16 = DecimalParameter(
        4.0, 8.0, default=3.6, space="entry", decimals=1, optimize=False, load=True
    )
