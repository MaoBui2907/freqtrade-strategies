...
class NASOSv4(IStrategy):
    ...
    profit_threshold = DecimalParameter(
        1.0, 1.03, default=buy_params["profit_threshold"], space="entry", optimize=True
    )
    ...
    pHSL = DecimalParameter(
        -0.200, -0.040, default=-0.15, decimals=3, space="exit", optimize=False, load=True
    )
    ...
    pSL_1 = DecimalParameter(
        0.008, 0.020, default=0.014, decimals=3, space="exit", optimize=False, load=True
    )

    # profit threshold 2, SL_2 is used
    pPF_2 = DecimalParameter(
        0.040, 0.100, default=0.024, decimals=3, space="exit", optimize=False, load=True
    )
    pSL_2 = DecimalParameter(
        0.020, 0.070, default=0.022, decimals=3, space="exit", optimize=False, load=True
    )
