...
class NFI47V2(IStrategy):
    ...
    buy_volume_9 = DecimalParameter(
        1.0, 4.0, default=2.0, space="entry", decimals=2, optimize=buy_params_9_optimize, load=True
    )
    buy_ma_offset_9 = DecimalParameter(
        ...
        space="entry",
        decimals=3,
        optimize=buy_params_9_optimize,
        load=True,
    )
    ...
    buy_volume_10 = DecimalParameter(
        ...
        space="entry",
        decimals=1,
        optimize=buy_params_10_optimize,
        load=True,
    )
    ...
    buy_ma_offset_11 = DecimalParameter(
        ...
        space="entry",
        decimals=3,
        optimize=buy_params_11_optimize,
        load=True,
    )
    ...
    buy_volume_12 = DecimalParameter(
        ...
        space="entry",
        decimals=1,
        optimize=buy_params_12_optimize,
        load=True,
    )
    ...
    buy_ewo_12 = DecimalParameter(
        2.0, 6.0, default=2.8, space="entry", decimals=1, optimize=buy_params_12_optimize, load=True
    )
    ...
    buy_volume_14 = DecimalParameter(
        ...
        space="entry",
        decimals=1,
        optimize=buy_params_14_optimize,
        load=True,
    )
    ...
    buy_ema_open_mult_15 = DecimalParameter(
        ...
        space="entry",
        decimals=3,
        optimize=buy_params_15_optimize,
        load=True,
    )
    ...
    buy_volume_16 = DecimalParameter(
        ...
        space="entry",
        decimals=1,
        optimize=buy_params_16_optimize,
        load=True,
    )
    ...
    buy_ewo_16 = DecimalParameter(
        4.0, 8.0, default=3.6, space="entry", decimals=1, optimize=buy_params_16_optimize, load=True
    )
    ...
    sell_rsi_bb_1 = DecimalParameter(
        ...
        space="exit",
        decimals=1,
        optimize=sell_rsi_params_optimize,
        load=True,
    )
    ...
    sell_dual_rsi_rsi_4 = DecimalParameter(
        ...
        space="exit",
        decimals=1,
        optimize=sell_dual_rsi_params_optimize,
        load=True,
    )
    ...
    sell_ema_relative_5 = DecimalParameter(
        0.005, 0.05, default=0.024, space="exit", optimize=sell_5_params_optimize, load=True
    )
    sell_rsi_diff_5 = DecimalParameter(
        0.0, 20.0, default=4.4, space="exit", optimize=sell_5_params_optimize, load=True
    )
    ...
    sell_custom_profit_0 = DecimalParameter(
        ...
        space="exit",
        decimals=3,
        optimize=sell_custom_profit_01_params_optimize,
        load=True,
    )
    ...
    sell_custom_profit_2 = DecimalParameter(
        ...
        space="exit",
        decimals=3,
        optimize=sell_custom_profit_23_params_optimize,
        load=True,
    )
    ...
    sell_custom_profit_4 = DecimalParameter(
        ...
        space="exit",
        decimals=3,
        optimize=sell_custom_profit_45_params_optimize,
        load=True,
    )
    ...
    sell_custom_profit_6 = DecimalParameter(
        ...
        space="exit",
        decimals=3,
        optimize=sell_custom_profit_67_params_optimize,
        load=True,
    )
    ...
    sell_custom_profit_8 = DecimalParameter(
        ...
        space="exit",
        decimals=3,
        optimize=sell_custom_profit_89_params_optimize,
        load=True,
    )
    ...
    sell_custom_profit_10 = DecimalParameter(
        ...
        space="exit",
        decimals=3,
        optimize=sell_custom_profit_1011_params_optimize,
        load=True,
    )
    ...
    sell_custom_under_profit_0 = DecimalParameter(
        ...
        space="exit",
        decimals=3,
        optimize=sell_custom_under_profit_01_optimize,
        load=True,
    )
    ...
    sell_custom_under_profit_2 = DecimalParameter(
        ...
        space="exit",
        decimals=3,
        optimize=sell_custom_under_profit_23_optimize,
        load=True,
    )
    ...
    sell_custom_under_profit_4 = DecimalParameter(
        ...
        space="exit",
        decimals=3,
        optimize=sell_custom_under_profit_45_optimize,
        load=True,
    )
    ...
    sell_custom_under_profit_6 = DecimalParameter(
        ...
        space="exit",
        decimals=3,
        optimize=sell_custom_under_profit_67_optimize,
        load=True,
    )
    ...
    sell_custom_under_profit_8 = DecimalParameter(
        ...
        space="exit",
        decimals=3,
        optimize=sell_custom_under_profit_89_optimize,
        load=True,
    )
    ...
    sell_custom_under_profit_10 = DecimalParameter(
        ...
        space="exit",
        decimals=3,
        optimize=sell_custom_under_profit_1011_optimize,
        load=True,
    )
    ...
    sell_custom_pump_profit_1_1 = DecimalParameter(
        ...
        space="exit",
        decimals=3,
        optimize=sell_custom_pump_profit_123_optimize,
        load=True,
    )
    ...
    sell_custom_pump_profit_1_4 = DecimalParameter(
        ...
        space="exit",
        decimals=3,
        optimize=sell_custom_pump_profit_45_optimize,
        load=True,
    )
    ...
    sell_custom_stoploss_under_rsi_diff_1 = DecimalParameter(
        0.0, 20.0, default=9.0, space="exit", optimize=False, load=True
    )
