...
class BigZ0407(IStrategy):
    ...
    buy_rsi_1h_1 = DecimalParameter(
        10.0, 40.0, default=16.5, space="entry", decimals=1, optimize=buy_rsi_1h_optimize, load=True
    )
    buy_rsi_1h_2 = DecimalParameter(
        10.0, 40.0, default=15.0, space="entry", decimals=1, optimize=buy_rsi_1h_optimize, load=True
    )
    buy_rsi_1h_3 = DecimalParameter(
        10.0, 40.0, default=20.0, space="entry", decimals=1, optimize=buy_rsi_1h_optimize, load=True
    )
    buy_rsi_1h_4 = DecimalParameter(
        10.0, 40.0, default=35.0, space="entry", decimals=1, optimize=buy_rsi_1h_optimize, load=True
    )
    buy_rsi_1h_5 = DecimalParameter(
        10.0, 60.0, default=39.0, space="entry", decimals=1, optimize=buy_rsi_1h_optimize, load=True
    )
    ...
    buy_condition_11_rsi = DecimalParameter(
        49, 53, default=51, space="entry", decimals=2, optimize=buy_condition_11_optimize, load=True
    )
    ...
    buy_condition_1_rsi_1h = DecimalParameter(
        63, 75, default=69, space="entry", decimals=1, optimize=buy_condition_1_optimize, load=True
    )
    ...
    custom_stoploss_minutes = IntParameter(
        50, 200, default=50, space="exit", optimize=False, load=True
    )
    custom_stoploss_rsi_1h = DecimalParameter(
        20, 50, default=30, space="exit", decimals=1, optimize=False, load=True
    )
    ...
    def custom_stoploss(
        ...
        **kwargs,
        ...
        if current_profit > 0:
            ...
            trade_time_50 = trade.open_date_utc + timedelta(
