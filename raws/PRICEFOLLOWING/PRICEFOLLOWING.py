...
class PRICEFOLLOWING(IStrategy):
    ...
    ema_sell_pct = DecimalParameter(
        0.0001, 0.1, decimals=4, default=0.003, space="sell", optimize=True, load=True
    )
    sell_rsi_value = IntParameter(
        low=25, high=100, default=70, space="exit", optimize=True, load=True
    )
