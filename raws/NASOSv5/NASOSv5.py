...
class NASOSv5(IStrategy):
    ...
    base_nb_candles_buy = IntParameter(
        2, 20, default=buy_params["base_nb_candles_buy"], space="entry", optimize=False
    )
    base_nb_candles_sell = IntParameter(
        2, 25, default=sell_params["base_nb_candles_sell"], space="exit", optimize=False
    )
    ...
    profit_threshold = DecimalParameter(
        0.99, 1.05, default=buy_params["profit_threshold"], space="entry", optimize=False
    )
    ...
    rsi_buy = IntParameter(10, 80, default=buy_params["rsi_buy"], space="entry", optimize=False)
    rsi_fast_buy = IntParameter(
        10, 50, default=buy_params["rsi_fast_buy"], space="entry", optimize=False
    )
