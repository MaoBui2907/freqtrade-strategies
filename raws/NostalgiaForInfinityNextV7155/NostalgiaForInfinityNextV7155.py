...
class NostalgiaForInfinityNextV7155(IStrategy):
    ...
    def informative_1d_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        informative_1d["open_sha"], informative_1d["close_sha"], informative_1d["low_sha"] = (
            HeikinAshi(informative_1d, smooth_inputs=True, smooth_outputs=False, length=10)
        )
        ...
        for index in self.buy_protection_params:
            ...
            if self.buy_params[f"buy_condition_{index}_enable"]:
                ...
                # Condition #2
                    ...
                    # Logic
                    item_buy_logic.append(
                        dataframe["rsi_14"] < dataframe["rsi_14_1h"] - self.buy_2_rsi_1h_diff
                    )
                    ...
                    item_buy_logic.append(
                        dataframe["volume"] < (dataframe["volume_mean_4"] * self.buy_2_volume)
                    )
                ...
                # Condition #4
                    ...
                    item_buy_logic.append(
                        dataframe["volume"]
                        < (dataframe["volume_mean_30"].shift(1) * self.buy_4_bb20_volume)
                    )
                ...
                # Condition #5
                    ...
                    # Non-Standard protections
                    item_buy_logic.append(
                        dataframe["close"] > (dataframe["ema_200_1h"] * self.buy_5_ema_rel)
                    )
                    ...
                    item_buy_logic.append(
                        dataframe["close"] < (dataframe["bb20_2_low"] * self.buy_5_bb_offset)
                    )
                    ...
                    item_buy_logic.append(
                        dataframe["volume"] < (dataframe["volume_mean_4"] * self.buy_5_volume)
                    )
                ...
                # Condition #6
                    ...
                    item_buy_logic.append(
                        dataframe["close"] < (dataframe["bb20_2_low"] * self.buy_6_bb_offset)
                    )
                ...
                # Condition #8
                    ...
                    # Logic
                    item_buy_logic.append(
                        dataframe["close"] < (dataframe["bb20_2_low"] * self.buy_8_bb_offset)
                    )
                    ...
                    item_buy_logic.append(
                        dataframe["volume"] < (dataframe["volume_mean_4"] * self.buy_8_volume)
                    )
                ...
                # Condition #9
                    ...
                    item_buy_logic.append(
                        dataframe["close"] < dataframe["bb20_2_low"] * self.buy_9_bb_offset
                    )
                ...
                # Condition #10
                    ...
                    # Logic
                    item_buy_logic.append(
                        dataframe["close"] < dataframe["sma_30"] * self.buy_10_ma_offset_high
                    )
                    item_buy_logic.append(
                        dataframe["close"] < dataframe["bb20_2_low"] * self.buy_10_bb_offset
                    )
                ...
                # Condition #14
                    ...
                    item_buy_logic.append(
                        dataframe["close"] < (dataframe["bb20_2_low"] * self.buy_14_bb_offset)
                    )
                    item_buy_logic.append(
                ...
                # Condition #17
                    ...
                    item_buy_logic.append(
                        dataframe["volume"] < (dataframe["volume_mean_4"] * self.buy_17_volume)
                    )
                ...
                # Condition #18
                    ...
                    # Logic
                    item_buy_logic.append(
                        dataframe["close"] < (dataframe["bb20_2_low"] * self.buy_18_bb_offset)
                    )
                    ...
                    item_buy_logic.append(
                        dataframe["volume"] < (dataframe["volume_mean_4"] * self.buy_18_volume)
                    )
                ...
                # Condition #20
                    ...
                    item_buy_logic.append(
                        dataframe["volume"] < (dataframe["volume_mean_4"] * self.buy_20_volume)
                    )
                ...
                # Condition #21
                    ...
                    item_buy_logic.append(
                        dataframe["volume"] < (dataframe["volume_mean_4"] * self.buy_21_volume)
                    )
                ...
                # Condition #22
                    ...
                    # Logic
                    item_buy_logic.append(
                        (dataframe["volume_mean_4"] * self.buy_22_volume) > dataframe["volume"]
                    )
                    item_buy_logic.append(
                        dataframe["close"] < dataframe["sma_30"] * self.buy_22_ma_offset
                    )
                    item_buy_logic.append(
                        dataframe["close"] < (dataframe["bb20_2_low"] * self.buy_22_bb_offset)
                    )
                ...
                # Condition #40
                    ...
                    # Logic
                    item_buy_logic.append(dataframe["momdiv_buy_1h"] is True)
                ...
                # Condition #41
                    ...
                    item_buy_logic.append(
                        dataframe["close"] < dataframe["sma_75"] * self.buy_41_ma_offset_high
                    )
                ...
                # Condition #47 - Long mode
                    ...
                    item_buy_logic.append(
                        dataframe["close"] < (dataframe["sma_30"] * self.buy_47_ma_offset)
                    )
