...
class GodStraNew40(IStrategy):
    ...
    buy_operator0 = CategoricalParameter(
        operators, default=buy_params["buy_operator0"], space="entry"
    )
    buy_operator1 = CategoricalParameter(
        operators, default=buy_params["buy_operator1"], space="entry"
    )
    buy_operator2 = CategoricalParameter(
        operators, default=buy_params["buy_operator2"], space="entry"
    )

    buy_real_num0 = DecimalParameter(
        0, 1, decimals=DECIMALS, default=buy_params["buy_real_num0"], space="entry"
    )
    buy_real_num1 = DecimalParameter(
        0, 1, decimals=DECIMALS, default=buy_params["buy_real_num1"], space="entry"
    )
    buy_real_num2 = DecimalParameter(
        0, 1, decimals=DECIMALS, default=buy_params["buy_real_num2"], space="entry"
    )
    ...
    sell_operator0 = CategoricalParameter(
        operators, default=sell_params["sell_operator0"], space="exit"
    )
    sell_operator1 = CategoricalParameter(
        operators, default=sell_params["sell_operator1"], space="exit"
    )
    sell_operator2 = CategoricalParameter(
        operators, default=sell_params["sell_operator2"], space="exit"
    )

    sell_real_num0 = DecimalParameter(
        0, 1, decimals=DECIMALS, default=sell_params["sell_real_num0"], space="exit"
    )
    sell_real_num1 = DecimalParameter(
        0, 1, decimals=DECIMALS, default=sell_params["sell_real_num1"], space="exit"
    )
    sell_real_num2 = DecimalParameter(
        0, 1, decimals=DECIMALS, default=sell_params["sell_real_num2"], space="exit"
    )
