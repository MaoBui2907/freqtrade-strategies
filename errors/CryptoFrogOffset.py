...
class CryptoFrogOffset(IStrategy):
    ...
    sell_custom_profit_4 = DecimalParameter(
        0.06, 0.30, default=0.1, space="exit", decimals=3, optimize=False, load=True
    )
    ...
    sell_custom_profit_5 = DecimalParameter(
        0.2, 0.45, default=0.12, space="exit", decimals=3, optimize=False, load=True
    )
    sell_custom_rsi_5 = DecimalParameter(
        40.0, 58.0, default=42.0, space="exit", decimals=2, optimize=False, load=True
    )
    ...
    sell_custom_rsi_6 = DecimalParameter(
        20.0, 40.0, default=34.0, space="exit", decimals=2, optimize=False, load=True
    )
    ...
    sell_custom_under_profit_3 = DecimalParameter(
        0.01, 0.10, default=0.06, space="exit", decimals=3, optimize=False, load=True
    )
    ...
    sell_custom_under_profit_4 = DecimalParameter(
        0.05, 0.12, default=0.08, space="exit", decimals=3, optimize=False, load=True
    )
    ...
    sell_custom_under_profit_5 = DecimalParameter(
        0.06, 0.14, default=0.1, space="exit", decimals=3, optimize=False, load=True
    )
    ...
    sell_pump_threshold_8 = DecimalParameter(
        0.3, 0.6, default=0.4, space="exit", decimals=2, optimize=False, load=True
    )
    ...
    def custom_exit(
        ...
        **kwargs,
        ...
        if last_candle is not None:
            if (current_profit > self.sell_custom_profit_6.value) & (
            ...
            # check if close is under EMA200
                ...
                (current_profit > self.sell_custom_under_profit_6.value)
