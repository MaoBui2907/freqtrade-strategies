...
class CombinedBinHAndClucV5Hyperoptable(IStrategy):
    ...
    buy_bin_bbdelta_close = RealParameter(
        0.004, 0.15, default=0.008, space="entry", optimize=True, load=True
    )
    buy_bin_closedelta_close = RealParameter(
        0.01, 0.03, default=0.0175, space="entry", optimize=True, load=True
    )
    buy_bin_tail_bbdelta = RealParameter(
        0.1, 0.5, default=0.25, space="entry", optimize=True, load=True
    )
    buy_cluc_close_bblowerband = RealParameter(
        0.5, 1.5, default=0.985, space="entry", optimize=True, load=True
    )
