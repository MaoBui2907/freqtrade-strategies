...
class BigZ0307HO(IStrategy):
    ...
    buy_bb20_close_bblowerband_safe_1 = DecimalParameter(
        0.7, 1.1, default=0.989, space="entry", optimize=buy_bb20_optimize, load=True
    )
    buy_bb20_close_bblowerband_safe_2 = DecimalParameter(
        0.7, 1.1, default=0.982, space="entry", optimize=buy_bb20_optimize, load=True
    )
    ...
    buy_volume_drop_1 = DecimalParameter(
        1, 10, default=3.8, space="entry", decimals=1, optimize=buy_volume_pump_optimize, load=True
    )
    buy_volume_drop_2 = DecimalParameter(
        1, 10, default=3, space="entry", decimals=1, optimize=buy_volume_pump_optimize, load=True
    )
    buy_volume_drop_3 = DecimalParameter(
        1, 10, default=2.7, space="entry", decimals=1, optimize=buy_volume_pump_optimize, load=True
    )
    ...
    buy_rsi_1h_1 = DecimalParameter(
        ...
        space="entry",
        decimals=1,
        optimize=buy_rsi_1h_optimize_1,
        load=True,
    )
    ...
    buy_rsi_1h_4 = DecimalParameter(
        ...
        space="entry",
        decimals=1,
        optimize=buy_rsi_1h_optimize_2,
        load=True,
    )
    ...
    buy_rsi_1 = DecimalParameter(
        10.0, 40.0, default=28.0, space="entry", decimals=1, optimize=buy_rsi_optimize, load=True
    )
    buy_rsi_2 = DecimalParameter(
        7.0, 40.0, default=10.0, space="entry", decimals=1, optimize=buy_rsi_optimize, load=True
    )
    buy_rsi_3 = DecimalParameter(
        7.0, 40.0, default=14.2, space="entry", decimals=1, optimize=buy_rsi_optimize, load=True
    )

    buy_macd_optimize = False
    buy_macd_1 = DecimalParameter(
        0.01, 0.09, default=0.02, space="entry", decimals=2, optimize=buy_macd_optimize, load=True
    )
    buy_macd_2 = DecimalParameter(
        0.01, 0.09, default=0.03, space="entry", decimals=2, optimize=buy_macd_optimize, load=True
    )
    ...
    buy_condition_11_bb_middleband = DecimalParameter(
        1.001,
        1.02,
        default=1.005,
        space="entry",
    ...
    buy_condition_11_rsi = DecimalParameter(
        60, 76, default=68, space="entry", decimals=2, optimize=buy_condition_11_optimize, load=True
    )

    buy_condition_0_optimize = False
    buy_condition_0_rsi = DecimalParameter(
        26, 34, default=30, space="entry", decimals=1, optimize=buy_condition_0_optimize, load=True
    )
    ...
    buy_condition_0_rsi_1h = DecimalParameter(
        66, 76, default=71, space="entry", decimals=1, optimize=buy_condition_0_optimize, load=True
    )

    buy_condition_1_rsi_1h = DecimalParameter(
        63, 75, default=69, space="entry", decimals=1, optimize=False, load=True
    )
    ...
    custom_stoploss_minutes = IntParameter(
        50, 200, default=50, space="exit", optimize=custom_stoploss_optimize_2, load=True
    )
    custom_stoploss_rsi_1h = DecimalParameter(
        20, 50, default=30, space="exit", decimals=1, optimize=custom_stoploss_optimize_2, load=True
    )
    custom_stoploss_current_rates_1 = DecimalParameter(
        1.001,
        1.1,
        default=1.025,
        space="exit",
        decimals=3,
        optimize=custom_stoploss_optimize_1,
        load=True,
    )
    custom_stoploss_current_rates_2 = DecimalParameter(
        1.001,
        1.1,
        default=1.015,
        space="exit",
    ...
    sell_custom_stoploss_long_profit_min_1 = DecimalParameter(
        ...
        default=-0.08,
        space="exit",
        optimize=sell_custom_stoploss_long_optimize,
        load=True,
    )
    ...
    sell_custom_stoploss_long_rsi_diff_1 = DecimalParameter(
        0.0, 20.0, default=4.0, space="exit", optimize=sell_custom_stoploss_long_optimize, load=True
    )
    ...
    sell_custom_stoploss_long_recover_2 = DecimalParameter(
        0.03, 0.15, default=0.06, space="exit", optimize=sell_custom_stoploss_2_optimize, load=True
    )
    sell_custom_stoploss_long_rsi_diff_2 = DecimalParameter(
        30.0, 50.0, default=40.0, space="exit", optimize=sell_custom_stoploss_2_optimize, load=True
    )
    ...
    def custom_stoploss(
        ...
        **kwargs,
        ...
        if current_profit > 0:
            ...
            trade_time_50 = current_time - timedelta(
                minutes=int(self.custom_stoploss_minutes.value)
            )
            ...
            if trade_time_50 > trade.open_date_utc:
                try:
                    ...
                    if candle["close"] > candle["ema_200"]:
                        if (
                            current_rate * self.custom_stoploss_current_rates_1.value
                            < candle["open"]
                        ):
                            return 0.015
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        dataframe.loc[
            (
                ...
                & (
                    dataframe["close"]
                    < dataframe["bb_lowerband"] * self.buy_condition_12_bblower_close.value
                )
                & (
                    dataframe["low"]
                    < dataframe["bb_lowerband"] * self.buy_condition_12_bblower_low.value
                )
            ...
            | (
                ...
                & (
                    ...
                    > dataframe["bb_middleband"].shift(9)
                    * self.buy_condition_11_bb_middleband.value
                )
