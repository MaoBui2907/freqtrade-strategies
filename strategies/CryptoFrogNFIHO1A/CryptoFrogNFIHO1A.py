...
#############################################################
    ...
    #############################################################
    buy_condition_1_enable = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_01_protection__ema_fast                 = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_01_protection__ema_fast_len             = CategoricalParameter(["26","50","100","200"], default="26", space='entry', optimize=True, load=True)
    buy_01_protection__ema_slow                 = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_01_protection__ema_slow_len             = CategoricalParameter(["26","50","100","200"], default="100", space='entry', optimize=True, load=True)
    buy_01_protection__close_above_ema_fast     = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_01_protection__close_above_ema_fast_len = CategoricalParameter(["12","20","26","50","100","200"], default="200", space='entry', optimize=True, load=True)
    buy_01_protection__close_above_ema_slow     = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_01_protection__close_above_ema_slow_len = CategoricalParameter(["15","50","200"], default="200", space='entry', optimize=True, load=True)
    buy_01_protection__sma200_rising            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_01_protection__sma200_rising_val        = CategoricalParameter(["20","30","36","44","50"], default="36", space='entry', optimize=True, load=True)
    buy_01_protection__sma200_1h_rising         = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_01_protection__sma200_1h_rising_val     = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_01_protection__safe_dips                = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_01_protection__safe_dips_type           = CategoricalParameter(["strict","normal","loose"], default="normal", space='entry', optimize=True, load=True)
    buy_01_protection__safe_pump                = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_01_protection__safe_pump_type           = CategoricalParameter(["strict","normal","loose"], default="loose", space='entry', optimize=True, load=True)
    buy_01_protection__safe_pump_period         = CategoricalParameter(["24","36","48"], default="36", space='entry', optimize=True, load=True)

    buy_condition_2_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_02_protection__close_above_ema_fast     = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_02_protection__close_above_ema_fast_len = CategoricalParameter(["12","20","26","50","100","200"], default="200", space='entry', optimize=True, load=True)
    buy_02_protection__close_above_ema_slow     = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_02_protection__close_above_ema_slow_len = CategoricalParameter(["15","50","200"], default="200", space='entry', optimize=True, load=True)
    buy_02_protection__ema_fast                 = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_02_protection__ema_fast_len             = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_02_protection__ema_slow                 = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_02_protection__ema_slow_len             = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_02_protection__safe_dips                = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_02_protection__safe_dips_type           = CategoricalParameter(["strict","normal","loose"], default="normal", space='entry', optimize=True, load=True)
    buy_02_protection__safe_pump                = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_02_protection__safe_pump_type           = CategoricalParameter(["strict","normal","loose"], default="strict", space='entry', optimize=True, load=True)
    buy_02_protection__safe_pump_period         = CategoricalParameter(["24","36","48"], default="24", space='entry', optimize=True, load=True)
    buy_02_protection__sma200_rising            = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_02_protection__sma200_rising_val        = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_02_protection__sma200_1h_rising         = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_02_protection__sma200_1h_rising_val     = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)

    buy_condition_3_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_03_protection__close_above_ema_fast     = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_03_protection__close_above_ema_fast_len = CategoricalParameter(["12","20","26","50","100","200"], default="200", space='entry', optimize=True, load=True)
    buy_03_protection__close_above_ema_slow     = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_03_protection__close_above_ema_slow_len = CategoricalParameter(["15","50","200"], default="200", space='entry', optimize=True, load=True)
    buy_03_protection__ema_fast                 = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_03_protection__ema_fast_len             = CategoricalParameter(["26","50","100","200"], default="100", space='entry', optimize=True, load=True)
    buy_03_protection__ema_slow                 = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_03_protection__ema_slow_len             = CategoricalParameter(["26","50","100","200"], default="100", space='entry', optimize=True, load=True)
    buy_03_protection__safe_dips                = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_03_protection__safe_dips_type           = CategoricalParameter(["strict","normal","loose"], default="strict", space='entry', optimize=True, load=True)
    buy_03_protection__safe_pump                = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_03_protection__safe_pump_type           = CategoricalParameter(["strict","normal","loose"], default="loose", space='entry', optimize=True, load=True)
    buy_03_protection__safe_pump_period         = CategoricalParameter(["24","36","48"], default="36", space='entry', optimize=True, load=True)
    buy_03_protection__sma200_rising            = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_03_protection__sma200_rising_val        = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_03_protection__sma200_1h_rising         = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_03_protection__sma200_1h_rising_val     = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)

    buy_condition_4_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_04_protection__close_above_ema_fast     = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_04_protection__close_above_ema_fast_len = CategoricalParameter(["12","20","26","50","100","200"], default="200", space='entry', optimize=True, load=True)
    buy_04_protection__close_above_ema_slow     = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_04_protection__close_above_ema_slow_len = CategoricalParameter(["15","50","200"], default="200", space='entry', optimize=True, load=True)
    buy_04_protection__ema_fast                 = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_04_protection__ema_fast_len             = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_04_protection__ema_slow                 = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_04_protection__ema_slow_len             = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_04_protection__safe_dips                = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_04_protection__safe_dips_type           = CategoricalParameter(["strict","normal","loose"], default="normal", space='entry', optimize=True, load=True)
    buy_04_protection__safe_pump                = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_04_protection__safe_pump_type           = CategoricalParameter(["strict","normal","loose"], default="normal", space='entry', optimize=True, load=True)
    buy_04_protection__safe_pump_period         = CategoricalParameter(["24","36","48"], default="48", space='entry', optimize=True, load=True)
    buy_04_protection__sma200_rising            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_04_protection__sma200_rising_val        = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_04_protection__sma200_1h_rising         = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_04_protection__sma200_1h_rising_val     = CategoricalParameter(["20","30","36","44","50"], default="20", space='entry', optimize=True, load=True)

    buy_condition_5_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_05_protection__close_above_ema_fast     = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_05_protection__close_above_ema_fast_len = CategoricalParameter(["12","20","26","50","100","200"], default="100", space='entry', optimize=True, load=True)
    buy_05_protection__close_above_ema_slow     = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_05_protection__close_above_ema_slow_len = CategoricalParameter(["15","50","200"], default="200", space='entry', optimize=True, load=True)
    buy_05_protection__ema_fast                 = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_05_protection__ema_fast_len             = CategoricalParameter(["26","50","100","200"], default="100", space='entry', optimize=True, load=True)
    buy_05_protection__ema_slow                 = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_05_protection__ema_slow_len             = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_05_protection__safe_dips                = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_05_protection__safe_dips_type           = CategoricalParameter(["strict","normal","loose"], default="loose", space='entry', optimize=True, load=True)
    buy_05_protection__safe_pump                = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_05_protection__safe_pump_type           = CategoricalParameter(["strict","normal","loose"], default="strict", space='entry', optimize=True, load=True)
    buy_05_protection__safe_pump_period         = CategoricalParameter(["24","36","48"], default="36", space='entry', optimize=True, load=True)
    buy_05_protection__sma200_rising            = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_05_protection__sma200_rising_val        = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_05_protection__sma200_1h_rising         = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_05_protection__sma200_1h_rising_val     = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)

    buy_condition_6_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_06_protection__ema_fast             = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_06_protection__ema_fast_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_06_protection__ema_slow             = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_06_protection__ema_slow_len         = CategoricalParameter(["26","50","100","200"], default="100", space='entry', optimize=True, load=True)
    buy_06_protection__close_above_ema_fast      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_06_protection__close_above_ema_fast_len  = CategoricalParameter(["12","20","26","50","100","200"], default="200", space='entry', optimize=True, load=True)
    buy_06_protection__close_above_ema_slow      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_06_protection__close_above_ema_slow_len  = CategoricalParameter(["15","50","200"], default="200", space='entry', optimize=True, load=True)
    buy_06_protection__sma200_rising        = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_06_protection__sma200_rising_val    = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_06_protection__sma200_1h_rising     = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_06_protection__sma200_1h_rising_val = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_06_protection__safe_dips            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_06_protection__safe_dips_type       = CategoricalParameter(["strict","normal","loose"], default="normal", space='entry', optimize=True, load=True)
    buy_06_protection__safe_pump            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_06_protection__safe_pump_type       = CategoricalParameter(["strict","normal","loose"], default="strict", space='entry', optimize=True, load=True)
    buy_06_protection__safe_pump_period     = CategoricalParameter(["24","36","48"], default="36", space='entry', optimize=True, load=True)

    buy_condition_7_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_07_protection__ema_fast             = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_07_protection__ema_fast_len         = CategoricalParameter(["26","50","100","200"], default="100", space='entry', optimize=True, load=True)
    buy_07_protection__ema_slow             = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_07_protection__ema_slow_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_07_protection__close_above_ema_fast      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_07_protection__close_above_ema_fast_len  = CategoricalParameter(["12","20","26","50","100","200"], default="200", space='entry', optimize=True, load=True)
    buy_07_protection__close_above_ema_slow      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_07_protection__close_above_ema_slow_len  = CategoricalParameter(["15","50","200"], default="200", space='entry', optimize=True, load=True)
    buy_07_protection__sma200_rising        = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_07_protection__sma200_rising_val    = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_07_protection__sma200_1h_rising     = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_07_protection__sma200_1h_rising_val = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_07_protection__safe_dips            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_07_protection__safe_dips_type       = CategoricalParameter(["strict","normal","loose"], default="normal", space='entry', optimize=True, load=True)
    buy_07_protection__safe_pump            = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_07_protection__safe_pump_type       = CategoricalParameter(["strict","normal","loose"], default="normal", space='entry', optimize=True, load=True)
    buy_07_protection__safe_pump_period     = CategoricalParameter(["24","36","48"], default="24", space='entry', optimize=True, load=True)

    buy_condition_8_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_08_protection__ema_fast             = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_08_protection__ema_fast_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_08_protection__ema_slow             = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_08_protection__ema_slow_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_08_protection__close_above_ema_fast      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_08_protection__close_above_ema_fast_len  = CategoricalParameter(["12","20","26","50","100","200"], default="200", space='entry', optimize=True, load=True)
    buy_08_protection__close_above_ema_slow      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_08_protection__close_above_ema_slow_len  = CategoricalParameter(["15","50","200"], default="200", space='entry', optimize=True, load=True)
    buy_08_protection__sma200_rising        = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_08_protection__sma200_rising_val    = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_08_protection__sma200_1h_rising     = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_08_protection__sma200_1h_rising_val = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_08_protection__safe_dips            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_08_protection__safe_dips_type       = CategoricalParameter(["strict","normal","loose"], default="loose", space='entry', optimize=True, load=True)
    buy_08_protection__safe_pump            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_08_protection__safe_pump_type       = CategoricalParameter(["strict","normal","loose"], default="loose", space='entry', optimize=True, load=True)
    buy_08_protection__safe_pump_period     = CategoricalParameter(["24","36","48"], default="24", space='entry', optimize=True, load=True)

    buy_condition_9_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_09_protection__ema_fast             = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_09_protection__ema_fast_len         = CategoricalParameter(["26","50","100","200"], default="100", space='entry', optimize=True, load=True)
    buy_09_protection__ema_slow             = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_09_protection__ema_slow_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_09_protection__close_above_ema_fast      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_09_protection__close_above_ema_fast_len  = CategoricalParameter(["12","20","26","50","100","200"], default="200", space='entry', optimize=True, load=True)
    buy_09_protection__close_above_ema_slow      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_09_protection__close_above_ema_slow_len  = CategoricalParameter(["15","50","200"], default="200", space='entry', optimize=True, load=True)
    buy_09_protection__sma200_rising        = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_09_protection__sma200_rising_val    = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_09_protection__sma200_1h_rising     = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_09_protection__sma200_1h_rising_val = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_09_protection__safe_dips            = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_09_protection__safe_dips_type       = CategoricalParameter(["strict","normal","loose"], default="strict", space='entry', optimize=True, load=True)
    buy_09_protection__safe_pump            = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_09_protection__safe_pump_type       = CategoricalParameter(["strict","normal","loose"], default="normal", space='entry', optimize=True, load=True)
    buy_09_protection__safe_pump_period     = CategoricalParameter(["24","36","48"], default="24", space='entry', optimize=True, load=True)

    buy_condition_10_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_10_protection__ema_fast             = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_10_protection__ema_fast_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_10_protection__ema_slow             = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_10_protection__ema_slow_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_10_protection__close_above_ema_fast      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_10_protection__close_above_ema_fast_len  = CategoricalParameter(["12","20","26","50","100","200"], default="200", space='entry', optimize=True, load=True)
    buy_10_protection__close_above_ema_slow      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_10_protection__close_above_ema_slow_len  = CategoricalParameter(["15","50","200"], default="200", space='entry', optimize=True, load=True)
    buy_10_protection__sma200_rising        = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_10_protection__sma200_rising_val    = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_10_protection__sma200_1h_rising     = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_10_protection__sma200_1h_rising_val = CategoricalParameter(["20","30","36","44","50"], default="24", space='entry', optimize=True, load=True)
    buy_10_protection__safe_dips            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_10_protection__safe_dips_type       = CategoricalParameter(["strict","normal","loose"], default="loose", space='entry', optimize=True, load=True)
    buy_10_protection__safe_pump            = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_10_protection__safe_pump_type       = CategoricalParameter(["strict","normal","loose"], default="normal", space='entry', optimize=True, load=True)
    buy_10_protection__safe_pump_period     = CategoricalParameter(["24","36","48"], default="24", space='entry', optimize=True, load=True)

    buy_condition_11_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_11_protection__ema_fast             = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_11_protection__ema_fast_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_11_protection__ema_slow             = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_11_protection__ema_slow_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_11_protection__close_above_ema_fast      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_11_protection__close_above_ema_fast_len  = CategoricalParameter(["12","20","26","50","100","200"], default="200", space='entry', optimize=True, load=True)
    buy_11_protection__close_above_ema_slow      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_11_protection__close_above_ema_slow_len  = CategoricalParameter(["15","50","200"], default="200", space='entry', optimize=True, load=True)
    buy_11_protection__sma200_rising        = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_11_protection__sma200_rising_val    = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_11_protection__sma200_1h_rising     = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_11_protection__sma200_1h_rising_val = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_11_protection__safe_dips            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_11_protection__safe_dips_type       = CategoricalParameter(["strict","normal","loose"], default="loose", space='entry', optimize=True, load=True)
    buy_11_protection__safe_pump            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_11_protection__safe_pump_type       = CategoricalParameter(["strict","normal","loose"], default="normal", space='entry', optimize=True, load=True)
    buy_11_protection__safe_pump_period     = CategoricalParameter(["24","36","48"], default="24", space='entry', optimize=True, load=True)

    buy_condition_12_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_12_protection__ema_fast             = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_12_protection__ema_fast_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_12_protection__ema_slow             = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_12_protection__ema_slow_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_12_protection__close_above_ema_fast      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_12_protection__close_above_ema_fast_len  = CategoricalParameter(["12","20","26","50","100","200"], default="200", space='entry', optimize=True, load=True)
    buy_12_protection__close_above_ema_slow      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_12_protection__close_above_ema_slow_len  = CategoricalParameter(["15","50","200"], default="200", space='entry', optimize=True, load=True)
    buy_12_protection__sma200_rising        = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_12_protection__sma200_rising_val    = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_12_protection__sma200_1h_rising     = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_12_protection__sma200_1h_rising_val = CategoricalParameter(["20","30","36","44","50"], default="24", space='entry', optimize=True, load=True)
    buy_12_protection__safe_dips            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_12_protection__safe_dips_type       = CategoricalParameter(["strict","normal","loose"], default="strict", space='entry', optimize=True, load=True)
    buy_12_protection__safe_pump            = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_12_protection__safe_pump_type       = CategoricalParameter(["strict","normal","loose"], default="normal", space='entry', optimize=True, load=True)
    buy_12_protection__safe_pump_period     = CategoricalParameter(["24","36","48"], default="24", space='entry', optimize=True, load=True)

    buy_condition_13_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_13_protection__ema_fast             = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_13_protection__ema_fast_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_13_protection__ema_slow             = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_13_protection__ema_slow_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_13_protection__close_above_ema_fast      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_13_protection__close_above_ema_fast_len  = CategoricalParameter(["12","20","26","50","100","200"], default="200", space='entry', optimize=True, load=True)
    buy_13_protection__close_above_ema_slow      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_13_protection__close_above_ema_slow_len  = CategoricalParameter(["15","50","200"], default="200", space='entry', optimize=True, load=True)
    buy_13_protection__sma200_rising        = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_13_protection__sma200_rising_val    = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_13_protection__sma200_1h_rising     = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_13_protection__sma200_1h_rising_val = CategoricalParameter(["20","30","36","44","50"], default="24", space='entry', optimize=True, load=True)
    buy_13_protection__safe_dips            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_13_protection__safe_dips_type       = CategoricalParameter(["strict","normal","loose"], default="strict", space='entry', optimize=True, load=True)
    buy_13_protection__safe_pump            = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_13_protection__safe_pump_type       = CategoricalParameter(["strict","normal","loose"], default="normal", space='entry', optimize=True, load=True)
    buy_13_protection__safe_pump_period     = CategoricalParameter(["24","36","48"], default="24", space='entry', optimize=True, load=True)

    buy_condition_14_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_14_protection__ema_fast             = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_14_protection__ema_fast_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_14_protection__ema_slow             = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_14_protection__ema_slow_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_14_protection__close_above_ema_fast      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_14_protection__close_above_ema_fast_len  = CategoricalParameter(["12","20","26","50","100","200"], default="200", space='entry', optimize=True, load=True)
    buy_14_protection__close_above_ema_slow      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_14_protection__close_above_ema_slow_len  = CategoricalParameter(["15","50","200"], default="200", space='entry', optimize=True, load=True)
    buy_14_protection__sma200_rising        = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_14_protection__sma200_rising_val    = CategoricalParameter(["20","30","36","44","50"], default="30", space='entry', optimize=True, load=True)
    buy_14_protection__sma200_1h_rising     = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_14_protection__sma200_1h_rising_val = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_14_protection__safe_dips            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_14_protection__safe_dips_type       = CategoricalParameter(["strict","normal","loose"], default="strict", space='entry', optimize=True, load=True)
    buy_14_protection__safe_pump            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_14_protection__safe_pump_type       = CategoricalParameter(["strict","normal","loose"], default="normal", space='entry', optimize=True, load=True)
    buy_14_protection__safe_pump_period     = CategoricalParameter(["24","36","48"], default="24", space='entry', optimize=True, load=True)

    buy_condition_15_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_15_protection__ema_fast             = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_15_protection__ema_fast_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_15_protection__ema_slow             = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_15_protection__ema_slow_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_15_protection__close_above_ema_fast      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_15_protection__close_above_ema_fast_len  = CategoricalParameter(["12","20","26","50","100","200"], default="200", space='entry', optimize=True, load=True)
    buy_15_protection__close_above_ema_slow      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_15_protection__close_above_ema_slow_len  = CategoricalParameter(["15","50","200"], default="200", space='entry', optimize=True, load=True)
    buy_15_protection__sma200_rising        = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_15_protection__sma200_rising_val    = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_15_protection__sma200_1h_rising     = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_15_protection__sma200_1h_rising_val = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_15_protection__safe_dips            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_15_protection__safe_dips_type       = CategoricalParameter(["strict","normal","loose"], default="normal", space='entry', optimize=True, load=True)
    buy_15_protection__safe_pump            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_15_protection__safe_pump_type       = CategoricalParameter(["strict","normal","loose"], default="strict", space='entry', optimize=True, load=True)
    buy_15_protection__safe_pump_period     = CategoricalParameter(["24","36","48"], default="36", space='entry', optimize=True, load=True)

    buy_condition_16_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_16_protection__ema_fast             = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_16_protection__ema_fast_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_16_protection__ema_slow             = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_16_protection__ema_slow_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_16_protection__close_above_ema_fast      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_16_protection__close_above_ema_fast_len  = CategoricalParameter(["12","20","26","50","100","200"], default="200", space='entry', optimize=True, load=True)
    buy_16_protection__close_above_ema_slow      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_16_protection__close_above_ema_slow_len  = CategoricalParameter(["15","50","200"], default="50", space='entry', optimize=True, load=True)
    buy_16_protection__sma200_rising        = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_16_protection__sma200_rising_val    = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_16_protection__sma200_1h_rising     = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_16_protection__sma200_1h_rising_val = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_16_protection__safe_dips            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_16_protection__safe_dips_type       = CategoricalParameter(["strict","normal","loose"], default="strict", space='entry', optimize=True, load=True)
    buy_16_protection__safe_pump            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_16_protection__safe_pump_type       = CategoricalParameter(["strict","normal","loose"], default="strict", space='entry', optimize=True, load=True)
    buy_16_protection__safe_pump_period     = CategoricalParameter(["24","36","48"], default="24", space='entry', optimize=True, load=True)

    buy_condition_17_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_17_protection__ema_fast             = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_17_protection__ema_fast_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_17_protection__ema_slow             = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_17_protection__ema_slow_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_17_protection__close_above_ema_fast      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_17_protection__close_above_ema_fast_len  = CategoricalParameter(["12","20","26","50","100","200"], default="200", space='entry', optimize=True, load=True)
    buy_17_protection__close_above_ema_slow      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_17_protection__close_above_ema_slow_len  = CategoricalParameter(["15","50","200"], default="200", space='entry', optimize=True, load=True)
    buy_17_protection__sma200_rising        = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_17_protection__sma200_rising_val    = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_17_protection__sma200_1h_rising     = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_17_protection__sma200_1h_rising_val = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_17_protection__safe_dips            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_17_protection__safe_dips_type       = CategoricalParameter(["strict","normal","loose"], default="strict", space='entry', optimize=True, load=True)
    buy_17_protection__safe_pump            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_17_protection__safe_pump_type       = CategoricalParameter(["strict","normal","loose"], default="loose", space='entry', optimize=True, load=True)
    buy_17_protection__safe_pump_period     = CategoricalParameter(["24","36","48"], default="24", space='entry', optimize=True, load=True)

    buy_condition_18_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_18_protection__ema_fast             = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_18_protection__ema_fast_len         = CategoricalParameter(["26","50","100","200"], default="100", space='entry', optimize=True, load=True)
    buy_18_protection__ema_slow             = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_18_protection__ema_slow_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_18_protection__close_above_ema_fast      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_18_protection__close_above_ema_fast_len  = CategoricalParameter(["12","20","26","50","100","200"], default="200", space='entry', optimize=True, load=True)
    buy_18_protection__close_above_ema_slow      = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_18_protection__close_above_ema_slow_len  = CategoricalParameter(["15","50","200"], default="200", space='entry', optimize=True, load=True)
    buy_18_protection__sma200_rising        = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_18_protection__sma200_rising_val    = CategoricalParameter(["20","30","36","44","50"], default="44", space='entry', optimize=True, load=True)
    buy_18_protection__sma200_1h_rising     = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_18_protection__sma200_1h_rising_val = CategoricalParameter(["20","30","36","44","50"], default="72", space='entry', optimize=True, load=True)
    buy_18_protection__safe_dips            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_18_protection__safe_dips_type       = CategoricalParameter(["strict","normal","loose"], default="normal", space='entry', optimize=True, load=True)
    buy_18_protection__safe_pump            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_18_protection__safe_pump_type       = CategoricalParameter(["strict","normal","loose"], default="strict", space='entry', optimize=True, load=True)
    buy_18_protection__safe_pump_period     = CategoricalParameter(["24","36","48"], default="24", space='entry', optimize=True, load=True)

    buy_condition_19_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_19_protection__ema_fast             = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_19_protection__ema_fast_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_19_protection__ema_slow             = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_19_protection__ema_slow_len         = CategoricalParameter(["26","50","100","200"], default="100", space='entry', optimize=True, load=True)
    buy_19_protection__close_above_ema_fast      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_19_protection__close_above_ema_fast_len  = CategoricalParameter(["12","20","26","50","100","200"], default="200", space='entry', optimize=True, load=True)
    buy_19_protection__close_above_ema_slow      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_19_protection__close_above_ema_slow_len  = CategoricalParameter(["15","50","200"], default="200", space='entry', optimize=True, load=True)
    buy_19_protection__sma200_rising        = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_19_protection__sma200_rising_val    = CategoricalParameter(["20","30","36","44","50"], default="36", space='entry', optimize=True, load=True)
    buy_19_protection__sma200_1h_rising     = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_19_protection__sma200_1h_rising_val = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_19_protection__safe_dips            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_19_protection__safe_dips_type       = CategoricalParameter(["strict","normal","loose"], default="normal", space='entry', optimize=True, load=True)
    buy_19_protection__safe_pump            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_19_protection__safe_pump_type       = CategoricalParameter(["strict","normal","loose"], default="normal", space='entry', optimize=True, load=True)
    buy_19_protection__safe_pump_period     = CategoricalParameter(["24","36","48"], default="24", space='entry', optimize=True, load=True)

    buy_condition_20_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_20_protection__ema_fast             = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_20_protection__ema_fast_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_20_protection__ema_slow             = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_20_protection__ema_slow_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_20_protection__close_above_ema_fast      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_20_protection__close_above_ema_fast_len  = CategoricalParameter(["12","20","26","50","100","200"], default="200", space='entry', optimize=True, load=True)
    buy_20_protection__close_above_ema_slow      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_20_protection__close_above_ema_slow_len  = CategoricalParameter(["15","50","200"], default="200", space='entry', optimize=True, load=True)
    buy_20_protection__sma200_rising        = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_20_protection__sma200_rising_val    = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_20_protection__sma200_1h_rising     = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_20_protection__sma200_1h_rising_val = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_20_protection__safe_dips            = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_20_protection__safe_dips_type       = CategoricalParameter(["strict","normal","loose"], default="strict", space='entry', optimize=True, load=True)
    buy_20_protection__safe_pump            = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_20_protection__safe_pump_type       = CategoricalParameter(["strict","normal","loose"], default="normal", space='entry', optimize=True, load=True)
    buy_20_protection__safe_pump_period     = CategoricalParameter(["24","36","48"], default="24", space='entry', optimize=True, load=True)

    buy_condition_21_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_21_protection__ema_fast             = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_21_protection__ema_fast_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_21_protection__ema_slow             = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_21_protection__ema_slow_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_21_protection__close_above_ema_fast      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_21_protection__close_above_ema_fast_len  = CategoricalParameter(["12","20","26","50","100","200"], default="200", space='entry', optimize=True, load=True)
    buy_21_protection__close_above_ema_slow      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_21_protection__close_above_ema_slow_len  = CategoricalParameter(["15","50","200"], default="200", space='entry', optimize=True, load=True)
    buy_21_protection__sma200_rising        = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_21_protection__sma200_rising_val    = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_21_protection__sma200_1h_rising     = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_21_protection__sma200_1h_rising_val = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_21_protection__safe_dips            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_21_protection__safe_dips_type       = CategoricalParameter(["strict","normal","loose"], default="normal", space='entry', optimize=True, load=True)
    buy_21_protection__safe_pump            = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_21_protection__safe_pump_type       = CategoricalParameter(["strict","normal","loose"], default="normal", space='entry', optimize=True, load=True)
    buy_21_protection__safe_pump_period     = CategoricalParameter(["24","36","48"], default="24", space='entry', optimize=True, load=True)

    buy_condition_22_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_22_protection__ema_fast             = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_22_protection__ema_fast_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_22_protection__ema_slow             = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_22_protection__ema_slow_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_22_protection__close_above_ema_fast      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_22_protection__close_above_ema_fast_len  = CategoricalParameter(["12","20","26","50","100","200"], default="200", space='entry', optimize=True, load=True)
    buy_22_protection__close_above_ema_slow      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_22_protection__close_above_ema_slow_len  = CategoricalParameter(["15","50","200"], default="200", space='entry', optimize=True, load=True)
    buy_22_protection__sma200_rising        = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_22_protection__sma200_rising_val    = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_22_protection__sma200_1h_rising     = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_22_protection__sma200_1h_rising_val = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_22_protection__safe_dips            = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_22_protection__safe_dips_type       = CategoricalParameter(["strict","normal","loose"], default="strict", space='entry', optimize=True, load=True)
    buy_22_protection__safe_pump            = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_22_protection__safe_pump_type       = CategoricalParameter(["strict","normal","loose"], default="normal", space='entry', optimize=True, load=True)
    buy_22_protection__safe_pump_period     = CategoricalParameter(["24","36","48"], default="24", space='entry', optimize=True, load=True)

    buy_condition_23_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_23_protection__ema_fast             = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_23_protection__ema_fast_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_23_protection__ema_slow             = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_23_protection__ema_slow_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_23_protection__close_above_ema_fast      = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_23_protection__close_above_ema_fast_len  = CategoricalParameter(["12","20","26","50","100","200"], default="200", space='entry', optimize=True, load=True)
    buy_23_protection__close_above_ema_slow      = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_23_protection__close_above_ema_slow_len  = CategoricalParameter(["15","50","200"], default="200", space='entry', optimize=True, load=True)
    buy_23_protection__sma200_rising        = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_23_protection__sma200_rising_val    = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_23_protection__sma200_1h_rising     = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_23_protection__sma200_1h_rising_val = CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=True, load=True)
    buy_23_protection__safe_dips            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_23_protection__safe_dips_type       = CategoricalParameter(["strict","normal","loose"], default="loose", space='entry', optimize=True, load=True)
    buy_23_protection__safe_pump            = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_23_protection__safe_pump_type       = CategoricalParameter(["strict","normal","loose"], default="normal", space='entry', optimize=True, load=True)
    buy_23_protection__safe_pump_period     = CategoricalParameter(["24","36","48"], default="24", space='entry', optimize=True, load=True)

    buy_condition_24_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_24_protection__ema_fast             = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_24_protection__ema_fast_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_24_protection__ema_slow             = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_24_protection__ema_slow_len         = CategoricalParameter(["26","50","100","200"], default="50", space='entry', optimize=True, load=True)
    buy_24_protection__close_above_ema_fast      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_24_protection__close_above_ema_fast_len  = CategoricalParameter(["12","20","26","50","100","200"], default="200", space='entry', optimize=True, load=True)
    buy_24_protection__close_above_ema_slow      = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_24_protection__close_above_ema_slow_len  = CategoricalParameter(["15","50","200"], default="200", space='entry', optimize=True, load=True)
    buy_24_protection__sma200_rising        = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_24_protection__sma200_rising_val    = CategoricalParameter(["20","30","36","44","50"], default="30", space='entry', optimize=True, load=True)
    buy_24_protection__sma200_1h_rising     = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_24_protection__sma200_1h_rising_val = CategoricalParameter(["20","30","36","44","50"], default="36", space='entry', optimize=True, load=True)
    buy_24_protection__safe_dips            = CategoricalParameter([True, False], default=True, space='entry', optimize=True, load=True)
    buy_24_protection__safe_dips_type       = CategoricalParameter(["strict","normal","loose"], default="strict", space='entry', optimize=True, load=True)
    buy_24_protection__safe_pump            = CategoricalParameter([True, False], default=False, space='entry', optimize=True, load=True)
    buy_24_protection__safe_pump_type       = CategoricalParameter(["strict","normal","loose"], default="normal", space='entry', optimize=True, load=True)
    buy_24_protection__safe_pump_period     = CategoricalParameter(["24","36","48"], default="24", space='entry', optimize=True, load=True)

    # Normal dips
    buy_dip_threshold_1 = DecimalParameter(0.001, 0.05, default=0.02, space='entry', decimals=3, optimize=True, load=True)
    buy_dip_threshold_2 = DecimalParameter(0.01, 0.2, default=0.14, space='entry', decimals=3, optimize=True, load=True)
    buy_dip_threshold_3 = DecimalParameter(0.05, 0.4, default=0.32, space='entry', decimals=3, optimize=True, load=True)
    buy_dip_threshold_4 = DecimalParameter(0.2, 0.5, default=0.5, space='entry', decimals=3, optimize=True, load=True)
    # Strict dips
    buy_dip_threshold_5 = DecimalParameter(0.001, 0.05, default=0.015, space='entry', decimals=3, optimize=True, load=True)
    buy_dip_threshold_6 = DecimalParameter(0.01, 0.2, default=0.1, space='entry', decimals=3, optimize=True, load=True)
    buy_dip_threshold_7 = DecimalParameter(0.05, 0.4, default=0.24, space='entry', decimals=3, optimize=True, load=True)
    buy_dip_threshold_8 = DecimalParameter(0.2, 0.5, default=0.42, space='entry', decimals=3, optimize=True, load=True)
    # Loose dips
    buy_dip_threshold_9 = DecimalParameter(0.001, 0.05, default=0.026, space='entry', decimals=3, optimize=True, load=True)
    buy_dip_threshold_10 = DecimalParameter(0.01, 0.2, default=0.24, space='entry', decimals=3, optimize=True, load=True)
    buy_dip_threshold_11 = DecimalParameter(0.05, 0.4, default=0.42, space='entry', decimals=3, optimize=True, load=True)
    buy_dip_threshold_12 = DecimalParameter(0.2, 0.5, default=0.8, space='entry', decimals=3, optimize=True, load=True)

    # 24 hours
    buy_pump_pull_threshold_1 = DecimalParameter(1.5, 3.0, default=1.75, space='entry', decimals=2, optimize=True, load=True)
    buy_pump_threshold_1 = DecimalParameter(0.4, 1.0, default=0.6, space='entry', decimals=3, optimize=True, load=True)
    # 36 hours
    buy_pump_pull_threshold_2 = DecimalParameter(1.5, 3.0, default=1.75, space='entry', decimals=2, optimize=True, load=True)
    buy_pump_threshold_2 = DecimalParameter(0.4, 1.0, default=0.64, space='entry', decimals=3, optimize=True, load=True)
    # 48 hours
    buy_pump_pull_threshold_3 = DecimalParameter(1.5, 3.0, default=1.75, space='entry', decimals=2, optimize=True, load=True)
    buy_pump_threshold_3 = DecimalParameter(0.4, 1.0, default=0.85, space='entry', decimals=3, optimize=True, load=True)

    # 24 hours strict
    buy_pump_pull_threshold_4 = DecimalParameter(1.5, 3.0, default=2.2, space='entry', decimals=2, optimize=True, load=True)
    buy_pump_threshold_4 = DecimalParameter(0.4, 1.0, default=0.42, space='entry', decimals=3, optimize=True, load=True)
    # 36 hours strict
    buy_pump_pull_threshold_5 = DecimalParameter(1.5, 3.0, default=2.0, space='entry', decimals=2, optimize=True, load=True)
    buy_pump_threshold_5 = DecimalParameter(0.4, 1.0, default=0.58, space='entry', decimals=3, optimize=True, load=True)
    # 48 hours strict
    buy_pump_pull_threshold_6 = DecimalParameter(1.5, 3.0, default=2.0, space='entry', decimals=2, optimize=True, load=True)
    buy_pump_threshold_6 = DecimalParameter(0.4, 1.0, default=0.8, space='entry', decimals=3, optimize=True, load=True)

    # 24 hours loose
    buy_pump_pull_threshold_7 = DecimalParameter(1.5, 3.0, default=1.7, space='entry', decimals=2, optimize=True, load=True)
    buy_pump_threshold_7 = DecimalParameter(0.4, 1.0, default=0.66, space='entry', decimals=3, optimize=True, load=True)
    # 36 hours loose
    buy_pump_pull_threshold_8 = DecimalParameter(1.5, 3.0, default=1.7, space='entry', decimals=2, optimize=True, load=True)
    buy_pump_threshold_8 = DecimalParameter(0.4, 1.0, default=0.7, space='entry', decimals=3, optimize=True, load=True)
    # 48 hours loose
    buy_pump_pull_threshold_9 = DecimalParameter(1.3, 2.0, default=1.4, space='entry', decimals=2, optimize=True, load=True)
    buy_pump_threshold_9 = DecimalParameter(0.4, 1.8, default=1.6, space='entry', decimals=3, optimize=True, load=True)

    buy_min_inc_1 = DecimalParameter(0.01, 0.05, default=0.022, space='entry', decimals=3, optimize=True, load=True)
    buy_rsi_1h_min_1 = DecimalParameter(25.0, 40.0, default=30.0, space='entry', decimals=1, optimize=True, load=True)
    buy_rsi_1h_max_1 = DecimalParameter(70.0, 90.0, default=84.0, space='entry', decimals=1, optimize=True, load=True)
    buy_rsi_1 = DecimalParameter(20.0, 40.0, default=36.0, space='entry', decimals=1, optimize=True, load=True)
    buy_mfi_1 = DecimalParameter(20.0, 40.0, default=36.0, space='entry', decimals=1, optimize=True, load=True)

    buy_rsi_1h_min_2 = DecimalParameter(30.0, 40.0, default=32.0, space='entry', decimals=1, optimize=True, load=True)
    buy_rsi_1h_max_2 = DecimalParameter(70.0, 95.0, default=84.0, space='entry', decimals=1, optimize=True, load=True)
    buy_rsi_1h_diff_2 = DecimalParameter(30.0, 50.0, default=39.0, space='entry', decimals=1, optimize=True, load=True)
    buy_mfi_2 = DecimalParameter(30.0, 56.0, default=49.0, space='entry', decimals=1, optimize=True, load=True)
    buy_bb_offset_2 = DecimalParameter(0.97, 0.999, default=0.983, space='entry', decimals=3, optimize=True, load=True)

    buy_bb40_bbdelta_close_3 = DecimalParameter(0.005, 0.06, default=0.057, space='entry', optimize=True, load=True)
    buy_bb40_closedelta_close_3 = DecimalParameter(0.01, 0.03, default=0.023, space='entry', optimize=True, load=True)
    buy_bb40_tail_bbdelta_3 = DecimalParameter(0.15, 0.45, default=0.418, space='entry', optimize=True, load=True)
    buy_ema_rel_3 = DecimalParameter(0.97, 0.999, default=0.986, space='entry', decimals=3, optimize=True, load=True)

    buy_bb20_close_bblowerband_4 = DecimalParameter(0.96, 0.99, default=0.979, space='entry', optimize=True, load=True)
    buy_bb20_volume_4 = DecimalParameter(1.0, 20.0, default=10.0, space='entry', decimals=2, optimize=True, load=True)

    buy_ema_open_mult_5 = DecimalParameter(0.016, 0.03, default=0.018, space='entry', decimals=3, optimize=True, load=True)
    buy_bb_offset_5 = DecimalParameter(0.98, 1.0, default=0.996, space='entry', decimals=3, optimize=True, load=True)
    buy_ema_rel_5 = DecimalParameter(0.97, 0.999, default=0.982, space='entry', decimals=3, optimize=True, load=True)

    buy_ema_open_mult_6 = DecimalParameter(0.02, 0.03, default=0.024, space='entry', decimals=3, optimize=True, load=True)
    buy_bb_offset_6 = DecimalParameter(0.98, 0.999, default=0.984, space='entry', decimals=3, optimize=True, load=True)

    buy_ema_open_mult_7 = DecimalParameter(0.02, 0.04, default=0.03, space='entry', decimals=3, optimize=True, load=True)
    buy_rsi_7 = DecimalParameter(24.0, 50.0, default=36.0, space='entry', decimals=1, optimize=True, load=True)

    buy_volume_8 = DecimalParameter(1.0, 6.0, default=2.0, space='entry', decimals=1, optimize=True, load=True)
    buy_rsi_8 = DecimalParameter(16.0, 30.0, default=20.0, space='entry', decimals=1, optimize=True, load=True)
    buy_tail_diff_8 = DecimalParameter(3.0, 10.0, default=3.5, space='entry', decimals=1, optimize=True, load=True)

    buy_ma_offset_9 = DecimalParameter(0.91, 0.94, default=0.922, space='entry', decimals=3, optimize=True, load=True)
    buy_bb_offset_9 = DecimalParameter(0.96, 0.98, default=0.965, space='entry', decimals=3, optimize=True, load=True)
    buy_rsi_1h_min_9 = DecimalParameter(26.0, 40.0, default=30.0, space='entry', decimals=1, optimize=True, load=True)
    buy_rsi_1h_max_9 = DecimalParameter(70.0, 90.0, default=88.0, space='entry', decimals=1, optimize=True, load=True)
    buy_mfi_9 = DecimalParameter(36.0, 56.0, default=50.0, space='entry', decimals=1, optimize=True, load=True)

    buy_ma_offset_10 = DecimalParameter(0.93, 0.97, default=0.948, space='entry', decimals=3, optimize=True, load=True)
    buy_bb_offset_10 = DecimalParameter(0.97, 0.99, default=0.994, space='entry', decimals=3, optimize=True, load=True)
    buy_rsi_1h_10 = DecimalParameter(20.0, 40.0, default=37.0, space='entry', decimals=1, optimize=True, load=True)

    buy_ma_offset_11 = DecimalParameter(0.93, 0.99, default=0.939, space='entry', decimals=3, optimize=True, load=True)
    buy_min_inc_11 = DecimalParameter(0.005, 0.05, default=0.01, space='entry', decimals=3, optimize=True, load=True)
    buy_rsi_1h_min_11 = DecimalParameter(40.0, 60.0, default=56.0, space='entry', decimals=1, optimize=True, load=True)
    buy_rsi_1h_max_11 = DecimalParameter(70.0, 90.0, default=84.0, space='entry', decimals=1, optimize=True, load=True)
    buy_rsi_11 = DecimalParameter(34.0, 50.0, default=48.0, space='entry', decimals=1, optimize=True, load=True)
    buy_mfi_11 = DecimalParameter(30.0, 46.0, default=36.0, space='entry', decimals=1, optimize=True, load=True)

    buy_ma_offset_12 = DecimalParameter(0.93, 0.97, default=0.922, space='entry', decimals=3, optimize=True, load=True)
    buy_rsi_12 = DecimalParameter(26.0, 40.0, default=30.0, space='entry', decimals=1, optimize=True, load=True)
    buy_ewo_12 = DecimalParameter(1.0, 6.0, default=1.8, space='entry', decimals=1, optimize=True, load=True)

    buy_ma_offset_13 = DecimalParameter(0.93, 0.98, default=0.99, space='entry', decimals=3, optimize=True, load=True)
    buy_ewo_13 = DecimalParameter(-14.0, -7.0, default=-11.8, space='entry', decimals=1, optimize=True, load=True)

    buy_ema_open_mult_14 = DecimalParameter(0.01, 0.03, default=0.014, space='entry', decimals=3, optimize=True, load=True)
    buy_bb_offset_14 = DecimalParameter(0.98, 1.0, default=0.988, space='entry', decimals=3, optimize=True, load=True)
    buy_ma_offset_14 = DecimalParameter(0.93, 0.99, default=0.98, space='entry', decimals=3, optimize=True, load=True)

    buy_ema_open_mult_15 = DecimalParameter(0.01, 0.03, default=0.018, space='entry', decimals=3, optimize=True, load=True)
    buy_ma_offset_15 = DecimalParameter(0.93, 0.99, default=0.954, space='entry', decimals=3, optimize=True, load=True)
    buy_rsi_15 = DecimalParameter(20.0, 36.0, default=28.0, space='entry', decimals=1, optimize=True, load=True)
    buy_ema_rel_15 = DecimalParameter(0.97, 0.999, default=0.988, space='entry', decimals=3, optimize=True, load=True)

    buy_ma_offset_16 = DecimalParameter(0.93, 0.97, default=0.952, space='entry', decimals=3, optimize=True, load=True)
    buy_rsi_16 = DecimalParameter(26.0, 50.0, default=31.0, space='entry', decimals=1, optimize=True, load=True)
    buy_ewo_16 = DecimalParameter(2.0, 6.0, default=2.8, space='entry', decimals=1, optimize=True, load=True)

    buy_ma_offset_17 = DecimalParameter(0.93, 0.98, default=0.952, space='entry', decimals=3, optimize=True, load=True)
    buy_ewo_17 = DecimalParameter(-18.0, -10.0, default=-12.0, space='entry', decimals=1, optimize=True, load=True)

    buy_rsi_18 = DecimalParameter(16.0, 32.0, default=26.0, space='entry', decimals=1, optimize=True, load=True)
    buy_bb_offset_18 = DecimalParameter(0.98, 1.0, default=0.982, space='entry', decimals=3, optimize=True, load=True)

    buy_rsi_1h_min_19 = DecimalParameter(40.0, 70.0, default=50.0, space='entry', decimals=1, optimize=True, load=True)
    buy_chop_min_19 = DecimalParameter(20.0, 60.0, default=24.1, space='entry', decimals=1, optimize=True, load=True)

    buy_rsi_20 = DecimalParameter(20.0, 36.0, default=27.0, space='entry', decimals=1, optimize=True, load=True)
    buy_rsi_1h_20 = DecimalParameter(14.0, 30.0, default=20.0, space='entry', decimals=1, optimize=True, load=True)

    buy_rsi_21 = DecimalParameter(10.0, 28.0, default=23.0, space='entry', decimals=1, optimize=True, load=True)
    buy_rsi_1h_21 = DecimalParameter(18.0, 40.0, default=24.0, space='entry', decimals=1, optimize=True, load=True)

    buy_volume_22 = DecimalParameter(0.5, 6.0, default=3.0, space='entry', decimals=1, optimize=True, load=True)
    buy_bb_offset_22 = DecimalParameter(0.98, 1.0, default=0.98, space='entry', decimals=3, optimize=True, load=True)
    buy_ma_offset_22 = DecimalParameter(0.93, 0.98, default=0.94, space='entry', decimals=3, optimize=True, load=True)
    buy_ewo_22 = DecimalParameter(2.0, 10.0, default=4.2, space='entry', decimals=1, optimize=True, load=True)
    buy_rsi_22 = DecimalParameter(26.0, 56.0, default=37.0, space='entry', decimals=1, optimize=True, load=True)

    buy_bb_offset_23 = DecimalParameter(0.97, 1.0, default=0.987, space='entry', decimals=3, optimize=True, load=True)
    buy_ewo_23 = DecimalParameter(2.0, 10.0, default=7.0, space='entry', decimals=1, optimize=True, load=True)
    buy_rsi_23 = DecimalParameter(20.0, 40.0, default=30.0, space='entry', decimals=1, optimize=True, load=True)
    buy_rsi_1h_23 = DecimalParameter(60.0, 80.0, default=70.0, space='entry', decimals=1, optimize=True, load=True)

    buy_24_rsi_max = DecimalParameter(26.0, 60.0, default=60.0, space='entry', decimals=1, optimize=True, load=True)
    buy_24_rsi_1h_min = DecimalParameter(40.0, 90.0, default=66.9, space='entry', decimals=1, optimize=True, load=True)

    # Sell

    sell_condition_1_enable = CategoricalParameter([True, False], default=True, space='exit', optimize=True, load=True)
    sell_condition_2_enable = CategoricalParameter([True, False], default=True, space='exit', optimize=True, load=True)
    sell_condition_3_enable = CategoricalParameter([True, False], default=True, space='exit', optimize=True, load=True)
    sell_condition_4_enable = CategoricalParameter([True, False], default=True, space='exit', optimize=True, load=True)
    sell_condition_5_enable = CategoricalParameter([True, False], default=True, space='exit', optimize=True, load=True)
    sell_condition_6_enable = CategoricalParameter([True, False], default=True, space='exit', optimize=True, load=True)
    sell_condition_7_enable = CategoricalParameter([True, False], default=True, space='exit', optimize=True, load=True)
    sell_condition_8_enable = CategoricalParameter([True, False], default=True, space='exit', optimize=True, load=True)

    sell_rsi_bb_1 = DecimalParameter(60.0, 80.0, default=79.5, space='exit', decimals=1, optimize=True, load=True)

    sell_rsi_bb_2 = DecimalParameter(72.0, 90.0, default=81, space='exit', decimals=1, optimize=True, load=True)

    sell_rsi_main_3 = DecimalParameter(77.0, 90.0, default=82, space='exit', decimals=1, optimize=True, load=True)

    sell_dual_rsi_rsi_4 = DecimalParameter(72.0, 84.0, default=73.4, space='exit', decimals=1, optimize=True, load=True)
    sell_dual_rsi_rsi_1h_4 = DecimalParameter(78.0, 92.0, default=79.6, space='exit', decimals=1, optimize=True, load=True)

    sell_ema_relative_5 = DecimalParameter(0.005, 0.05, default=0.024, space='exit', optimize=True, load=True)
    sell_rsi_diff_5 = DecimalParameter(0.0, 20.0, default=4.4, space='exit', optimize=True, load=True)

    sell_rsi_under_6 = DecimalParameter(72.0, 90.0, default=79.0, space='exit', decimals=1, optimize=True, load=True)

    sell_rsi_1h_7 = DecimalParameter(80.0, 95.0, default=81.7, space='exit', decimals=1, optimize=True, load=True)

    sell_bb_relative_8 = DecimalParameter(1.05, 1.3, default=1.1, space='exit', decimals=3, optimize=True, load=True)

    sell_custom_profit_0 = DecimalParameter(0.01, 0.1, default=0.01, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_rsi_0 = DecimalParameter(30.0, 40.0, default=33.0, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_profit_1 = DecimalParameter(0.01, 0.1, default=0.02, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_rsi_1 = DecimalParameter(30.0, 50.0, default=34.0, space='exit', decimals=2, optimize=True, load=True)
    sell_custom_profit_2 = DecimalParameter(0.01, 0.1, default=0.03, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_rsi_2 = DecimalParameter(30.0, 50.0, default=38.0, space='exit', decimals=2, optimize=True, load=True)
    sell_custom_profit_3 = DecimalParameter(0.01, 0.1, default=0.04, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_rsi_3 = DecimalParameter(30.0, 50.0, default=42.0, space='exit', decimals=2, optimize=True, load=True)
    sell_custom_profit_4 = DecimalParameter(0.01, 0.1, default=0.05, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_rsi_4 = DecimalParameter(35.0, 50.0, default=43.0, space='exit', decimals=2, optimize=True, load=True)
    sell_custom_profit_5 = DecimalParameter(0.01, 0.1, default=0.06, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_rsi_5 = DecimalParameter(35.0, 50.0, default=44.0, space='exit', decimals=2, optimize=True, load=True)
    sell_custom_profit_6 = DecimalParameter(0.01, 0.1, default=0.07, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_rsi_6 = DecimalParameter(38.0, 55.0, default=49.0, space='exit', decimals=2, optimize=True, load=True)
    sell_custom_profit_7 = DecimalParameter(0.01, 0.1, default=0.08, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_rsi_7 = DecimalParameter(40.0, 58.0, default=54.0, space='exit', decimals=2, optimize=True, load=True)
    sell_custom_profit_8 = DecimalParameter(0.06, 0.1, default=0.09, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_rsi_8 = DecimalParameter(40.0, 50.0, default=54.0, space='exit', decimals=2, optimize=True, load=True)
    sell_custom_profit_9 = DecimalParameter(0.05, 0.14, default=0.1, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_rsi_9 = DecimalParameter(40.0, 60.0, default=50.0, space='exit', decimals=2, optimize=True, load=True)
    sell_custom_profit_10 = DecimalParameter(0.1, 0.14, default=0.12, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_rsi_10 = DecimalParameter(38.0, 50.0, default=42.0, space='exit', decimals=2, optimize=True, load=True)
    sell_custom_profit_11 = DecimalParameter(0.16, 0.45, default=0.20, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_rsi_11 = DecimalParameter(28.0, 40.0, default=34.0, space='exit', decimals=2, optimize=True, load=True)

    # Profit under EMA200
    sell_custom_under_profit_0 = DecimalParameter(0.01, 0.4, default=0.01, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_under_rsi_0 = DecimalParameter(28.0, 40.0, default=33.0, space='exit', decimals=1, optimize=True, load=True)
    sell_custom_under_profit_1 = DecimalParameter(0.01, 0.10, default=0.02, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_under_rsi_1 = DecimalParameter(36.0, 60.0, default=56.0, space='exit', decimals=1, optimize=True, load=True)
    sell_custom_under_profit_2 = DecimalParameter(0.01, 0.10, default=0.03, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_under_rsi_2 = DecimalParameter(46.0, 66.0, default=57.0, space='exit', decimals=1, optimize=True, load=True)
    sell_custom_under_profit_3 = DecimalParameter(0.01, 0.10, default=0.04, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_under_rsi_3 = DecimalParameter(50.0, 68.0, default=58.0, space='exit', decimals=1, optimize=True, load=True)
    sell_custom_under_profit_4 = DecimalParameter(0.02, 0.1, default=0.05, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_under_rsi_4 = DecimalParameter(50.0, 68.0, default=59.0, space='exit', decimals=1, optimize=True, load=True)
    sell_custom_under_profit_5 = DecimalParameter(0.02, 0.1, default=0.06, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_under_rsi_5 = DecimalParameter(46.0, 62.0, default=58.0, space='exit', decimals=1, optimize=True, load=True)
    sell_custom_under_profit_6 = DecimalParameter(0.03, 0.1, default=0.07, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_under_rsi_6 = DecimalParameter(44.0, 60.0, default=56.0, space='exit', decimals=1, optimize=True, load=True)
    sell_custom_under_profit_7 = DecimalParameter(0.04, 0.1, default=0.08, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_under_rsi_7 = DecimalParameter(46.0, 60.0, default=54.0, space='exit', decimals=1, optimize=True, load=True)
    sell_custom_under_profit_8 = DecimalParameter(0.06, 0.12, default=0.09, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_under_rsi_8 = DecimalParameter(40.0, 58.0, default=50.0, space='exit', decimals=1, optimize=True, load=True)
    sell_custom_under_profit_9 = DecimalParameter(0.08, 0.14, default=0.1, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_under_rsi_9 = DecimalParameter(32.0, 48.0, default=44.0, space='exit', decimals=1, optimize=True, load=True)
    sell_custom_under_profit_10 = DecimalParameter(0.1, 0.16, default=0.12, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_under_rsi_10 = DecimalParameter(30.0, 50.0, default=42.0, space='exit', decimals=1, optimize=True, load=True)
    sell_custom_under_profit_11 = DecimalParameter(0.16, 0.3, default=0.2, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_under_rsi_11 = DecimalParameter(24.0, 40.0, default=34.0, space='exit', decimals=1, optimize=True, load=True)

    # Profit targets for pumped pairs 48h 1
    sell_custom_pump_profit_1_1 = DecimalParameter(0.01, 0.03, default=0.01, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_pump_rsi_1_1 = DecimalParameter(26.0, 40.0, default=34.0, space='exit', decimals=1, optimize=True, load=True)
    sell_custom_pump_profit_1_2 = DecimalParameter(0.01, 0.6, default=0.02, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_pump_rsi_1_2 = DecimalParameter(36.0, 50.0, default=40.0, space='exit', decimals=1, optimize=True, load=True)
    sell_custom_pump_profit_1_3 = DecimalParameter(0.02, 0.10, default=0.04, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_pump_rsi_1_3 = DecimalParameter(38.0, 50.0, default=42.0, space='exit', decimals=1, optimize=True, load=True)
    sell_custom_pump_profit_1_4 = DecimalParameter(0.06, 0.12, default=0.1, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_pump_rsi_1_4 = DecimalParameter(36.0, 48.0, default=42.0, space='exit', decimals=1, optimize=True, load=True)
    sell_custom_pump_profit_1_5 = DecimalParameter(0.14, 0.24, default=0.2, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_pump_rsi_1_5 = DecimalParameter(20.0, 40.0, default=34.0, space='exit', decimals=1, optimize=True, load=True)

    # Profit targets for pumped pairs 36h 1
    sell_custom_pump_profit_2_1 = DecimalParameter(0.01, 0.03, default=0.01, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_pump_rsi_2_1 = DecimalParameter(26.0, 40.0, default=34.0, space='exit', decimals=1, optimize=True, load=True)
    sell_custom_pump_profit_2_2 = DecimalParameter(0.01, 0.6, default=0.02, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_pump_rsi_2_2 = DecimalParameter(36.0, 50.0, default=40.0, space='exit', decimals=1, optimize=True, load=True)
    sell_custom_pump_profit_2_3 = DecimalParameter(0.02, 0.10, default=0.04, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_pump_rsi_2_3 = DecimalParameter(38.0, 50.0, default=40.0, space='exit', decimals=1, optimize=True, load=True)
    sell_custom_pump_profit_2_4 = DecimalParameter(0.06, 0.12, default=0.1, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_pump_rsi_2_4 = DecimalParameter(36.0, 48.0, default=42.0, space='exit', decimals=1, optimize=True, load=True)
    sell_custom_pump_profit_2_5 = DecimalParameter(0.14, 0.24, default=0.2, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_pump_rsi_2_5 = DecimalParameter(20.0, 40.0, default=34.0, space='exit', decimals=1, optimize=True, load=True)

    # Profit targets for pumped pairs 24h 1
    sell_custom_pump_profit_3_1 = DecimalParameter(0.01, 0.03, default=0.01, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_pump_rsi_3_1 = DecimalParameter(26.0, 40.0, default=34.0, space='exit', decimals=1, optimize=True, load=True)
    sell_custom_pump_profit_3_2 = DecimalParameter(0.01, 0.6, default=0.02, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_pump_rsi_3_2 = DecimalParameter(34.0, 50.0, default=40.0, space='exit', decimals=1, optimize=True, load=True)
    sell_custom_pump_profit_3_3 = DecimalParameter(0.02, 0.10, default=0.04, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_pump_rsi_3_3 = DecimalParameter(38.0, 50.0, default=40.0, space='exit', decimals=1, optimize=True, load=True)
    sell_custom_pump_profit_3_4 = DecimalParameter(0.06, 0.12, default=0.1, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_pump_rsi_3_4 = DecimalParameter(36.0, 48.0, default=42.0, space='exit', decimals=1, optimize=True, load=True)
    sell_custom_pump_profit_3_5 = DecimalParameter(0.14, 0.24, default=0.2, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_pump_rsi_3_5 = DecimalParameter(20.0, 40.0, default=34.0, space='exit', decimals=1, optimize=True, load=True)

    # SMA descending
    sell_custom_dec_profit_min_1 = DecimalParameter(0.01, 0.10, default=0.05, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_dec_profit_max_1 = DecimalParameter(0.06, 0.16, default=0.12, space='exit', decimals=3, optimize=True, load=True)

    # Under EMA100
    sell_custom_dec_profit_min_2 = DecimalParameter(0.05, 0.12, default=0.07, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_dec_profit_max_2 = DecimalParameter(0.06, 0.2, default=0.16, space='exit', decimals=3, optimize=True, load=True)

    # Trail 1
    sell_trail_profit_min_1 = DecimalParameter(0.1, 0.2, default=0.16, space='exit', decimals=2, optimize=True, load=True)
    sell_trail_profit_max_1 = DecimalParameter(0.4, 0.7, default=0.6, space='exit', decimals=2, optimize=True, load=True)
    sell_trail_down_1 = DecimalParameter(0.01, 0.08, default=0.03, space='exit', decimals=3, optimize=True, load=True)
    sell_trail_rsi_min_1 = DecimalParameter(16.0, 36.0, default=20.0, space='exit', decimals=1, optimize=True, load=True)
    sell_trail_rsi_max_1 = DecimalParameter(30.0, 50.0, default=50.0, space='exit', decimals=1, optimize=True, load=True)

    # Trail 2
    sell_trail_profit_min_2 = DecimalParameter(0.08, 0.16, default=0.1, space='exit', decimals=3, optimize=True, load=True)
    sell_trail_profit_max_2 = DecimalParameter(0.3, 0.5, default=0.4, space='exit', decimals=2, optimize=True, load=True)
    sell_trail_down_2 = DecimalParameter(0.02, 0.08, default=0.03, space='exit', decimals=3, optimize=True, load=True)
    sell_trail_rsi_min_2 = DecimalParameter(16.0, 36.0, default=20.0, space='exit', decimals=1, optimize=True, load=True)
    sell_trail_rsi_max_2 = DecimalParameter(30.0, 50.0, default=50.0, space='exit', decimals=1, optimize=True, load=True)

    # Trail 3
    sell_trail_profit_min_3 = DecimalParameter(0.01, 0.12, default=0.06, space='exit', decimals=3, optimize=True, load=True)
    sell_trail_profit_max_3 = DecimalParameter(0.1, 0.3, default=0.2, space='exit', decimals=2, optimize=True, load=True)
    sell_trail_down_3 = DecimalParameter(0.01, 0.06, default=0.05, space='exit', decimals=3, optimize=True, load=True)

    # Under & near EMA200, accept profit
    sell_custom_profit_under_rel_1 = DecimalParameter(0.01, 0.04, default=0.024, space='exit', optimize=True, load=True)
    sell_custom_profit_under_rsi_diff_1 = DecimalParameter(0.0, 20.0, default=4.4, space='exit', optimize=True, load=True)

    # Under & near EMA200, take the loss
    sell_custom_stoploss_under_rel_1 = DecimalParameter(0.001, 0.02, default=0.004, space='exit', optimize=True, load=True)
    sell_custom_stoploss_under_rsi_diff_1 = DecimalParameter(0.0, 20.0, default=8.0, space='exit', optimize=True, load=True)

    # 48h for pump sell checks
    sell_pump_threshold_1 = DecimalParameter(0.5, 1.2, default=0.9, space='exit', decimals=2, optimize=True, load=True)
    sell_pump_threshold_2 = DecimalParameter(0.4, 0.9, default=0.7, space='exit', decimals=2, optimize=True, load=True)
    sell_pump_threshold_3 = DecimalParameter(0.3, 0.7, default=0.5, space='exit', decimals=2, optimize=True, load=True)

    # 36h for pump sell checks
    sell_pump_threshold_4 = DecimalParameter(0.5, 0.9, default=0.72, space='exit', decimals=2, optimize=True, load=True)
    sell_pump_threshold_5 = DecimalParameter(3.0, 6.0, default=4.0, space='exit', decimals=2, optimize=True, load=True)
    sell_pump_threshold_6 = DecimalParameter(0.8, 1.6, default=1.0, space='exit', decimals=2, optimize=True, load=True)

    # 24h for pump sell checks
    sell_pump_threshold_7 = DecimalParameter(0.5, 0.9, default=0.68, space='exit', decimals=2, optimize=True, load=True)
    sell_pump_threshold_8 = DecimalParameter(0.3, 0.6, default=0.62, space='exit', decimals=2, optimize=True, load=True)
    sell_pump_threshold_9 = DecimalParameter(0.2, 0.5, default=0.3, space='exit', decimals=2, optimize=True, load=True)

    # Pumped, descending SMA
    sell_custom_pump_dec_profit_min_1 = DecimalParameter(0.001, 0.04, default=0.005, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_pump_dec_profit_max_1 = DecimalParameter(0.03, 0.08, default=0.05, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_pump_dec_profit_min_2 = DecimalParameter(0.01, 0.08, default=0.04, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_pump_dec_profit_max_2 = DecimalParameter(0.04, 0.1, default=0.06, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_pump_dec_profit_min_3 = DecimalParameter(0.02, 0.1, default=0.06, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_pump_dec_profit_max_3 = DecimalParameter(0.06, 0.12, default=0.09, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_pump_dec_profit_min_4 = DecimalParameter(0.01, 0.05, default=0.02, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_pump_dec_profit_max_4 = DecimalParameter(0.02, 0.1, default=0.04, space='exit', decimals=3, optimize=True, load=True)


    # Pumped 48h 1, under EMA200
    sell_custom_pump_under_profit_min_1 = DecimalParameter(0.02, 0.06, default=0.04, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_pump_under_profit_max_1 = DecimalParameter(0.04, 0.1, default=0.09, space='exit', decimals=3, optimize=True, load=True)

    # Pumped trail 1
    sell_custom_pump_trail_profit_min_1 = DecimalParameter(0.01, 0.12, default=0.05, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_pump_trail_profit_max_1 = DecimalParameter(0.06, 0.16, default=0.07, space='exit', decimals=2, optimize=True, load=True)
    sell_custom_pump_trail_down_1 = DecimalParameter(0.01, 0.06, default=0.05, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_pump_trail_rsi_min_1 = DecimalParameter(16.0, 36.0, default=20.0, space='exit', decimals=1, optimize=True, load=True)
    sell_custom_pump_trail_rsi_max_1 = DecimalParameter(30.0, 50.0, default=70.0, space='exit', decimals=1, optimize=True, load=True)

    # Stoploss, pumped, 48h 1
    sell_custom_stoploss_pump_max_profit_1 = DecimalParameter(0.01, 0.04, default=0.025, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_stoploss_pump_min_1 = DecimalParameter(-0.1, -0.01, default=-0.02, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_stoploss_pump_max_1 = DecimalParameter(-0.1, -0.01, default=-0.01, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_stoploss_pump_ma_offset_1 = DecimalParameter(0.7, 0.99, default=0.94, space='exit', decimals=2, optimize=True, load=True)

    # Stoploss, pumped, 48h 1
    sell_custom_stoploss_pump_max_profit_2 = DecimalParameter(0.01, 0.04, default=0.025, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_stoploss_pump_loss_2 = DecimalParameter(-0.1, -0.01, default=-0.05, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_stoploss_pump_ma_offset_2 = DecimalParameter(0.7, 0.99, default=0.92, space='exit', decimals=2, optimize=True, load=True)

    # Stoploss, pumped, 36h 3
    sell_custom_stoploss_pump_max_profit_3 = DecimalParameter(0.01, 0.04, default=0.008, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_stoploss_pump_loss_3 = DecimalParameter(-0.16, -0.06, default=-0.12, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_stoploss_pump_ma_offset_3 = DecimalParameter(0.7, 0.99, default=0.88, space='exit', decimals=2, optimize=True, load=True)
