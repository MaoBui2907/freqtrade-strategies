...
class NFINextMultiOffsetAndHO2(IStrategy):
   ...
   # Multi Offset
    ...
    buy_mfi_1 = DecimalParameter(20.0, 40.0, default=44.0, space='entry', decimals=1, optimize=False, load=True)
    ...
    buy_cti_8 = DecimalParameter(-0.99, -0.5, default=-0.9, space='entry', decimals=2, optimize=False, load=True)
    buy_rsi_8 = DecimalParameter(20.0, 50.0, default=30.0, space='entry', decimals=1, optimize=False, load=True)
    buy_rsi_1h_8 = DecimalParameter(40.0, 66.0, default=54.0, space='entry', decimals=1, optimize=False, load=True)
    buy_volume_8 = DecimalParameter(0.6, 6.0, default=1.2, space='entry', decimals=1, optimize=False, load=True)
    ...
    buy_chop_min_19 = DecimalParameter(20.0, 60.0, default=22.1, space='entry', decimals=1, optimize=False, load=True)
    ...
    buy_ma_offset_22 = DecimalParameter(0.93, 0.98, default=0.941, space='entry', decimals=3, optimize=False, load=True)
    ...
    buy_25_rsi_14 = DecimalParameter(26.0, 40.0, default=38.0, space='entry', decimals=1, optimize=False, load=True)

    buy_26_zema_low_offset = DecimalParameter(0.90, 0.99, default=0.93, space='entry', optimize=False, load=True)

    buy_27_wr_max = DecimalParameter(95, 99, default=95.4, space='entry', decimals=1, optimize=False, load=True)
    ...
    sell_custom_profit_under_profit_1 = DecimalParameter(0.0, 0.01, default=0.0, space='exit', optimize=False, load=True)
