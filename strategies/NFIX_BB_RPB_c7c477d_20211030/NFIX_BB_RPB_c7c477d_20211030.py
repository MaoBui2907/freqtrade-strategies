...
class NFIX_BB_RPB_c7c477d_20211030(IStrategy):
    ...
    def sell_r(self, current_profit: float, max_profit: float, max_loss: float, last_candle, previous_candle_1, trade: 'Trade', current_time: 'datetime') -> tuple:
        if 0.02 > current_profit >= 0.012:
            ...
            elif (last_candle['rsi_14'] < 40.0) and (last_candle['btc_not_downtrend_1h'] is False) and (last_candle['cmf_1h'] < -0.1) and (last_candle['r_480_1h'] > -25.0):
            ...
            elif (last_candle['rsi_14'] < 38.0) and (last_candle['btc_not_downtrend_1h'] is False) and (last_candle['cmf_1h'] < -0.1) and (last_candle['r_480_1h'] > -25.0):
    ...
    def sell_trail(self, current_profit: float, max_profit: float, max_loss: float, last_candle, previous_candle_1, trade: 'Trade', current_time: 'datetime') -> tuple:
        if 0.012 > current_profit >= 0.0:
            ...
            elif (max_profit > (current_profit + 0.07)) and (last_candle['rsi_14'] < 38.0) and (last_candle['btc_not_downtrend_1h'] is False) and (last_candle['cmf'] < -0.0):
