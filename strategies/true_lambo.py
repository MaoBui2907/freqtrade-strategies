...
class true_lambo(IStrategy):
    ...
    buy_clucha_bbdelta_close = DecimalParameter(
        0.0005, 0.042, default=0.034, decimals=5, optimize=is_optimize_clucha
    )
    buy_clucha_bbdelta_tail = DecimalParameter(
        0.7, 1.1, default=0.95, decimals=5, optimize=is_optimize_clucha
    )
    buy_clucha_closedelta_close = DecimalParameter(
        0.0005, 0.025, default=0.019, decimals=5, optimize=is_optimize_clucha
    )
    buy_clucha_rocr_1h = DecimalParameter(
        0.001, 1.0, default=0.131, decimals=5, optimize=is_optimize_clucha
    )

    is_optimize_clucha_2 = False
    buy_clucha_bbdelta_close_2 = DecimalParameter(
        0.0005, 0.042, default=0.034, decimals=5, optimize=is_optimize_clucha_2
    )
    buy_clucha_bbdelta_tail_2 = DecimalParameter(
        0.7, 1.1, default=0.95, decimals=5, optimize=is_optimize_clucha_2
    )
    buy_clucha_closedelta_close_2 = DecimalParameter(
        0.0005, 0.025, default=0.019, decimals=5, optimize=is_optimize_clucha_2
    )
    buy_clucha_rocr_1h_2 = DecimalParameter(
        0.001, 1.0, default=0.131, decimals=5, optimize=is_optimize_clucha_2
    )

    is_optimize_clucha_3 = False
    buy_clucha_bbdelta_close_3 = DecimalParameter(
        0.0005, 0.042, default=0.034, decimals=5, optimize=is_optimize_clucha_3
    )
    buy_clucha_bbdelta_tail_3 = DecimalParameter(
        0.7, 1.1, default=0.95, decimals=5, optimize=is_optimize_clucha_3
    )
    buy_clucha_closedelta_close_3 = DecimalParameter(
        0.0005, 0.025, default=0.019, decimals=5, optimize=is_optimize_clucha_3
    )
    buy_clucha_rocr_1h_3 = DecimalParameter(
        0.001, 1.0, default=0.131, decimals=5, optimize=is_optimize_clucha_3
    )

    is_optimize_clucha_4 = True
    buy_clucha_bbdelta_close_4 = DecimalParameter(
        0.0005, 0.06, default=0.034, decimals=5, optimize=is_optimize_clucha_4
    )
    buy_clucha_bbdelta_tail_4 = DecimalParameter(
        0.35, 1.1, default=0.95, decimals=5, optimize=is_optimize_clucha_4
    )
    buy_clucha_closedelta_close_4 = DecimalParameter(
        0.0005, 0.025, default=0.019, decimals=5, optimize=is_optimize_clucha_4
    )
    ...
    buy_gumbo_tpct_0 = DecimalParameter(
        0.0, 0.25, default=0.131, decimals=2, optimize=is_optimize_gumbo_protection
    )
    buy_gumbo_tpct_3 = DecimalParameter(
        0.0, 0.25, default=0.131, decimals=2, optimize=is_optimize_gumbo_protection
    )
    buy_gumbo_tpct_9 = DecimalParameter(
        0.0, 0.25, default=0.131, decimals=2, optimize=is_optimize_gumbo_protection
    )
    ...
    buy_crash_4_tpct_0 = DecimalParameter(
        0.02, 0.04, default=0.02, decimals=3, optimize=is_optimize_crash_4
    )
    buy_crash_4_tpct_3 = DecimalParameter(
        0.05, 0.10, default=0.05, decimals=2, optimize=is_optimize_crash_4
    )
    buy_crash_4_tpct_9 = DecimalParameter(
        0.13, 0.32, default=0.13, decimals=2, optimize=is_optimize_crash_4
    )

    ## Sell params
    base_nb_candles_sell = IntParameter(
        5, 80, default=sell_params["base_nb_candles_sell"], space="exit", optimize=False
    )
    high_offset = DecimalParameter(
        0.85, 1.1, default=sell_params["high_offset"], space="exit", optimize=True
    )
    high_offset_2 = DecimalParameter(
        0.85, 1.5, default=sell_params["high_offset_2"], space="exit", optimize=True
    )
    ...
    pHSL = DecimalParameter(
        -0.10, -0.040, default=-0.08, decimals=3, space="exit", load=True, optimize=True
    )
    # profit threshold 1, trigger point, SL_1 is used
    pPF_1 = DecimalParameter(
        0.008, 0.020, default=0.016, decimals=3, space="exit", load=True, optimize=True
    )
    pSL_1 = DecimalParameter(
        0.008, 0.020, default=0.011, decimals=3, space="exit", load=True, optimize=True
    )

    # profit threshold 2, SL_2 is used
    pPF_2 = DecimalParameter(
        0.040, 0.100, default=0.080, decimals=3, space="exit", load=True, optimize=True
    )
    pSL_2 = DecimalParameter(
        0.020, 0.070, default=0.040, decimals=3, space="exit", load=True, optimize=True
    )
        ...
        **kwargs,
        ...
        if last_candle["ema_vwap_diff_50"] > 0.02:
            if current_profit >= 0.005:
                if (last_candle["close"] > last_candle["vwap_middleband"] * 0.99) and (
                    last_candle["rsi"] > 41
                ):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        is_pump_2 = dataframe["close"].rolling(48).max() >= (
            dataframe["close"] * self.buy_pump_2_factor.value
        )
        ...
        is_clucHA_2 = (
            ...
            & (
                ...
                & (
                    dataframe["bb_delta_cluc"]
                    > dataframe["ha_close"] * self.buy_clucha_bbdelta_close_2.value
                )
                & (
                    dataframe["ha_closedelta"]
                    > dataframe["ha_close"] * self.buy_clucha_closedelta_close_2.value
                )
                & (
                    dataframe["tail"]
                    < dataframe["bb_delta_cluc"] * self.buy_clucha_bbdelta_tail_2.value
                )
                & (dataframe["ha_close"] < dataframe["bb_lowerband2_40"].shift())
                & (dataframe["ha_close"] < dataframe["ha_close"].shift())
            )
        ...
        is_clucHA_3 = (
            ...
            & (
                ...
                & (
                    dataframe["bb_delta_cluc"]
                    > dataframe["ha_close"] * self.buy_clucha_bbdelta_close_3.value
                )
                & (
                    dataframe["ha_closedelta"]
                    > dataframe["ha_close"] * self.buy_clucha_closedelta_close_3.value
                )
                & (
                    dataframe["tail"]
                    < dataframe["bb_delta_cluc"] * self.buy_clucha_bbdelta_tail_3.value
                )
                & (dataframe["ha_close"] < dataframe["bb_lowerband2_40"].shift())
                & (dataframe["ha_close"] < dataframe["ha_close"].shift())
            )
        ...
        is_clucHA_4 = (
            ...
            & (
                ...
                & (
                    dataframe["bb_delta_cluc"]
                    > dataframe["ha_close"] * self.buy_clucha_bbdelta_close_4.value
                )
                & (
                    dataframe["ha_closedelta"]
                    > dataframe["ha_close"] * self.buy_clucha_closedelta_close_4.value
                )
                & (
                    dataframe["tail"]
                    < dataframe["bb_delta_cluc"] * self.buy_clucha_bbdelta_tail_4.value
                )
                & (dataframe["ha_close"] < dataframe["bb_lowerband2_40"].shift())
                & (dataframe["ha_close"] < dataframe["ha_close"].shift())
            )
        ...
        is_vwap_2 = (
            ...
            & (
                ...
                > dataframe["close"] * self.buy_vwap_closedelta_2.value / 1000
            )
        ...
        is_vwap_3 = (
            ...
            & (
                dataframe["closedelta"]
                > dataframe["close"] * self.buy_vwap_closedelta_3.value / 1000
            )
        ...
        is_vwap_4 = (
            ...
            & (
                dataframe["closedelta"]
                > dataframe["close"] * self.buy_vwap_closedelta_4.value / 1000
            )
        ...
        is_additional_check = (
            (dataframe["rsi_84"] < 60) & (dataframe["rsi_112"] < 60) & (dataframe["volume"] > 0)
        )
