...
class CombinedBinHAndClucV7(IStrategy):
    ...
    buy_dip_threshold_1 = DecimalParameter(
        0.08, 0.2, default=0.14, space="entry", decimals=2, optimize=False, load=True
    )
    buy_dip_threshold_2 = DecimalParameter(
        0.02, 0.4, default=0.34, space="entry", decimals=2, optimize=False, load=True
    )
    buy_dip_threshold_3 = DecimalParameter(
        0.25, 0.44, default=0.38, space="entry", decimals=2, optimize=False, load=True
    )
    ...
    sell_roi_profit_1 = DecimalParameter(
        0.08, 0.16, default=0.1, space="exit", decimals=2, optimize=False, load=True
    )
    sell_roi_rsi_1 = DecimalParameter(
        30.0, 38.0, default=34, space="exit", decimals=2, optimize=False, load=True
    )
    sell_roi_profit_2 = DecimalParameter(
        0.02, 0.05, default=0.03, space="exit", decimals=2, optimize=False, load=True
    )
    sell_roi_rsi_2 = DecimalParameter(
        34.0, 44.0, default=38, space="exit", decimals=2, optimize=False, load=True
    )
    sell_roi_profit_3 = DecimalParameter(
        0.0, 0.0, default=0.0, space="exit", decimals=2, optimize=False, load=True
    )
    sell_roi_rsi_3 = DecimalParameter(
        48.0, 56.0, default=50, space="exit", decimals=2, optimize=False, load=True
    )

    sell_rsi_main = DecimalParameter(
        72.0, 90.0, default=77, space="exit", decimals=2, optimize=True, load=True
    )
