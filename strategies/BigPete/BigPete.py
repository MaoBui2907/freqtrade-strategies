...
class BigPete(IStrategy):
    ...
    buy_condition_0_enable = CategoricalParameter(
        [True, False],
        default=buy_params["buy_condition_0_enable"],
        space="entry",
        optimize=optimize_cond,
        load=True,
    )
    ...
    buy_bb20_close_bblowerband_safe_1 = DecimalParameter(
        0.950,
        1.050,
        default=buy_params["buy_bb20_close_bblowerband_safe_1"],
        decimals=3,
        space="entry",
        optimize=opzimize_buy_params,
        load=True,
    )
    buy_bb20_close_bblowerband_safe_2 = DecimalParameter(
        0.700,
        1.100,
        default=buy_params["buy_bb20_close_bblowerband_safe_2"],
        decimals=2,
        space="entry",
        optimize=opzimize_buy_params,
        load=True,
    ...
    buy_volume_pump_1 = DecimalParameter(
        0.1,
        0.9,
        default=buy_params["buy_volume_pump_1"],
        space="entry",
        decimals=1,
        optimize=opzimize_buy_params,
        load=True,
    ...
    buy_volume_drop_1 = DecimalParameter(
        1,
        10,
        default=buy_params["buy_volume_drop_1"],
        space="entry",
        decimals=1,
        optimize=opzimize_buy_params,
        load=True,
    ...
    buy_volume_drop_2 = DecimalParameter(
        1,
        10,
        default=buy_params["buy_volume_drop_2"],
        space="entry",
        decimals=1,
        optimize=opzimize_buy_params,
        load=True,
    ...
    buy_volume_drop_3 = DecimalParameter(
        1,
        10,
        default=buy_params["buy_volume_drop_3"],
        space="entry",
        decimals=1,
        optimize=opzimize_buy_params,
        load=True,
    ...
    buy_rsi_1h_0 = DecimalParameter(
        55.0,
        85.0,
        default=buy_params["buy_rsi_1h_0"],
        space="entry",
        decimals=1,
        optimize=opzimize_buy_params,
        load=True,
    ...
    buy_rsi_1h_1a = DecimalParameter(
        65.0,
        78.0,
        default=buy_params["buy_rsi_1h_1a"],
        space="entry",
        decimals=1,
        optimize=opzimize_buy_params,
        load=True,
    ...
    buy_rsi_1h_1 = DecimalParameter(
        10.0,
        40.0,
        default=buy_params["buy_rsi_1h_1"],
        space="entry",
        decimals=1,
        optimize=opzimize_buy_params,
        load=True,
    ...
    buy_rsi_1h_2 = DecimalParameter(
        10.0,
        40.0,
        default=buy_params["buy_rsi_1h_2"],
        space="entry",
        decimals=1,
        optimize=opzimize_buy_params,
        load=True,
    ...
    buy_rsi_1h_3 = DecimalParameter(
        10.0,
        40.0,
        default=buy_params["buy_rsi_1h_3"],
        space="entry",
        decimals=1,
        optimize=opzimize_buy_params,
        load=True,
    ...
    buy_rsi_1h_4 = DecimalParameter(
        10.0,
        40.0,
        default=buy_params["buy_rsi_1h_4"],
        space="entry",
        decimals=1,
        optimize=opzimize_buy_params,
        load=True,
    ...
    buy_rsi_1h_5 = DecimalParameter(
        10.0,
        60.0,
        default=buy_params["buy_rsi_1h_5"],
        space="entry",
        decimals=1,
        optimize=opzimize_buy_params,
        load=True,
    ...
    trade_time = IntParameter(
        25, 65, default=sell_params["trade_time"], space="exit", optimize=opzimize_cSL, load=True
    )
    rsi_1h_val = IntParameter(
        25, 45, default=sell_params["rsi_1h_val"], space="exit", optimize=opzimize_cSL, load=True
    )
    narrow_stop = DecimalParameter(
        1.005,
        1.030,
        default=sell_params["narrow_stop"],
        space="exit",
        decimals=3,
        optimize=opzimize_cSL,
        load=True,
    )
    wide_stop = DecimalParameter(
        1.010,
        1.045,
        default=sell_params["wide_stop"],
        space="exit",
        decimals=3,
        optimize=opzimize_cSL,
        load=True,
    ...
    base_nb_candles_sell = IntParameter(
        5, 80, default=sell_params["base_nb_candles_sell"], space="exit", optimize=False, load=True
    )
    high_offset = DecimalParameter(
        0.99, 1.1, default=sell_params["high_offset"], space="exit", optimize=False, load=True
    )
    ...
    pPF_1 = DecimalParameter(
        0.008,
        0.020,
        default=sell_params["pPF_1"],
        decimals=3,
        space="exit",
        optimize=optimize_SLT,
        load=True,
    )
    pSL_1 = DecimalParameter(
        0.008,
        0.020,
        default=sell_params["pSL_1"],
        decimals=3,
        space="exit",
        optimize=optimize_SLT,
        load=True,
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        cond11 = (
            ...
            & (dataframe["volume"] > 0)
        ).astype(int)  # Make sure Volume is not 0
