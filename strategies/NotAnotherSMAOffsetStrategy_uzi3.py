        ...
        if (
            ...
            * 100
            ...
            self.base_nb_candles_buy = IntParameter(
                5, 80, default=14, space="entry", optimize=False
            )
            self.low_offset = DecimalParameter(
                0.9, 0.99, default=0.975, space="entry", optimize=False
            )
            self.low_offset_2 = DecimalParameter(
                0.9, 0.99, default=0.955, space="entry", optimize=False
            )
            self.ewo_low = DecimalParameter(
                -20.0, -8.0, default=-20.988, space="entry", optimize=False
            )
            self.ewo_high = DecimalParameter(
                2.0, 12.0, default=2.327, space="entry", optimize=False
            )
            self.ewo_high_2 = DecimalParameter(
                -6.0, 12.0, default=-2.327, space="entry", optimize=False
            )
            ...
            self.high_offset = DecimalParameter(
                0.95, 1.1, default=0.991, space="exit", optimize=True
            )
            self.high_offset_2 = DecimalParameter(
                0.99, 1.5, default=0.997, space="exit", optimize=True
            )
            ...
            self.low_offset = DecimalParameter(
                0.9, 0.99, default=0.986, space="entry", optimize=False
            )
            self.low_offset_2 = DecimalParameter(
                0.9, 0.99, default=0.944, space="entry", optimize=False
            )
            self.ewo_low = DecimalParameter(
                -20.0, -8.0, default=-16.917, space="entry", optimize=False
            )
            self.ewo_high = DecimalParameter(
                2.0, 12.0, default=4.179, space="entry", optimize=False
            )
            self.ewo_high_2 = DecimalParameter(
                -6.0, 12.0, default=-2.609, space="entry", optimize=False
            )
            ...
            self.base_nb_candles_sell = IntParameter(5, 80, default=16, space="exit", optimize=True)
            self.high_offset = DecimalParameter(
                0.95, 1.1, default=1.054, space="exit", optimize=True
            )
            self.high_offset_2 = DecimalParameter(
                0.99, 1.5, default=1.018, space="exit", optimize=True
            )
