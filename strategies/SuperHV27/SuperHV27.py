...
class SuperHV27(IStrategy):
    ...
    sell_params = {"adx2": 36, "emarsi1": 43, "emarsi2": 27, "emarsi3": 26}

    # ROI table:
    minimal_roi = {"0": 0.10, "30": 0.05, "40": 0.025, "60": 0.015, "720": 0.01, "1440": 0}
        ...
        conditions.append(
            (
                ...
                | (
                    ...
                    & dataframe["highsma"].gt(0)
                    & (
                        dataframe["emarsi"].ge(params["emarsi1"])
    ...
    def min_roi_reached_entry(self, trade_dur: int) -> Tuple[Optional[int], Optional[float]]:
        ...
        if dynamic_roi and dynamic_roi["enabled"]:
            ...
            # exponential decay: f(t) = start * e^(-rate*t)
                ...
                min_roi = max(
                    dynamic_roi["end"],
                    dynamic_roi["start"] * np.exp(-dynamic_roi["decay-rate"] * trade_dur),
                )
