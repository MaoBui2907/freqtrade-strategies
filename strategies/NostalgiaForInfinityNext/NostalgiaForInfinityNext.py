...
class NostalgiaForInfinityNext(IStrategy):
    ...
    buy_protection_params = {
        ...
        5: {
            ...
            "sma200_1h_rising_val"      : CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=False, load=True),
            "safe_dips"                 : CategoricalParameter([True, False], default=True, space='entry', optimize=False, load=True),
            "safe_dips_type"            : CategoricalParameter(["10","50","100"], default="130", space='entry', optimize=False, load=True),
            "safe_pump"                 : CategoricalParameter([True, False], default=True, space='entry', optimize=False, load=True),
            "safe_pump_type"            : CategoricalParameter(["10","50","100"], default="30", space='entry', optimize=False, load=True),
            "safe_pump_period"          : CategoricalParameter(["24","36","48"], default="36", space='entry', optimize=False, load=True),
            "btc_1h_not_downtrend"      : CategoricalParameter([True, False], default=False, space='entry', optimize=False, load=True)
        },
        6: {
        ...
        26: {
            ...
            "sma200_1h_rising_val"      : CategoricalParameter(["20","30","36","44","50"], default="50", space='entry', optimize=False, load=True),
            "safe_dips"                 : CategoricalParameter([True, False], default=True, space='entry', optimize=False, load=True),
            "safe_dips_type"            : CategoricalParameter(["10","50","100"], default="60", space='entry', optimize=False, load=True),
            "safe_pump"                 : CategoricalParameter([True, False], default=True, space='entry', optimize=False, load=True),
            "safe_pump_type"            : CategoricalParameter(["10","50","100"], default="100", space='entry', optimize=False, load=True),
            "safe_pump_period"          : CategoricalParameter(["24","36","48"], default="48", space='entry', optimize=False, load=True),
            "btc_1h_not_downtrend"      : CategoricalParameter([True, False], default=False, space='entry', optimize=False, load=True)
    ...
    buy_min_inc_1 = DecimalParameter(0.01, 0.05, default=0.021, space='entry', decimals=3, optimize=False, load=True)
    ...
    buy_rsi_1 = DecimalParameter(20.0, 40.0, default=35.4, space='entry', decimals=1, optimize=False, load=True)
    buy_mfi_1 = DecimalParameter(20.0, 40.0, default=50.0, space='entry', decimals=1, optimize=False, load=True)
    buy_cti_1 = DecimalParameter(-0.99, -0.5, default=-0.87, space='entry', decimals=2, optimize=False, load=True)
    ...
    buy_bb40_closedelta_close_3 = DecimalParameter(0.01, 0.03, default=0.022, space='entry', optimize=False, load=True)
    ...
    buy_cti_3 = DecimalParameter(-0.99, -0.5, default=-0.9, space='entry', decimals=2, optimize=False, load=True)
    ...
    buy_cti_4 = DecimalParameter(-0.99, -0.5, default=-0.68, space='entry', decimals=2, optimize=False, load=True)
    ...
    buy_ema_rel_5 = DecimalParameter(0.97, 0.999, default=0.938, space='entry', decimals=3, optimize=False, load=True)
    ...
    buy_ema_open_mult_7 = DecimalParameter(0.02, 0.04, default=0.031, space='entry', decimals=3, optimize=False, load=True)
    ...
    buy_min_inc_11 = DecimalParameter(0.005, 0.05, default=0.02, space='entry', decimals=3, optimize=False, load=True)
    ...
    buy_rsi_11 = DecimalParameter(34.0, 50.0, default=44.0, space='entry', decimals=1, optimize=False, load=True)
    buy_mfi_11 = DecimalParameter(30.0, 46.0, default=36.0, space='entry', decimals=1, optimize=False, load=True)

    buy_ma_offset_12 = DecimalParameter(0.93, 0.97, default=0.907, space='entry', decimals=3, optimize=False, load=True)
    buy_rsi_12 = DecimalParameter(26.0, 40.0, default=34.0, space='entry', decimals=1, optimize=False, load=True)
    ...
    buy_cti_13 = DecimalParameter(-0.99, -0.5, default=-0.74, space='entry', decimals=2, optimize=False, load=True)
    buy_ewo_13 = DecimalParameter(-14.0, -7.0, default=-9.6, space='entry', decimals=1, optimize=False, load=True)
    ...
    buy_ma_offset_15 = DecimalParameter(0.93, 0.99, default=0.96, space='entry', decimals=3, optimize=False, load=True)
    buy_rsi_15 = DecimalParameter(20.0, 36.0, default=28.0, space='entry', decimals=1, optimize=False, load=True)
    buy_ema_rel_15 = DecimalParameter(0.97, 0.999, default=0.977, space='entry', decimals=3, optimize=False, load=True)
    ...
    buy_ma_offset_17 = DecimalParameter(0.93, 0.98, default=0.94, space='entry', decimals=3, optimize=False, load=True)
    buy_ewo_17 = DecimalParameter(-18.0, -10.0, default=-12.4, space='entry', decimals=1, optimize=False, load=True)
    buy_cti_17 = DecimalParameter(-0.99, -0.5, default=-0.92, space='entry', decimals=2, optimize=False, load=True)
    buy_volume_17 = DecimalParameter(0.6, 6.0, default=2.0, space='entry', decimals=1, optimize=False, load=True)

    buy_rsi_18 = DecimalParameter(16.0, 32.0, default=30.0, space='entry', decimals=1, optimize=False, load=True)
    buy_bb_offset_18 = DecimalParameter(0.98, 1.0, default=0.985, space='entry', decimals=3, optimize=False, load=True)
    buy_volume_18 = DecimalParameter(0.6, 6.0, default=2.0, space='entry', decimals=1, optimize=False, load=True)
    buy_cti_18 = DecimalParameter(-0.99, -0.5, default=-0.82, space='entry', decimals=2, optimize=False, load=True)

    buy_rsi_1h_min_19 = DecimalParameter(40.0, 70.0, default=30.0, space='entry', decimals=1, optimize=False, load=True)
    buy_chop_min_19 = DecimalParameter(20.0, 60.0, default=23.0, space='entry', decimals=1, optimize=False, load=True)
    ...
    buy_cti_20 = DecimalParameter(-0.99, -0.5, default=-0.9, space='entry', decimals=2, optimize=False, load=True)
    ...
    buy_ma_offset_22 = DecimalParameter(0.93, 0.98, default=0.946, space='entry', decimals=3, optimize=False, load=True)
    buy_ewo_22 = DecimalParameter(2.0, 10.0, default=6.2, space='entry', decimals=1, optimize=False, load=True)
    buy_rsi_22 = DecimalParameter(26.0, 56.0, default=37.0, space='entry', decimals=1, optimize=False, load=True)

    buy_bb_offset_23 = DecimalParameter(0.97, 1.0, default=0.983, space='entry', decimals=3, optimize=False, load=True)
    ...
    buy_26_cti = DecimalParameter(-0.99, -0.4, default=-0.8, space='entry', decimals=2, optimize=False, load=True)
    buy_26_volume = DecimalParameter(0.6, 6.0, default=1.2, space='entry', decimals=1, optimize=False, load=True)

    buy_27_wr_max = DecimalParameter(95, 99, default=99.0, space='entry', decimals=1, optimize=False, load=True)
    buy_27_wr_1h_max = DecimalParameter(90, 99, default=97.6, space='entry', decimals=1, optimize=False, load=True)
    buy_27_rsi_max = DecimalParameter(40, 70, default=50, space='entry', decimals=0, optimize=False, load=True)
    buy_27_cti = DecimalParameter(-0.99, -0.4, default=-0.9, space='entry', decimals=2, optimize=False, load=True)
    buy_27_volume = DecimalParameter(0.6, 6.0, default=2.0, space='entry', decimals=1, optimize=False, load=True)

    buy_28_ma_offset = DecimalParameter(0.90, 0.99, default=0.92, space='entry', optimize=False, load=True)
    buy_28_ewo = DecimalParameter(2.0, 14.0, default=12.4, space='entry', decimals=1, optimize=False, load=True)
    buy_28_rsi = DecimalParameter(24.0, 44.0, default=38.0, space='entry', decimals=1, optimize=False, load=True)
    buy_28_cti = DecimalParameter(-0.99, -0.4, default=-0.6, space='entry', decimals=2, optimize=False, load=True)

    buy_29_ma_offset = DecimalParameter(0.90, 0.99, default=0.91, space='entry', optimize=False, load=True)
    buy_29_ewo = DecimalParameter(-14.0, -2.0, default=-4.0, space='entry', decimals=1, optimize=False, load=True)
    buy_29_cti = DecimalParameter(-0.99, -0.4, default=-0.82, space='entry', decimals=2, optimize=False, load=True)

    buy_30_ma_offset = DecimalParameter(0.90, 0.99, default=0.97, space='entry', optimize=False, load=True)
    buy_30_ewo = DecimalParameter(2.0, 14.0, default=7.8, space='entry', decimals=1, optimize=False, load=True)
    buy_30_rsi = DecimalParameter(24.0, 48.0, default=42.0, space='entry', decimals=1, optimize=False, load=True)
    buy_30_cti = DecimalParameter(-0.99, -0.4, default=-0.8, space='entry', decimals=2, optimize=False, load=True)
    ...
    buy_32_ma_offset = DecimalParameter(0.90, 0.99, default=0.946, space='entry', optimize=False, load=True)
    ...
    buy_33_ma_offset = DecimalParameter(0.90, 0.99, default=0.974, space='entry', optimize=False, load=True)
    ...
    buy_33_ewo = DecimalParameter(2.0, 14.0, default=9.0, space='entry', decimals=1, optimize=False, load=True)
    buy_33_volume = DecimalParameter(0.6, 6.0, default=2.0, space='entry', decimals=1, optimize=False, load=True)

    buy_34_ma_offset = DecimalParameter(0.90, 0.99, default=0.968, space='entry', optimize=False, load=True)
    buy_34_dip = DecimalParameter(0.001, 0.02, default=0.002, space='entry', decimals=3, optimize=False, load=True)
    buy_34_ewo = DecimalParameter(-24.0, -8.0, default=-20.0, space='entry', decimals=1, optimize=False, load=True)
    buy_34_cti = DecimalParameter(-0.99, -0.4, default=-0.88, space='entry', decimals=2, optimize=False, load=True)
    buy_34_volume = DecimalParameter(0.6, 6.0, default=1.1, space='entry', decimals=1, optimize=False, load=True)
    ...
    # Profit over EMA200
    sell_custom_profit_0 = DecimalParameter(0.01, 0.1, default=0.012, space='exit', decimals=3, optimize=False, load=True)
    ...
    sell_custom_rsi_6 = DecimalParameter(38.0, 55.0, default=52.0, space='exit', decimals=2, optimize=False, load=True)
    ...
    sell_custom_under_rsi_0 = DecimalParameter(28.0, 40.0, default=38.0, space='exit', decimals=1, optimize=False, load=True)
    ...
    def sell_trail_main(self, current_profit: float, last_candle, max_profit: float) -> tuple:
        if (self.sell_trail_profit_max_1.value > current_profit > self.sell_trail_profit_min_1.value) & (self.sell_trail_rsi_min_1.value < last_candle['rsi'] < self.sell_trail_rsi_max_1.value) & (max_profit > (current_profit + self.sell_trail_down_1.value)) & (last_candle['moderi_96'] is False):
