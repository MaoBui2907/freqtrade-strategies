...
class NFI7MOHO(IStrategy):
    ...
    buy_01_protection__ema_fast_len = CategoricalParameter(
        ...
        default="26",
        space="entry",
        optimize=buy_01_protections_optimize,
        load=True,
    )
    ...
    buy_02_protection__close_above_ema_fast_len = CategoricalParameter(
        ...
        default="200",
        space="entry",
        optimize=buy_02_protections_optimize,
        load=True,
    )
    ...
    buy_03_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"], default="50", space="entry", optimize=False, load=True
    )
    ...
    buy_04_protection__safe_dips_type = CategoricalParameter(
        ["10", "50", "100"], default="40", space="entry", optimize=False, load=True
    )
    ...
    buy_04_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"], default="20", space="entry", optimize=False, load=True
    )
    ...
    buy_10_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"], default="24", space="entry", optimize=False, load=True
    )
    ...
    buy_14_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"], default="30", space="entry", optimize=False, load=True
    )
    ...
    buy_18_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"], default="44", space="entry", optimize=False, load=True
    )
    buy_18_protection__sma200_1h_rising = CategoricalParameter(
        [True, False], default=True, space="entry", optimize=False, load=True
    )
    buy_18_protection__sma200_1h_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"], default="72", space="entry", optimize=False, load=True
    )
    ...
    buy_19_protection__sma200_rising_val = CategoricalParameter(
        ["20", "30", "36", "44", "50"], default="36", space="entry", optimize=False, load=True
    )
    ...
    buy_26_protection__ema_fast = CategoricalParameter(
        [True, False], default=False, space="entry", optimize=buy_26_protection__optimize, load=True
    )
    ...
    buy_26_protection__ema_slow = CategoricalParameter(
        [True, False], default=True, space="entry", optimize=buy_26_protection__optimize, load=True
    )
    ...
    buy_ema_rel_5 = DecimalParameter(
        0.97, 0.999, default=0.944, space="entry", decimals=3, optimize=False, load=True
    )
    ...
    buy_rsi_7 = DecimalParameter(
        24.0, 50.0, default=37.0, space="entry", decimals=1, optimize=False, load=True
    )
    ...
    buy_rsi_8 = DecimalParameter(
        16.0, 30.0, default=29.0, space="entry", decimals=1, optimize=False, load=True
    )
    ...
    buy_min_inc_11 = DecimalParameter(
        0.005, 0.05, default=0.01, space="entry", decimals=3, optimize=False, load=True
    )
    ...
    buy_rsi_11 = DecimalParameter(
        34.0, 50.0, default=48.0, space="entry", decimals=1, optimize=False, load=True
    )
    ...
    buy_ewo_13 = DecimalParameter(
        -14.0, -7.0, default=-11.4, space="entry", decimals=1, optimize=False, load=True
    )
    ...
    buy_ewo_17 = DecimalParameter(
        -18.0, -10.0, default=-12.8, space="entry", decimals=1, optimize=False, load=True
    )
    ...
    buy_rsi_20 = DecimalParameter(
        20.0, 36.0, default=27.0, space="entry", decimals=1, optimize=False, load=True
    )
    ...
    buy_ewo_22 = DecimalParameter(
        2.0, 10.0, default=4.2, space="entry", decimals=1, optimize=False, load=True
    )
    ...
    buy_bb_offset_23 = DecimalParameter(
        0.97, 1.0, default=0.987, space="entry", decimals=3, optimize=False, load=True
    )
    ...
    buy_24_rsi_max = DecimalParameter(
        26.0, 60.0, default=60.0, space="entry", decimals=1, optimize=False, load=True
    )
    ...
    buy_26_zema_low_offset = DecimalParameter(
        0.90, 0.99, default=0.93, space="entry", optimize=buy_26_parameters__optimize, load=True
    )
    ...
    sell_custom_under_rsi_0 = DecimalParameter(
        28.0, 40.0, default=35.0, space="exit", decimals=1, optimize=False, load=True
    )
    ...
    sell_trail_profit_min_1 = DecimalParameter(
        0.1, 0.2, default=0.16, space="exit", decimals=2, optimize=False, load=True
    )
    sell_trail_profit_max_1 = DecimalParameter(
        0.4, 0.7, default=0.6, space="exit", decimals=2, optimize=False, load=True
    )
    sell_trail_down_1 = DecimalParameter(
        0.01, 0.08, default=0.03, space="exit", decimals=3, optimize=False, load=True
    )
    ...
    sell_custom_stoploss_long_recover_1 = DecimalParameter(
        0.05, 0.15, default=0.1, space="exit", optimize=False, load=True
    )
    ...
    sell_custom_recover_profit_1 = DecimalParameter(
        0.01, 0.06, default=0.04, space="exit", decimals=3, optimize=False, load=True
    )
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        if self.buy_26_protection__close_above_ema_fast.value:
            buy_26_protections.append(
                dataframe["close"]
                > dataframe[f"ema_{self.buy_26_protection__close_above_ema_fast_len.value}"]
            )
        if self.buy_26_protection__close_above_ema_slow.value:
            buy_26_protections.append(
                dataframe["close"]
                > dataframe[f"ema_{self.buy_26_protection__close_above_ema_slow_len.value}_1h"]
            )
        if self.buy_26_protection__sma200_rising.value:
            buy_26_protections.append(
                dataframe["sma_200"]
                > dataframe["sma_200"].shift(int(self.buy_26_protection__sma200_rising_val.value))
            )
