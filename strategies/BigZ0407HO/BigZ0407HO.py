...
class BigZ0407HO(IStrategy):
    ...
    buy_bb20_close_bblowerband_safe_1 = DecimalParameter(0.7, 1.1, default=0.989, space='entry', optimize=buy_bb20_optimize, load=True)
    buy_bb20_close_bblowerband_safe_2 = DecimalParameter(0.7, 1.1, default=0.982, space='entry', optimize=buy_bb20_optimize, load=True)

    buy_volume_pump_optimize=False
    buy_volume_pump_1 = DecimalParameter(0.1, 0.9, default=0.4, space='entry', decimals=1, optimize=buy_volume_pump_optimize, load=True)
    buy_volume_drop_1 = DecimalParameter(1, 10, default=3.8, space='entry', decimals=1, optimize=buy_volume_pump_optimize, load=True)
    buy_volume_drop_2 = DecimalParameter(1, 10, default=3, space='entry', decimals=1, optimize=buy_volume_pump_optimize, load=True)
    buy_volume_drop_3 = DecimalParameter(1, 10, default=2.7, space='entry', decimals=1, optimize=buy_volume_pump_optimize, load=True)

    buy_rsi_1h_optimize_1=False
    buy_rsi_1h_optimize_2=False
    buy_rsi_1h_1 = DecimalParameter(10.0, 40.0, default=16.5, space='entry', decimals=1, optimize=buy_rsi_1h_optimize_1, load=True)
    buy_rsi_1h_2 = DecimalParameter(10.0, 40.0, default=15.0, space='entry', decimals=1, optimize=buy_rsi_1h_optimize_1, load=True)
    buy_rsi_1h_3 = DecimalParameter(10.0, 40.0, default=20.0, space='entry', decimals=1, optimize=buy_rsi_1h_optimize_1, load=True)
    buy_rsi_1h_4 = DecimalParameter(10.0, 40.0, default=35.0, space='entry', decimals=1, optimize=buy_rsi_1h_optimize_2, load=True)
    buy_rsi_1h_5 = DecimalParameter(10.0, 60.0, default=39.0, space='entry', decimals=1, optimize=buy_rsi_1h_optimize_2, load=True)

    buy_rsi_optimize=False
    buy_rsi_1 = DecimalParameter(10.0, 40.0, default=28.0, space='entry', decimals=1, optimize=buy_rsi_optimize, load=True)
    buy_rsi_2 = DecimalParameter(7.0, 40.0, default=10.0, space='entry', decimals=1, optimize=buy_rsi_optimize, load=True)
    buy_rsi_3 = DecimalParameter(7.0, 40.0, default=14.2, space='entry', decimals=1, optimize=buy_rsi_optimize, load=True)

    buy_macd_optimize=False
    buy_macd_1 = DecimalParameter(0.01, 0.09, default=0.02, space='entry', decimals=2, optimize=buy_macd_optimize, load=True)
    buy_macd_2 = DecimalParameter(0.01, 0.09, default=0.03, space='entry', decimals=2, optimize=buy_macd_optimize, load=True)

    buy_condition_12_optimize=False
    buy_condition_12_bblower_close = DecimalParameter(0.95, 0.995, default=0.993, space='entry', decimals=3, optimize=buy_condition_12_optimize, load=True)
    buy_condition_12_bblower_low = DecimalParameter(0.95, 0.99, default=0.985, space='entry', decimals=3, optimize=buy_condition_12_optimize, load=True)
    buy_condition_12_rsi_1h = DecimalParameter(60, 80, default=72.8, space='entry', decimals=1, optimize=buy_condition_12_optimize, load=True)

    buy_condition_11_optimize=False
    buy_condition_11_close_1 = DecimalParameter(0.05, 0.15, default=0.1, space='entry', decimals=3, optimize=buy_condition_11_optimize, load=True)
    buy_condition_11_close_2 = DecimalParameter(0.01, 0.03, default=0.018, space='entry', decimals=3, optimize=buy_condition_11_optimize, load=True)
    buy_condition_11_rsi = DecimalParameter(49, 53, default=51, space='entry', decimals=2, optimize=buy_condition_11_optimize, load=True)

    buy_condition_0_optimize=False
    buy_condition_0_rsi = DecimalParameter(26, 34, default=30, space='entry', decimals=1, optimize=buy_condition_0_optimize, load=True)
    buy_condition_0_close = DecimalParameter(1, 1.2, default=1.024, space='entry', decimals=3, optimize=buy_condition_0_optimize, load=True)
    buy_condition_0_rsi_1h = DecimalParameter(66, 76, default=71, space='entry', decimals=1, optimize=buy_condition_0_optimize, load=True)
    
    buy_condition_1_rsi_1h = DecimalParameter(63, 75, default=69, space='entry', decimals=1, optimize=False, load=True)
    
    buy_condition_10_optimize=False
    buy_condition_10_rsi = DecimalParameter(35, 45, default=40.5, space='entry', decimals=1, optimize=buy_condition_10_optimize, load=True)
    buy_condition_10_hist_close = DecimalParameter(0.0001, 0.01, default=0.0012, space='entry', decimals=4, optimize=buy_condition_10_optimize, load=True)

    custom_stoploss_optimize_1=False
    custom_stoploss_optimize_2=False
    custom_stoploss_minutes = IntParameter(50, 200, default=50, space='exit', optimize=
    ...
    sell_custom_stoploss_long_profit_min_1 = DecimalParameter(-0.1, -0.02, default=-0.08, space='exit', optimize=sell_custom_stoploss_long_optimize, load=True)
    sell_custom_stoploss_long_profit_max_1 = DecimalParameter(-0.06, -0.01, default=-0.04, space='exit', optimize=sell_custom_stoploss_long_optimize, load=True)
    sell_custom_stoploss_long_recover_1 = DecimalParameter(0.05, 0.15, default=0.1, space='exit', optimize=sell_custom_stoploss_long_optimize, load=True)
    sell_custom_stoploss_long_rsi_diff_1 = DecimalParameter(0.0, 20.0, default=4.0, space='exit', optimize=sell_custom_stoploss_long_optimize, load=True)

    sell_custom_stoploss_2_optimize=False
    # Long duration/recover stoploss 2
    sell_custom_stoploss_long_recover_2 = DecimalParameter(0.03, 0.15, default=0.06, space='exit', optimize=sell_custom_stoploss_2_optimize, load=True)
    sell_custom_stoploss_long_rsi_diff_2 = DecimalParameter(30.0, 50.0, default=40.0, space='exit', optimize=sell_custom_stoploss_2_optimize, load=True)
