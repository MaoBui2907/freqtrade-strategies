...
class NFI4Frog(IStrategy):
    ...
    sell_rsi_diff_5 = DecimalParameter(0.0, 20.0, default=4.382, space='exit', optimize=True, load=True)
    ...
    sell_custom_rsi_0 = DecimalParameter(30.0, 40.0, default=30.0, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_profit_1 = DecimalParameter(0.01, 0.1, default=0.03, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_rsi_1 = DecimalParameter(30.0, 50.0, default=36.0, space='exit', decimals=2, optimize=True, load=True)
    ...
    sell_custom_under_profit_2 = DecimalParameter(0.01, 0.10, default=0.035, space='exit', decimals=3, optimize=True, load=True)
    sell_custom_under_profit_3 = DecimalParameter(0.05, 0.2, default=0.07, space='exit', decimals=3, optimize=True, load=True)
