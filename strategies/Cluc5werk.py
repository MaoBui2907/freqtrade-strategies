...
class Cluc5werk(IStrategy):
    ...
    sell_params = {"sell-bbmiddle-close": 0.97103}
...
class Cluc5werk_ETH(Cluc5werk):
    ...
    # Sell hyperspace params:
    sell_params = {"sell-bbmiddle-close": 0.97181}
...
class Cluc5werk_BTC(Cluc5werk):
    ...
    # Sell hyperspace params:
    sell_params = {"sell-bbmiddle-close": 0.97906}
...
class Cluc5werk_USD(Cluc5werk):
    ...
    # Sell hyperspace params:
    sell_params = {"sell-bbmiddle-close": 0.97008}
