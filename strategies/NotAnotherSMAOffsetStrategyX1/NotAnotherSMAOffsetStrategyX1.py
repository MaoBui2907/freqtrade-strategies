...
class NotAnotherSMAOffsetStrategyX1(IStrategy):
    ...
    pPF_1 = DecimalParameter(
        0.008, 0.020, default=0.016, decimals=3, space="exit", optimize=True, load=True
    )
    pSL_1 = DecimalParameter(
        0.008, 0.020, default=0.011, decimals=3, space="exit", optimize=True, load=True
    )

    # profit threshold 2, SL_2 is used
    pPF_2 = DecimalParameter(
        0.040, 0.100, default=0.080, decimals=3, space="exit", optimize=True, load=True
    )
    pSL_2 = DecimalParameter(
        0.020, 0.070, default=0.040, decimals=3, space="exit", optimize=True, load=True
    )
