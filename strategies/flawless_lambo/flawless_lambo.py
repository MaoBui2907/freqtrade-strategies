...
class flawless_lambo(IStrategy):
    ...
    trailing_sell_max_stop = (
        0.01  # stop trailing sell if current_price < starting_price * (1+trailing_buy_max_stop)
    )
    ...
    def plot_config(self):
        return {
            "main_plot": {
                "bb.lower": {"color": "#9c6edc", "type": "line"},
                "bb.upper": {"color": "#9c6edc", "type": "line"},
                "vwma": {"color": "#4f9f02", "type": "line"},
            },
            "subplots": {
                "obv": {
                    "OBV": {"color": "#1b61ab", "type": "line"},
                    "OBVSlope": {"color": "#f18b7a", "type": "line"},
                },
                "vpci": {"vpci": {"color": "#d59a7a", "type": "line"}},
                "macd": {
                    "macd": {"color": "#1c3d6a", "type": "line"},
                    "macdsignal": {"color": "#873480", "type": "line"},
                    "macdhist": {"color": "#478a87", "type": "bar"},
                },
                "wiliams": {"williamspercent": {"color": "#10f551", "type": "line"}},
                "stoch + rsi": {
                    "rsi": {"color": "#d7affd", "type": "line"},
                    "slowd": {"color": "#d7cc5c", "type": "line"},
                    "fastk": {"color": "#186f86", "type": "line"},
                },
                "adx": {
                    "adx": {"color": "#c392cd", "type": "line"},
                    "plus.di": {"color": "#bcd6c5", "type": "line"},
                    "plus.di.slope": {"color": "#ffffff", "type": "line"},
                    "minus.di": {"color": "#eb044c", "type": "line"},
                },
            },
        }
