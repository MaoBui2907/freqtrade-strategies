...
class MultiMA_TSL3(IStrategy):
    ...
    base_nb_candles_buy_trima = IntParameter(
        5, 80, default=20, space="entry", optimize=optimize_buy_trima
    )
    low_offset_trima = DecimalParameter(
        0.9, 0.99, default=0.958, space="entry", optimize=optimize_buy_trima
    )
    ...
    base_nb_candles_buy_zema = IntParameter(
        5, 80, default=20, space="entry", optimize=optimize_buy_zema
    )
    low_offset_zema = DecimalParameter(
        0.9, 0.99, default=0.958, space="entry", optimize=optimize_buy_zema
    )
    ...
    base_nb_candles_buy_hma = IntParameter(
        5, 80, default=20, space="entry", optimize=optimize_buy_hma
    )
    low_offset_hma = DecimalParameter(
        0.9, 0.99, default=0.958, space="entry", optimize=optimize_buy_hma
    )
    ...
    rsi_buy = IntParameter(30, 70, default=50, space="entry", optimize=rsi_buy_optimize)
    rsi_buy2 = IntParameter(30, 70, default=50, space="entry", optimize=rsi_buy_optimize)
    buy_rsi_fast = IntParameter(0, 50, default=35, space="entry", optimize=True)
...
class MultiMA_TSL3a(MultiMA_TSL3):
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe = merge_informative_pair(
            dataframe, informative_15m, self.timeframe, self.timeframe_15m, ffill=True
        )
        drop_columns = [
            (s + "_" + self.timeframe_15m)
