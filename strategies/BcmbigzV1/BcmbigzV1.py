...
class BcmbigzV1(IStrategy):
    ...
    bzv7_buy_condition_0_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=False, load=True)
    bzv7_buy_condition_1_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=False, load=True)
    bzv7_buy_condition_2_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=False, load=True)
    bzv7_buy_condition_3_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=False, load=True)
    bzv7_buy_condition_4_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=False, load=True)
    bzv7_buy_condition_5_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=False, load=True)
    bzv7_buy_condition_6_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=False, load=True)
    bzv7_buy_condition_7_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=False, load=True)
    bzv7_buy_condition_8_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=False, load=True)
    bzv7_buy_condition_9_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=False, load=True)
    bzv7_buy_condition_10_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=False, load=True)
    bzv7_buy_condition_11_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=False, load=True)
    bzv7_buy_condition_12_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=False, load=True)
    bzv7_buy_condition_13_enable = CategoricalParameter([True, False], default=True, space='entry', optimize=False, load=True)

    bzv7_buy_bb20_close_bblowerband_safe_1 = DecimalParameter(0.7, 1.1, default=0.989, space='entry', optimize=False, load=True)
    bzv7_buy_bb20_close_bblowerband_safe_2 = DecimalParameter(0.7, 1.1, default=0.982, space='entry', optimize=False, load=True)

    bzv7_buy_volume_pump_1 = DecimalParameter(0.1, 0.9, default=0.4, space='entry', decimals=1, optimize=False, load=True)
    bzv7_buy_volume_drop_1 = DecimalParameter(1, 10, default=3.8, space='entry', decimals=1, optimize=False, load=True)
    bzv7_buy_volume_drop_2 = DecimalParameter(1, 10, default=3, space='entry', decimals=1, optimize=False, load=True)
    bzv7_buy_volume_drop_3 = DecimalParameter(1, 10, default=2.7, space='entry', decimals=1, optimize=False, load=True)

    bzv7_buy_rsi_1h_1 = DecimalParameter(10.0, 40.0, default=16.5, space='entry', decimals=1, optimize=False, load=True)
    bzv7_buy_rsi_1h_2 = DecimalParameter(10.0, 40.0, default=15.0, space='entry', decimals=1, optimize=False, load=True)
    bzv7_buy_rsi_1h_3 = DecimalParameter(10.0, 40.0, default=20.0, space='entry', decimals=1, optimize=False, load=True)
    bzv7_buy_rsi_1h_4 = DecimalParameter(10.0, 40.0, default=35.0, space='entry', decimals=1, optimize=False, load=True)
    bzv7_buy_rsi_1h_5 = DecimalParameter(10.0, 60.0, default=39.0, space='entry', decimals=1, optimize=False, load=True)

    bzv7_buy_rsi_1 = DecimalParameter(10.0, 40.0, default=28.0, space='entry', decimals=1, optimize=False, load=True)
    bzv7_buy_rsi_2 = DecimalParameter(7.0, 40.0, default=10.0, space='entry', decimals=1, optimize=False, load=True)
    bzv7_buy_rsi_3 = DecimalParameter(7.0, 40.0, default=14.2, space='entry', decimals=1, optimize=False, load=True)

    bzv7_buy_macd_1 = DecimalParameter(0.01, 0.09, default=0.02, space='entry', decimals=2, optimize=False, load=True)
    bzv7_buy_macd_2 = DecimalParameter(0.01, 0.09, default=0.03, space='entry', decimals=2, optimize=False, load=True)
