...
class NFI46Z(IStrategy):
    ...
    buy_condition_25_enable = CategoricalParameter(
        [True, False], default=True, space="entry", optimize=True, load=True
    )
    buy_condition_26_enable = CategoricalParameter(
        [True, False], default=True, space="entry", optimize=True, load=True
    )
    buy_condition_27_enable = CategoricalParameter(
        [True, False], default=True, space="entry", optimize=True, load=True
    )
    buy_condition_28_enable = CategoricalParameter(
        [True, False], default=True, space="entry", optimize=True, load=True
    )
    buy_condition_29_enable = CategoricalParameter(
        [True, False], default=True, space="entry", optimize=True, load=True
    )

    buy_bb20_close_bblowerband_safe_1 = DecimalParameter(
        0.7, 1.1, default=0.989, space="entry", optimize=True, load=True
    )
    buy_bb20_close_bblowerband_safe_2 = DecimalParameter(
        0.7, 1.1, default=0.982, space="entry", optimize=True, load=True
    )

    buy_volume_pump_1 = DecimalParameter(
        0.1, 0.9, default=0.4, space="entry", decimals=1, optimize=True, load=True
    )
    buy_volume_drop_1 = DecimalParameter(
        1, 10, default=3.8, space="entry", decimals=1, optimize=True, load=True
    )
    buy_volume_drop_2 = DecimalParameter(
        1, 10, default=3, space="entry", decimals=1, optimize=True, load=True
    )
    buy_volume_drop_3 = DecimalParameter(
        1, 10, default=2.7, space="entry", decimals=1, optimize=True, load=True
    )

    buy_rsi_1h_1 = DecimalParameter(
        10.0, 40.0, default=16.5, space="entry", decimals=1, optimize=True, load=True
    )
    buy_rsi_1h_2 = DecimalParameter(
        10.0, 40.0, default=15.0, space="entry", decimals=1, optimize=True, load=True
    )
    buy_rsi_1h_3 = DecimalParameter(
        10.0, 40.0, default=20.0, space="entry", decimals=1, optimize=True, load=True
    )
    buy_rsi_1h_4 = DecimalParameter(
        10.0, 40.0, default=35.0, space="entry", decimals=1, optimize=True, load=True
    )
    buy_rsi_1h_5 = DecimalParameter(
        10.0, 60.0, default=39.0, space="entry", decimals=1, optimize=True, load=True
    )

    buy_rsi_1 = DecimalParameter(
        10.0, 40.0, default=28.0, space="entry", decimals=1, optimize=True, load=True
    )
    buy_rsi_2 = DecimalParameter(
        7.0, 40.0, default=10.0, space="entry", decimals=1, optimize=True, load=True
    )
    buy_rsi_3 = DecimalParameter(
        7.0, 40.0, default=14.2, space="entry", decimals=1, optimize=True, load=True
    )

    buy_macd_1 = DecimalParameter(
        0.01, 0.09, default=0.02, space="entry", decimals=2, optimize=True, load=True
    )
    buy_macd_2 = DecimalParameter(
        0.01, 0.09, default=0.03, space="entry", decimals=2, optimize=True, load=True
    )
    ...
    buy_dip_threshold_6 = DecimalParameter(
        0.01, 0.2, default=0.06, space="entry", decimals=3, optimize=True, load=True
    )
    ...
    buy_dip_threshold_8 = DecimalParameter(
        0.2, 0.5, default=0.4, space="entry", decimals=3, optimize=True, load=True
    )
    # Loose dips
    ...
    buy_pump_threshold_1 = DecimalParameter(
        0.4, 1.0, default=0.46, space="entry", decimals=3, optimize=True, load=True
    )
    # 36 hours
    ...
    buy_pump_threshold_2 = DecimalParameter(
        0.4, 1.0, default=0.56, space="entry", decimals=3, optimize=True, load=True
    )
    # 48 hours
    ...
    buy_pump_threshold_4 = DecimalParameter(
        0.4, 1.0, default=0.4, space="entry", decimals=3, optimize=True, load=True
    )
    # 36 hours strict
    ...
    buy_pump_threshold_6 = DecimalParameter(
        0.4, 1.0, default=0.68, space="entry", decimals=3, optimize=True, load=True
    )
    # 24 hours loose
    ...
    buy_rsi_1h_max_1 = DecimalParameter(
        70.0, 90.0, default=80.0, space="entry", decimals=1, optimize=True, load=True
    )
    buy_rsi_1 = DecimalParameter(
        20.0, 40.0, default=36.0, space="entry", decimals=1, optimize=True, load=True
    )
    buy_mfi_1 = DecimalParameter(
        20.0, 56.0, default=26.0, space="entry", decimals=1, optimize=True, load=True
    )

    buy_volume_2 = DecimalParameter(
        1.0, 10.0, default=2.0, space="entry", decimals=1, optimize=True, load=True
    )
    buy_rsi_1h_min_2 = DecimalParameter(
        30.0, 40.0, default=36.0, space="entry", decimals=1, optimize=True, load=True
    )
    buy_rsi_1h_max_2 = DecimalParameter(
        70.0, 95.0, default=90.0, space="entry", decimals=1, optimize=True, load=True
    )
    buy_rsi_1h_diff_2 = DecimalParameter(
        30.0, 50.0, default=34.0, space="entry", decimals=1, optimize=True, load=True
    )
    buy_mfi_2 = DecimalParameter(
        30.0, 65.0, default=56.0, space="entry", decimals=1, optimize=True, load=True
    )
    buy_bb_offset_2 = DecimalParameter(
        0.97, 0.99, default=0.983, space="entry", decimals=3, optimize=True, load=True
    )
    ...
    buy_bb20_close_bblowerband_4 = DecimalParameter(
        0.9, 0.99, default=0.979, space="entry", optimize=True, load=True
    )
    buy_bb20_volume_4 = IntParameter(16, 35, default=18, space="entry", optimize=True, load=True)

    buy_volume_5 = DecimalParameter(
        1.0, 10.0, default=6.0, space="entry", decimals=1, optimize=True, load=True
    )
    buy_ema_open_mult_5 = DecimalParameter(
        0.016, 0.03, default=0.019, space="entry", decimals=3, optimize=True, load=True
    )
    buy_bb_offset_5 = DecimalParameter(
        0.98, 1.0, default=0.999, space="entry", decimals=3, optimize=True, load=True
    )
    ...
    buy_volume_6 = DecimalParameter(
        1.0, 10.0, default=1.5, space="entry", decimals=1, optimize=True, load=True
    )
    buy_ema_open_mult_6 = DecimalParameter(
        0.03, 0.04, default=0.025, space="entry", decimals=3, optimize=True, load=True
    )
    buy_bb_offset_6 = DecimalParameter(
        0.98, 0.999, default=0.995, space="entry", decimals=3, optimize=True, load=True
    )
    ...
    buy_rsi_8 = DecimalParameter(
        30.0, 50.0, default=46.0, space="entry", decimals=1, optimize=True, load=True
    )
    ...
    buy_volume_9 = DecimalParameter(
        1.0, 4.0, default=2.0, space="entry", decimals=2, optimize=True, load=True
    )
    buy_ma_offset_9 = DecimalParameter(
        0.94, 0.99, default=0.958, space="entry", decimals=3, optimize=True, load=True
    )
    buy_bb_offset_9 = DecimalParameter(
        0.97, 0.99, default=0.984, space="entry", decimals=3, optimize=True, load=True
    )
    ...
    buy_mfi_9 = DecimalParameter(
        36.0, 65.0, default=56.0, space="entry", decimals=1, optimize=True, load=True
    )

    buy_volume_10 = DecimalParameter(
        1.0, 26.0, default=23.0, space="entry", decimals=1, optimize=True, load=True
    )
    buy_ma_offset_10 = DecimalParameter(
        0.93, 0.97, default=0.94, space="entry", decimals=3, optimize=True, load=True
    )
    ...
    buy_rsi_1h_10 = DecimalParameter(
        20.0, 40.0, default=39.0, space="entry", decimals=1, optimize=True, load=True
    )

    buy_ma_offset_11 = DecimalParameter(
        0.93, 0.99, default=0.938, space="entry", decimals=3, optimize=True, load=True
    )
    ...
    buy_rsi_1h_min_11 = DecimalParameter(
        40.0, 60.0, default=55.0, space="entry", decimals=1, optimize=True, load=True
    )
    buy_rsi_1h_max_11 = DecimalParameter(
        70.0, 90.0, default=82.0, space="entry", decimals=1, optimize=True, load=True
    )
    buy_rsi_11 = DecimalParameter(
        30.0, 48.0, default=46.0, space="entry", decimals=1, optimize=True, load=True
    )
    buy_mfi_11 = DecimalParameter(
        36.0, 56.0, default=38.0, space="entry", decimals=1, optimize=True, load=True
    )
    ...
    buy_ma_offset_12 = DecimalParameter(
        0.93, 0.97, default=0.936, space="entry", decimals=3, optimize=True, load=True
    )
    ...
    buy_ewo_13 = DecimalParameter(
        -14.0, -7.0, default=-7.9, space="entry", decimals=1, optimize=True, load=True
    )
    ...
    buy_bb_offset_14 = DecimalParameter(
        0.98, 1.0, default=0.992, space="entry", decimals=3, optimize=True, load=True
    )
    buy_ma_offset_14 = DecimalParameter(
        0.93, 0.99, default=0.998, space="entry", decimals=3, optimize=True, load=True
    )

    buy_ema_open_mult_15 = DecimalParameter(
        0.02, 0.04, default=0.026, space="entry", decimals=3, optimize=True, load=True
    )
    buy_ma_offset_15 = DecimalParameter(
        0.93, 0.99, default=0.985, space="entry", decimals=3, optimize=True, load=True
    )
    buy_rsi_15 = DecimalParameter(
        30.0, 50.0, default=32.0, space="entry", decimals=1, optimize=True, load=True
    )
    ...
    buy_ma_offset_16 = DecimalParameter(
        0.93, 0.97, default=0.95, space="entry", decimals=3, optimize=True, load=True
    )
    buy_rsi_16 = DecimalParameter(
        26.0, 50.0, default=38.0, space="entry", decimals=1, optimize=True, load=True
    )
    buy_ewo_16 = DecimalParameter(
        4.0, 8.0, default=3.6, space="entry", decimals=1, optimize=True, load=True
    )

    buy_ma_offset_17 = DecimalParameter(
        0.93, 0.98, default=0.958, space="entry", decimals=3, optimize=True, load=True
    )
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        conditions.append(
            (
                ...
                & (dataframe["safe_dips_strict"])
                & (
                    dataframe["volume"].rolling(4).mean() * self.buy_volume_6.value
                    > dataframe["volume"]
                )
                & (dataframe["ema_26"] > dataframe["ema_12"])
                & (
