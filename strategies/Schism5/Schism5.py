...
class Schism5(IStrategy):
    ...
    buy_params = {"bear-buy-rsi": 49, "bull-buy-rsi": 39}

    sell_params = {"bear-sell-rsi": 86, "bull-sell-rsi": 86}
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        if trade_data["active_trade"]:
            ...
            conditions.append(
                (
                    (dataframe["bull"] > 0)
                    & qtpylib.crossed_below(dataframe["rsi"], params["bull-buy-rsi"])
                )
                | (
                    ~(dataframe["bull"] > 0)
                    & qtpylib.crossed_below(dataframe["rsi"], params["bear-buy-rsi"])
                )
            )
    ...
    def custom_stoploss(
        ...
        **kwargs,
        ...
        sl_pct = (
            1 - (max(min(since_open / timedelta(minutes=self.custom_stop_ramp_minutes), 1), 0)) ** 3
        )
