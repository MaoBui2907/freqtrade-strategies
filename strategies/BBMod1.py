...
class BBMod1(IStrategy):
    ...
    buy_clucha_close_bblower = DecimalParameter(
        0.0005, 0.02, default=0.00799, optimize=is_optimize_clucha
    )
    ...
    def normal_tf_indicators(self, dataframe: DataFrame) -> DataFrame:
        ...
        dataframe["pm"], dataframe["pmx"] = pmax(
            heikinashi, ma_type=1, length=9, multiplier=27, period=10, src=3
        )
        dataframe["source"] = (
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        is_clucha2 = (
            ...
            & (
                dataframe["ha_close"]
                < self.buy_clucha_close_bblower.value * dataframe["bb_lowerband2_40"]
            )
        )
...
def momdiv(
    ...
    upperband, middleband, lowerband = ta.BBANDS(
        mom, timeperiod=bb_length, nbdevup=bb_dev, nbdevdn=bb_dev, ma_type=0
    )
