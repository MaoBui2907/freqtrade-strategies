...
class CombinedBinHAndClucV8(IStrategy):
    ...
    sell_custom_roi_profit_1 = DecimalParameter(0.01, 0.03, default=0.01, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_roi_rsi_1 = DecimalParameter(40.0, 56.0, default=50, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_roi_profit_2 = DecimalParameter(0.01, 0.20, default=0.04, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_roi_rsi_2 = DecimalParameter(42.0, 56.0, default=50, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_roi_profit_3 = DecimalParameter(0.15, 0.30, default=0.08, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_roi_rsi_3 = DecimalParameter(44.0, 58.0, default=56, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_roi_profit_4 = DecimalParameter(0.3, 0.7, default=0.14, space='exit', decimals=2, optimize=False, load=True)
    ...
    sell_trail_profit_min_1 = DecimalParameter(0.1, 0.25, default=0.1, space='exit', decimals=3, optimize=False, load=True)
    sell_trail_profit_max_1 = DecimalParameter(0.3, 0.5, default=0.4, space='exit', decimals=2, optimize=False, load=True)
    sell_trail_down_1 = DecimalParameter(0.04, 0.1, default=0.03, space='exit', decimals=3, optimize=False, load=True)

    sell_trail_profit_min_2 = DecimalParameter(0.01, 0.1, default=0.02, space='exit', decimals=3, optimize=False, load=True)
    sell_trail_profit_max_2 = DecimalParameter(0.08, 0.25, default=0.1, space='exit', decimals=2, optimize=False, load=True)
    sell_trail_down_2 = DecimalParameter(0.04, 0.2, default=0.015, space='exit', decimals=3, optimize=False, load=True)

    sell_custom_stoploss_1 = DecimalParameter(-0.15, -0.03, default=-0.05, space='exit', decimals=2, optimize=False, load=True)

    sell_rsi_main = DecimalParameter(72.0, 90.0, default=80, space='exit', decimals=2, optimize=True, load=True)
