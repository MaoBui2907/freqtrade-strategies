...
class ClucHAwerk(IStrategy):
    ...
    sell_params = {"sell-bbmiddle-close": 1.01283, "sell-rocr-1h": 0.95269}
...
class ClucHAwerk_ETH(ClucHAwerk):
    ...
    # Sell hyperspace params:
    sell_params = {"sell-bbmiddle-close": 1.02894, "sell-rocr-1h": 0.94925}
...
class ClucHAwerk_BTC(ClucHAwerk):
    ...
    # Sell hyperspace params:
    sell_params = {"sell-bbmiddle-close": 0.98016, "sell-rocr-1h": 0.86823}
...
class ClucHAwerk_USD(ClucHAwerk):
    ...
    # Sell hyperspace params:
    sell_params = {"sell-bbmiddle-close": 1.06163, "sell-rocr-1h": 0.63285}
