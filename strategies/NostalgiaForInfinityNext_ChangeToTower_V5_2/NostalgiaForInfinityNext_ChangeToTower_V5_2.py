...
class NostalgiaForInfinityNext_ChangeToTower_V5_2(IStrategy):
    ...
    buy_dip_threshold_120_1 = DecimalParameter(0.001, 0.05, default=0.028, space='entry', decimals=3, optimize=False, load=True)
    buy_dip_threshold_120_2 = DecimalParameter(0.16, 0.3, default=0.28, space='entry', decimals=3, optimize=False, load=True)
    buy_dip_threshold_120_3 = DecimalParameter(0.3, 0.5, default=0.46, space='entry', decimals=3, optimize=False, load=True)
    buy_dip_threshold_120_4 = DecimalParameter(0.6, 1.0, default=0.86, space='entry', decimals=3, optimize=False, load=True)
    # Loose dips - level 130
    buy_dip_threshold_130_1 = DecimalParameter(0.001, 0.05, default=0.028, space='entry', decimals=3, optimize=False, load=True)
    buy_dip_threshold_130_2 = DecimalParameter(0.16, 0.34, default=0.3, space='entry', decimals=3, optimize=False, load=True)
    buy_dip_threshold_130_3 = DecimalParameter(0.36, 0.56, default=0.48, space='entry', decimals=3, optimize=False, load=True)
    buy_dip_threshold_130_4 = DecimalParameter(0.6, 1.0, default=0.9, space='entry', decimals=3, optimize=False, load=True)
    ...
    # 5 hours - level 10
    buy_dump_protection_10_5 = DecimalParameter(0.3, 0.8, default=0.4, space='entry', decimals=2, optimize=False, load=True)

    # 5 hours - level 20
    buy_dump_protection_20_5 = DecimalParameter(0.3, 0.8, default=0.44, space='entry', decimals=2, optimize=False, load=True)

    # 5 hours - level 30
    buy_dump_protection_30_5 = DecimalParameter(0.3, 0.8, default=0.50, space='entry', decimals=2, optimize=False, load=True)

    # 5 hours - level 40
    buy_dump_protection_40_5 = DecimalParameter(0.3, 0.8, default=0.58, space='entry', decimals=2, optimize=False, load=True)

    # 5 hours - level 50
    buy_dump_protection_50_5 = DecimalParameter(0.3, 0.8, default=0.66, space='entry', decimals=2, optimize=False, load=True)

    # 5 hours - level 60
    buy_dump_protection_60_5 = DecimalParameter(0.3, 0.8, default=0.74, space='entry', decimals=2, optimize=False, load=True)

    buy_min_inc_1 = DecimalParameter(0.01, 0.05, default=0.022, space='entry', decimals=3, optimize=False, load=True)
    buy_rsi_1h_min_1 = DecimalParameter(25.0, 40.0, default=20.0, space='entry', decimals=1, optimize=False, load=True)
    ...
    buy_mfi_1 = DecimalParameter(20.0, 40.0, default=50.0, space='entry', decimals=1, optimize=False, load=True)
    buy_cti_1 = DecimalParameter(-0.99, -0.5, default=-0.92, space='entry', decimals=2, optimize=False, load=True)
    ...
    buy_rsi_1h_diff_2 = DecimalParameter(30.0, 50.0, default=38.8, space='entry', decimals=1, optimize=False, load=True)
    ...
    buy_volume_2 = DecimalParameter(0.6, 6.0, default=1.6, space='entry', decimals=1, optimize=False, load=True)

    buy_bb40_bbdelta_close_3 = DecimalParameter(0.005, 0.06, default=0.045, space='entry', optimize=False, load=True)
    ...
    buy_cti_3 = DecimalParameter(-0.99, -0.5, default=-0.5, space='entry', decimals=2, optimize=False, load=True)
    ...
    buy_cti_4 = DecimalParameter(-0.99, -0.5, default=-0.8, space='entry', decimals=2, optimize=False, load=True)
    ...
    buy_ema_rel_5 = DecimalParameter(0.97, 0.999, default=0.915, space='entry', decimals=3, optimize=False, load=True)
    buy_cti_5 = DecimalParameter(-0.99, -0.5, default=-0.84, space='entry', decimals=2, optimize=False, load=True)
    buy_volume_5 = DecimalParameter(0.6, 6.0, default=1.8, space='entry', decimals=1, optimize=False, load=True)

    buy_ema_open_mult_6 = DecimalParameter(0.02, 0.03, default=0.021, space='entry', decimals=3, optimize=False, load=True)
    buy_bb_offset_6 = DecimalParameter(0.98, 0.999, default=0.976, space='entry', decimals=3, optimize=False, load=True)

    buy_ema_open_mult_7 = DecimalParameter(0.02, 0.04, default=0.030, space='entry', decimals=3, optimize=False, load=True)
    buy_cti_7 = DecimalParameter(-0.99, -0.5, default=-0.89, space='entry', decimals=2, optimize=False, load=True)

    buy_cti_8 = DecimalParameter(-0.99, -0.5, default=-0.88, space='entry', decimals=2, optimize=False, load=True)
    buy_rsi_8 = DecimalParameter(20.0, 50.0, default=40.0, space='entry', decimals=1, optimize=False, load=True)
    buy_bb_offset_8 = DecimalParameter(0.98, 1.0, default=0.99, space='entry', decimals=3, optimize=False, load=True)
    buy_rsi_1h_8 = DecimalParameter(40.0, 66.0, default=64.0, space='entry', decimals=1, optimize=False, load=True)
    buy_volume_8 = DecimalParameter(0.6, 6.0, default=1.8, space='entry', decimals=1, optimize=False, load=True)

    buy_ma_offset_9 = DecimalParameter(0.91, 0.94, default=0.968, space='entry', decimals=3, optimize=False, load=True)
    buy_bb_offset_9 = DecimalParameter(0.96, 0.98, default=0.942, space='entry', decimals=3, optimize=False, load=True)
    buy_rsi_1h_min_9 = DecimalParameter(26.0, 40.0, default=20.0, space='entry', decimals=1, optimize=False, load=True)
    ...
    buy_ma_offset_10 = DecimalParameter(0.94, 0.99, default=0.98, space='entry', decimals=3, optimize=False, load=True)
    buy_bb_offset_10 = DecimalParameter(0.97, 0.99, default=0.972, space='entry', decimals=3, optimize=False, load=True)
    buy_rsi_1h_10 = DecimalParameter(30.0, 60.0, default=50.0, space='entry', decimals=1, optimize=False, load=True)

    buy_ma_offset_11 = DecimalParameter(0.93, 0.99, default=0.946, space='entry', decimals=3, optimize=False, load=True)
    buy_min_inc_11 = DecimalParameter(0.005, 0.05, default=0.038, space='entry', decimals=3, optimize=False, load=True)
    buy_rsi_1h_min_11 = DecimalParameter(40.0, 60.0, default=46.0, space='entry', decimals=1, optimize=False, load=True)
    buy_rsi_1h_max_11 = DecimalParameter(70.0, 90.0, default=84.0, space='entry', decimals=1, optimize=False, load=True)
    buy_rsi_11 = DecimalParameter(34.0, 50.0, default=38.0, space='entry', decimals=1, optimize=False, load=True)
    buy_mfi_11 = DecimalParameter(30.0, 46.0, default=36.0, space='entry', decimals=1, optimize=False, load=True)

    buy_ma_offset_12 = DecimalParameter(0.93, 0.97, default=0.921, space='entry', decimals=3, optimize=False, load=True)
    buy_rsi_12 = DecimalParameter(26.0, 40.0, default=28.0, space='entry', decimals=1, optimize=False, load=True)
    buy_ewo_12 = DecimalParameter(1.0, 6.0, default=1.8, space='entry', decimals=1, optimize=False, load=True)
    buy_cti_12 = DecimalParameter(-0.99, -0.5, default=-0.7, space='entry', decimals=2, optimize=False, load=True)

    buy_ma_offset_13 = DecimalParameter(0.93, 0.98, default=0.99, space='entry', decimals=3, optimize=False, load=True)
    buy_cti_13 = DecimalParameter(-0.99, -0.5, default=-0.82, space='entry', decimals=2, optimize=False, load=True)
    buy_ewo_13 = DecimalParameter(-14.0, -7.0, default=-9.0, space='entry', decimals=1, optimize=False, load=True)
    ...
    buy_ma_offset_14 = DecimalParameter(0.93, 0.99, default=0.945, space='entry', decimals=3, optimize=False, load=True)
    buy_cti_14 = DecimalParameter(-0.99, -0.5, default=-0.86, space='entry', decimals=2, optimize=False, load=True)

    buy_ema_open_mult_15 = DecimalParameter(0.01, 0.03, default=0.024, space='entry', decimals=3, optimize=False, load=True)
    buy_ma_offset_15 = DecimalParameter(0.93, 0.99, default=0.958, space='entry', decimals=3, optimize=False, load=True)
    buy_rsi_15 = DecimalParameter(20.0, 36.0, default=28.0, space='entry', decimals=1, optimize=False, load=True)
    buy_ema_rel_15 = DecimalParameter(0.97, 0.999, default=0.974, space='entry', decimals=3, optimize=False, load=True)

    buy_ma_offset_16 = DecimalParameter(0.93, 0.97, default=0.953, space='entry', decimals=3, optimize=False, load=True)
    ...
    buy_cti_16 = DecimalParameter(-0.99, -0.5, default=-0.84, space='entry', decimals=2, optimize=False, load=True)

    buy_ma_offset_17 = DecimalParameter(0.93, 0.98, default=0.99, space='entry', decimals=3, optimize=False, load=True)
    buy_ewo_17 = DecimalParameter(-18.0, -10.0, default=-9.4, space='entry', decimals=1, optimize=False, load=True)
    buy_cti_17 = DecimalParameter(-0.99, -0.5, default=-0.96, space='entry', decimals=2, optimize=False, load=True)
    buy_volume_17 = DecimalParameter(0.6, 6.0, default=2.0, space='entry', decimals=1, optimize=False, load=True)

    buy_rsi_18 = DecimalParameter(20.0, 36.0, default=33.0, space='entry', decimals=1, optimize=False, load=True)
    buy_bb_offset_18 = DecimalParameter(0.98, 1.0, default=0.986, space='entry', decimals=3, optimize=False, load=True)
    buy_volume_18 = DecimalParameter(0.6, 6.0, default=2.0, space='entry', decimals=1, optimize=False, load=True)
    buy_cti_18 = DecimalParameter(-0.99, -0.5, default=-0.86, space='entry', decimals=2, optimize=False, load=True)

    buy_rsi_1h_min_19 = DecimalParameter(40.0, 70.0, default=30.0, space='entry', decimals=1, optimize=False, load=True)
    buy_chop_max_19 = DecimalParameter(20.0, 60.0, default=21.3, space='entry', decimals=1, optimize=False, load=True)

    buy_rsi_20 = DecimalParameter(20.0, 36.0, default=36.0, space='entry', decimals=1, optimize=False, load=True)
    buy_rsi_1h_20 = DecimalParameter(14.0, 30.0, default=16.0, space='entry', decimals=1, optimize=False, load=True)
    buy_cti_20 = DecimalParameter(-0.99, -0.5, default=-0.84, space='entry', decimals=2, optimize=False, load=True)
    buy_volume_20 = DecimalParameter(0.6, 6.0, default=2.0, space='entry', decimals=1, optimize=False, load=True)

    buy_rsi_21 = DecimalParameter(10.0, 28.0, default=14.0, space='entry', decimals=1, optimize=False, load=True)
    buy_rsi_1h_21 = DecimalParameter(18.0, 40.0, default=28.0, space='entry', decimals=1, optimize=False, load=True)
    buy_cti_21 = DecimalParameter(-0.99, -0.4, default=-0.9, space='entry', decimals=2, optimize=False, load=True)
    buy_volume_21 = DecimalParameter(0.6, 6.0, default=2.0, space='entry', decimals=1, optimize=False, load=True)

    buy_volume_22 = DecimalParameter(0.5, 6.0, default=2.0, space='entry', decimals=1, optimize=False, load=True)
    buy_bb_offset_22 = DecimalParameter(0.98, 1.0, default=0.984, space='entry', decimals=3, optimize=False, load=True)
    buy_ma_offset_22 = DecimalParameter(0.93, 0.98, default=0.942, space='entry', decimals=3, optimize=False, load=True)
    buy_ewo_22 = DecimalParameter(2.0, 10.0, default=5.8, space='entry', decimals=1, optimize=False, load=True)
    buy_rsi_22 = DecimalParameter(26.0, 56.0, default=36.0, space='entry', decimals=1, optimize=False, load=True)

    buy_bb_offset_23 = DecimalParameter(0.97, 1.0, default=0.985, space='entry', decimals=3, optimize=False, load=True)
    buy_ewo_23 = DecimalParameter(2.0, 10.0, default=6.2, space='entry', decimals=1, optimize=False, load=True)
    buy_rsi_23 = DecimalParameter(20.0, 40.0, default=32.4, space='entry', decimals=1, optimize=False, load=True)
    buy_rsi_1h_23 = DecimalParameter(60.0, 80.0, default=70.0, space='entry', decimals=1, optimize=False, load=True)

    buy_24_rsi_max = DecimalParameter(26.0, 60.0, default=50.0, space='entry', decimals=1, optimize=False, load=True)
    buy_24_rsi_1h_min = DecimalParameter(40.0, 90.0, default=66.9, space='entry', decimals=1, optimize=False, load=True)

    buy_25_ma_offset = DecimalParameter(0.90, 0.99, default=0.922, space='entry', optimize=False, load=True)
    buy_25_rsi_4 = DecimalParameter(26.0, 40.0, default=38.0, space='entry', decimals=1, optimize=False, load=True)
    buy_25_cti = DecimalParameter(-0.99, -0.4, default=-0.76, space='entry', decimals=2, optimize=False, load=True)

    buy_26_zema_low_offset = DecimalParameter(0.90, 0.99, default=0.932, space='entry', optimize=False, load=True)
    buy_26_cti = DecimalParameter(-0.99, -0.4, default=-0.82, space='entry', decimals=2, optimize=False, load=True)
    buy_26_volume = DecimalParameter(0.6, 6.0, default=1.2, space='entry', decimals=1, optimize=False, load=True)

    buy_27_wr_max = DecimalParameter(90, 99, default=90.0, space='entry', decimals=1, optimize=False, load=True)
    buy_27_wr_1h_max = DecimalParameter(90, 99, default=90.0, space='entry', decimals=1, optimize=False, load=True)
    buy_27_rsi_max = DecimalParameter(40, 70, default=50, space='entry', decimals=0, optimize=False, load=True)
    buy_27_cti = DecimalParameter(-0.99, -0.4, default=-0.93, space='entry', decimals=2, optimize=False, load=True)
    buy_27_volume = DecimalParameter(0.6, 6.0, default=2.0, space='entry', decimals=1, optimize=False, load=True)

    buy_28_ma_offset = DecimalParameter(0.90, 0.99, default=0.97, space='entry', optimize=False, load=True)
    buy_28_ewo = DecimalParameter(2.0, 14.0, default=7.2, space='entry', decimals=1, optimize=False, load=True)
    buy_28_rsi = DecimalParameter(24.0, 44.0, default=32.5, space='entry', decimals=1, optimize=False, load=True)
    buy_28_cti = DecimalParameter(-0.99, -0.4, default=-0.9, space='entry', decimals=2, optimize=False, load=True)

    buy_29_ma_offset = DecimalParameter(0.90, 0.99, default=0.94, space='entry', optimize=False, load=True)
    buy_29_ewo = DecimalParameter(-14.0, -2.0, default=-4.0, space='entry', decimals=1, optimize=False, load=True)
    buy_29_cti = DecimalParameter(-0.99, -0.4, default=-0.95, space='entry', decimals=2, optimize=False, load=True)

    buy_30_ma_offset = DecimalParameter(0.90, 0.99, default=0.97, space='entry', optimize=False, load=True)
    buy_30_ewo = DecimalParameter(2.0, 14.0, default=7.4, space='entry', decimals=1, optimize=False, load=True)
    buy_30_rsi = DecimalParameter(24.0, 48.0, default=40.0, space='entry', decimals=1, optimize=False, load=True)
    buy_30_cti = DecimalParameter(-0.99, -0.4, default=-0.88, space='entry', decimals=2, optimize=False, load=True)

    buy_31_ma_offset = DecimalParameter(0.90, 0.99, default=0.94, space='entry', optimize=False, load=True)
    buy_31_ewo = DecimalParameter(-22.0, -8.0, default=-19.0, space='entry', decimals=1, optimize=False, load=True)
    buy_31_wr = DecimalParameter(-99.9, -95.0, default=-98.4, space='entry', decimals=1, optimize=False, load=True)

    buy_32_ma_offset = DecimalParameter(0.90, 0.99, default=0.934, space='entry', optimize=False, load=True)
    buy_32_dip = DecimalParameter(0.001, 0.02, default=0.005, space='entry', decimals=3, optimize=False, load=True)
    buy_32_rsi = DecimalParameter(24.0, 50.0, default=46.0, space='entry', decimals=1, optimize=False, load=True)
    buy_32_cti = DecimalParameter(-0.99, -0.4, default=-0.8, space='entry', decimals=2, optimize=False, load=True)

    buy_33_ma_offset = DecimalParameter(0.90, 0.99, default=0.988, space='entry', optimize=False, load=True)
    buy_33_rsi = DecimalParameter(24.0, 50.0, default=32.0, space='entry', decimals=1, optimize=False, load=True)
    buy_33_cti = DecimalParameter(-0.99, -0.4, default=-0.9, space='entry', decimals=2, optimize=False, load=True)
    buy_33_ewo = DecimalParameter(2.0, 14.0, default=6.5, space='entry', decimals=1, optimize=False, load=True)
    buy_33_volume = DecimalParameter(0.6, 6.0, default=2.0, space='entry', decimals=1, optimize=False, load=True)

    buy_34_ma_offset = DecimalParameter(0.90, 0.99, default=0.93, space='entry', optimize=False, load=True)
    buy_34_dip = DecimalParameter(0.001, 0.02, default=0.005, space='entry', decimals=3, optimize=False, load=True)
    buy_34_ewo = DecimalParameter(-24.0, -5.0, default=-6.0, space='entry', decimals=1, optimize=False, load=True)
    buy_34_cti = DecimalParameter(-0.99, -0.4, default=-0.88, space='entry', decimals=2, optimize=False, load=True)
    buy_34_volume = DecimalParameter(0.6, 6.0, default=2.0, space='entry', decimals=1, optimize=False, load=True)
    ...
    # Profit over EMA200
    sell_custom_profit_bull_0 = DecimalParameter(0.01, 0.1, default=0.012, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bull_0 = DecimalParameter(30.0, 40.0, default=34.0, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_profit_bull_1 = DecimalParameter(0.01, 0.1, default=0.02, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bull_1 = DecimalParameter(30.0, 50.0, default=35.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_profit_bull_2 = DecimalParameter(0.01, 0.1, default=0.03, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bull_2 = DecimalParameter(30.0, 50.0, default=36.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_profit_bull_3 = DecimalParameter(0.01, 0.1, default=0.04, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bull_3 = DecimalParameter(30.0, 50.0, default=37.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_profit_bull_4 = DecimalParameter(0.01, 0.1, default=0.05, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bull_4 = DecimalParameter(35.0, 50.0, default=42.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_profit_bull_5 = DecimalParameter(0.01, 0.1, default=0.06, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bull_5 = DecimalParameter(35.0, 50.0, default=49.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_profit_bull_6 = DecimalParameter(0.01, 0.1, default=0.07, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bull_6 = DecimalParameter(38.0, 55.0, default=50.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_profit_bull_7 = DecimalParameter(0.01, 0.1, default=0.08, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bull_7 = DecimalParameter(40.0, 58.0, default=54.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_profit_bull_8 = DecimalParameter(0.06, 0.1, default=0.09, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bull_8 = DecimalParameter(40.0, 50.0, default=50.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_profit_bull_9 = DecimalParameter(0.05, 0.14, default=0.1, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bull_9 = DecimalParameter(40.0, 60.0, default=46.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_profit_bull_10 = DecimalParameter(0.1, 0.14, default=0.12, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bull_10 = DecimalParameter(38.0, 50.0, default=42.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_profit_bull_11 = DecimalParameter(0.16, 0.45, default=0.20, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bull_11 = DecimalParameter(28.0, 40.0, default=30.0, space='exit', decimals=2, optimize=False, load=True)

    sell_custom_profit_bear_0 = DecimalParameter(0.01, 0.1, default=0.012, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bear_0 = DecimalParameter(30.0, 40.0, default=34.0, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_profit_bear_1 = DecimalParameter(0.01, 0.1, default=0.02, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bear_1 = DecimalParameter(30.0, 50.0, default=35.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_profit_bear_2 = DecimalParameter(0.01, 0.1, default=0.03, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bear_2 = DecimalParameter(30.0, 50.0, default=37.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_profit_bear_3 = DecimalParameter(0.01, 0.1, default=0.04, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bear_3 = DecimalParameter(30.0, 50.0, default=44.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_profit_bear_4 = DecimalParameter(0.01, 0.1, default=0.05, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bear_4 = DecimalParameter(35.0, 50.0, default=48.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_profit_bear_5 = DecimalParameter(0.01, 0.1, default=0.06, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bear_5 = DecimalParameter(35.0, 50.0, default=50.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_rsi_over_bear_5 = DecimalParameter(70.0, 85.0, default=78.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_profit_bear_6 = DecimalParameter(0.01, 0.1, default=0.07, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bear_6 = DecimalParameter(38.0, 55.0, default=52.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_rsi_over_bear_6 = DecimalParameter(70.0, 85.0, default=78.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_profit_bear_7 = DecimalParameter(0.01, 0.1, default=0.08, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bear_7 = DecimalParameter(40.0, 58.0, default=54.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_rsi_over_bear_7 = DecimalParameter(70.0, 85.0, default=80.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_profit_bear_8 = DecimalParameter(0.06, 0.1, default=0.09, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bear_8 = DecimalParameter(40.0, 50.0, default=52.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_rsi_over_bear_8 = DecimalParameter(70.0, 85.0, default=82.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_profit_bear_9 = DecimalParameter(0.05, 0.14, default=0.1, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bear_9 = DecimalParameter(40.0, 60.0, default=50.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_profit_bear_10 = DecimalParameter(0.1, 0.14, default=0.12, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bear_10 = DecimalParameter(38.0, 50.0, default=42.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_profit_bear_11 = DecimalParameter(0.16, 0.45, default=0.20, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_rsi_under_bear_11 = DecimalParameter(28.0, 40.0, default=30.0, space='exit', decimals=2, optimize=False, load=True)

    # Profit under EMA200
    sell_custom_under_profit_bull_0 = DecimalParameter(0.01, 0.4, default=0.01, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_under_rsi_under_bull_0 = DecimalParameter(28.0, 40.0, default=38.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_under_profit_bull_1 = DecimalParameter(0.01, 0.10, default=0.02, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_under_rsi_under_bull_1 = DecimalParameter(36.0, 60.0, default=54.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_under_profit_bull_2 = DecimalParameter(0.01, 0.10, default=0.03, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_under_rsi_under_bull_2 = DecimalParameter(46.0, 66.0, default=55.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_under_profit_bull_3 = DecimalParameter(0.01, 0.10, default=0.04, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_under_rsi_under_bull_3 = DecimalParameter(50.0, 68.0, default=56.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_under_profit_bull_4 = DecimalParameter(0.02, 0.1, default=0.05, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_under_rsi_under_bull_4 = DecimalParameter(50.0, 68.0, default=57.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_under_profit_bull_5 = DecimalParameter(0.02, 0.1, default=0.06, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_under_rsi_under_bull_5 = DecimalParameter(46.0, 62.0, default=58.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_under_profit_bull_6 = DecimalParameter(0.03, 0.1, default=0.07, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_under_rsi_under_bull_6 = DecimalParameter(44.0, 60.0, default=48.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_under_profit_bull_7 = DecimalParameter(0.04, 0.1, default=0.08, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_under_rsi_under_bull_7 = DecimalParameter(46.0, 60.0, default=44.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_under_profit_bull_8 = DecimalParameter(0.06, 0.12, default=0.09, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_under_rsi_under_bull_8 = DecimalParameter(40.0, 58.0, default=42.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_under_profit_bull_9 = DecimalParameter(0.08, 0.14, default=0.1, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_under_rsi_under_bull_9 = DecimalParameter(40.0, 60.0, default=38.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_under_profit_bull_10 = DecimalParameter(0.1, 0.16, default=0.12, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_under_rsi_under_bull_10 = DecimalParameter(30.0, 50.0, default=34.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_under_profit_bull_11 = DecimalParameter(0.16, 0.3, default=0.2, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_under_rsi_under_bull_11 = DecimalParameter(24.0, 40.0, default=30.0, space='exit', decimals=1, optimize=False, load=True)

    sell_custom_under_profit_bear_0 = DecimalParameter(0.01, 0.4, default=0.01, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_under_rsi_under_bear_0 = DecimalParameter(28.0, 40.0, default=38.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_under_profit_bear_1 = DecimalParameter(0.01, 0.10, default=0.02, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_under_rsi_under_bear_1 = DecimalParameter(36.0, 60.0, default=59.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_under_profit_bear_2 = DecimalParameter(0.01, 0.10, default=0.03, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_under_rsi_under_bear_2 = DecimalParameter(46.0, 66.0, default=60.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_under_profit_bear_3 = DecimalParameter(0.01, 0.10, default=0.04, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_under_rsi_under_bear_3 = DecimalParameter(50.0, 68.0, default=61.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_under_profit_bear_4 = DecimalParameter(0.02, 0.1, default=0.05, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_under_rsi_under_bear_4 = DecimalParameter(50.0, 68.0, default=60.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_under_profit_bear_5 = DecimalParameter(0.02, 0.1, default=0.06, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_under_rsi_under_bear_5 = DecimalParameter(46.0, 62.0, default=58.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_under_rsi_over_bear_5 = DecimalParameter(70.0, 85.0, default=78.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_under_profit_bear_6 = DecimalParameter(0.03, 0.1, default=0.07, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_under_rsi_under_bear_6 = DecimalParameter(44.0, 60.0, default=50.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_under_rsi_over_bear_6 = DecimalParameter(70.0, 85.0, default=78.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_under_profit_bear_7 = DecimalParameter(0.04, 0.1, default=0.08, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_under_rsi_under_bear_7 = DecimalParameter(46.0, 60.0, default=46.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_under_rsi_over_bear_7 = DecimalParameter(70.0, 85.0, default=80.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_under_profit_bear_8 = DecimalParameter(0.06, 0.12, default=0.09, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_under_rsi_under_bear_8 = DecimalParameter(40.0, 58.0, default=42.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_under_rsi_over_bear_8 = DecimalParameter(70.0, 85.0, default=82.0, space='exit', decimals=2, optimize=False, load=True)
    sell_custom_under_profit_bear_9 = DecimalParameter(0.08, 0.14, default=0.1, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_under_rsi_under_bear_9 = DecimalParameter(40.0, 60.0, default=36.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_under_profit_bear_10 = DecimalParameter(0.1, 0.16, default=0.12, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_under_rsi_under_bear_10 = DecimalParameter(30.0, 50.0, default=34.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_under_profit_bear_11 = DecimalParameter(0.16, 0.3, default=0.2, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_under_rsi_under_bear_11 = DecimalParameter(24.0, 40.0, default=30.0, space='exit', decimals=1, optimize=False, load=True)
    ...
    sell_custom_pump_rsi_1_4 = DecimalParameter(36.0, 48.0, default=34.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_pump_profit_1_5 = DecimalParameter(0.14, 0.24, default=0.2, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_pump_rsi_1_5 = DecimalParameter(20.0, 40.0, default=30.0, space='exit', decimals=1, optimize=False, load=True)
    ...
    sell_custom_pump_rsi_2_3 = DecimalParameter(38.0, 50.0, default=42.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_pump_profit_2_4 = DecimalParameter(0.06, 0.12, default=0.1, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_pump_rsi_2_4 = DecimalParameter(36.0, 48.0, default=34.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_pump_profit_2_5 = DecimalParameter(0.14, 0.24, default=0.2, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_pump_rsi_2_5 = DecimalParameter(20.0, 40.0, default=30.0, space='exit', decimals=1, optimize=False, load=True)
    ...
    sell_custom_pump_rsi_3_3 = DecimalParameter(38.0, 50.0, default=42.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_pump_profit_3_4 = DecimalParameter(0.06, 0.12, default=0.1, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_pump_rsi_3_4 = DecimalParameter(36.0, 48.0, default=34.0, space='exit', decimals=1, optimize=False, load=True)
    sell_custom_pump_profit_3_5 = DecimalParameter(0.14, 0.24, default=0.2, space='exit', decimals=3, optimize=False, load=True)
    sell_custom_pump_rsi_3_5 = DecimalParameter(20.0, 40.0, default=30.0, space='exit', decimals=1, optimize=False, load=True)
    ...
    # Trail 1
    sell_trail_profit_min_1 = DecimalParameter(0.1, 0.2, default=0.03, space='exit', decimals=2, optimize=False, load=True)
    sell_trail_profit_max_1 = DecimalParameter(0.4, 0.7, default=0.05, space='exit', decimals=2, optimize=False, load=True)
    sell_trail_down_1 = DecimalParameter(0.01, 0.08, default=0.05, space='exit', decimals=3, optimize=False, load=True)
    sell_trail_rsi_min_1 = DecimalParameter(16.0, 36.0, default=10.0, space='exit', decimals=1, optimize=False, load=True)
    sell_trail_rsi_max_1 = DecimalParameter(30.0, 50.0, default=20.0, space='exit', decimals=1, optimize=False, load=True)
    ...
    # Trail 4
    sell_trail_profit_min_4 = DecimalParameter(0.01, 0.12, default=0.03, space='exit', decimals=3, optimize=False, load=True)
    sell_trail_profit_max_4 = DecimalParameter(0.02, 0.1, default=0.06, space='exit', decimals=2, optimize=False, load=True)
    sell_trail_down_4 = DecimalParameter(0.01, 0.06, default=0.02, space='exit', decimals=3, optimize=False, load=True)

    # Under & near EMA200, accept profit
    sell_custom_profit_under_profit_min_1 = DecimalParameter(0.0, 0.01, default=0.0, space='exit', optimize=False, load=True)
    sell_custom_profit_under_profit_max_1 = DecimalParameter(0.0, 0.05, default=0.02, space='exit', optimize=False, load=True)
    ...
    sell_custom_profit_under_profit_2 = DecimalParameter(0.0, 0.05, default=0.03, space='exit', optimize=False, load=True)
    sell_custom_profit_under_rel_2 = DecimalParameter(0.01, 0.04, default=0.024, space='exit', optimize=False, load=True)
    sell_custom_profit_under_rsi_diff_2 = DecimalParameter(0.0, 20.0, default=4.4, space='exit', optimize=False, load=True)

    # Under & near EMA200, take the loss
    sell_custom_stoploss_under_rel_1 = DecimalParameter(0.001, 0.02, default=0.002, space='exit', optimize=False, load=True)
    ...
    sell_custom_stoploss_long_recover_1 = DecimalParameter(0.05, 0.15, default=0.14, space='exit', optimize=False, load=True)
    ...
    sell_custom_stoploss_pump_max_profit_1 = DecimalParameter(0.01, 0.04, default=0.01, space='exit', decimals=3, optimize=False, load=True)
    ...
    # Recover
    sell_custom_recover_profit_1 = DecimalParameter(0.01, 0.06, default=0.06, space='exit', decimals=3, optimize=False, load=True)
    ...
    def sell_quick_mode(self, current_profit: float, max_profit:float, last_candle, previous_candle_1, trade: 'Trade', current_time: 'datetime') -> tuple:
        ...
        if (last_candle['zlema_4'] > last_candle['zlema_1']) and (previous_candle_1['zlema_4'] < previous_candle_1['zlema_1']) and (last_candle['cci'] > 200) and (last_candle['hrsi'] > 80) and (last_candle['moderi_32'] is True) and (current_profit > 0):
            return True, 'signal_profit_zlema_up'

        if (last_candle['zlema_4_std'] > last_candle['zlema_1_std']) and (previous_candle_1['zlema_4_std'] < previous_candle_1['zlema_1_std']) and (last_candle['cci'] > -100) and (last_candle['hrsi'] > 80) and (last_candle['moderi_32'] is False) and (current_profit > 0):
