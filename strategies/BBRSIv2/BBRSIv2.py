...
class BBRSIv2(IStrategy):
    ...
    plot_config = {
        "main_plot": {"bb_lowerband": {}, "bb_middleband": {}, "bb_upperband": {}, "tema": {}},
        "subplots": {
            "RSI": {"rsi": {"color": "blue"}},
            "MARKET": {
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe["pumped_by_percent"] = (dataframe["high"] - dataframe["close_min"]) / dataframe[
            "high"
        ]
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        if conditions:
            dataframe.loc[
                # can_sell &
                # is_live_data &
                reduce(lambda x, y: x | y, conditions), "exit_long"
            ] = 1
