...
class NostalgiaForInfinityNext_maximizer(IStrategy):
    ...
    def load_hold_trades_config(self):
        if self.hold_trades_cache is None:
            hold_trades_config_file = (
                NostalgiaForInfinityNext_maximizer.get_hold_trades_config_file()
            )
        ...
        if last_candle["close"] < last_candle["ema_200"]:
            if last_candle["moderi_96"]:
                if current_profit >= self.sell_custom_under_profit_bull_11:
                    ...
                    if (last_candle["rsi_14"] < self.sell_custom_under_rsi_under_bull_0) and (
                        last_candle["cmf"] < 0.0
                    ):
                ...
                if current_profit >= self.sell_custom_under_profit_bear_11:
                    ...
                    if (last_candle["rsi_14"] < self.sell_custom_under_rsi_under_bear_0) and (
                        last_candle["cmf"] < 0.0
                    ):
    ...
    def sell_dec_main(self, current_profit: float, last_candle) -> tuple:
        if (
            self.sell_custom_dec_profit_max_1 > current_profit >= self.sell_custom_dec_profit_min_1
        ) and (last_candle["sma_200_dec_20"]):
            return True, "signal_profit_d_1"
        elif (
            self.sell_custom_dec_profit_max_2 > current_profit >= self.sell_custom_dec_profit_min_2
    ...
    def sell_duration_main(
        ...
        if (
            ...
            self.sell_custom_long_profit_min_1 < current_profit < self.sell_custom_long_profit_max_1
        ) and (
    ...
    def sell_under_min(self, current_profit: float, last_candle) -> tuple:
        ...
        if (
            ...
            and (
                last_candle["rsi_14"]
                > last_candle["rsi_14_1h"] + self.sell_custom_profit_under_rsi_diff_2
            )
        ):
    ...
    def mark_profit_target(
        ...
        if self.profit_target_1_enable:
            if (
                ...
                and (
                    last_candle["rsi_14"]
                    > last_candle["rsi_14_1h"] + self.sell_custom_profit_under_rsi_diff_1
                )
            ):
    ...
    def sell_profit_target(
        ...
        if self.profit_target_1_enable:
            ...
            if (
                (last_candle["zlema_1_sell"] < last_candle["zlema_4_sell"])
                and (previous_candle_1["zlema_1_sell"] > previous_candle_1["zlema_4_sell"])
                and (last_candle["hrsi_sell"] > 90)
            ):
    ...
    def custom_exit(
        ...
        **kwargs,
        ...
        self.mark_profit_target(
            pair, trade, current_rate, current_profit, max_profit, last_candle, previous_candle_1
        )
        ...
        for index in self.buy_protection_params:
            ...
            if self.buy_params["buy_condition_" + str(index) + "_enable"]:
                ...
                # Condition #2
                    ...
                    # Logic
                    item_buy_logic.append(
                        dataframe["rsi_14"] < dataframe["rsi_14_1h"] - self.buy_rsi_1h_diff_2
                    )
                    item_buy_logic.append(dataframe["mfi"] < self.buy_mfi_2)
                    item_buy_logic.append(
                        dataframe["close"] < (dataframe["bb20_2_low"] * self.buy_bb_offset_2)
                    )
                    item_buy_logic.append(
                        dataframe["volume"] < (dataframe["volume_mean_4"] * self.buy_volume_2)
                    )
                ...
                # Condition #3
                    ...
                    # Non-Standard protections
                    item_buy_logic.append(
                        dataframe["close"] > (dataframe["ema_200_1h"] * self.buy_ema_rel_3)
                    )
                ...
                # Condition #4
                    ...
                    item_buy_logic.append(
                        dataframe["volume"]
                        < (dataframe["volume_mean_30"].shift(1) * self.buy_bb20_volume_4)
                    )
                ...
                # Condition #5
                    ...
                    # Non-Standard protections
                    item_buy_logic.append(
                        dataframe["close"] > (dataframe["ema_200_1h"] * self.buy_ema_rel_5)
                    )
                    ...
                    item_buy_logic.append(
                        dataframe["close"] < (dataframe["bb20_2_low"] * self.buy_bb_offset_5)
                    )
                    item_buy_logic.append(dataframe["cti"] < self.buy_cti_5)
                    item_buy_logic.append(
                        dataframe["volume"] < (dataframe["volume_mean_4"] * self.buy_volume_5)
                    )
                ...
                # Condition #6
                    ...
                    item_buy_logic.append(
                        dataframe["close"] < (dataframe["bb20_2_low"] * self.buy_bb_offset_6)
                    )
                ...
                # Condition #8
                    ...
                    item_buy_logic.append(
                        dataframe["close"] < (dataframe["bb20_2_low"] * self.buy_bb_offset_8)
                    )
                    item_buy_logic.append(dataframe["rsi_14_1h"] < self.buy_rsi_1h_8)
                    item_buy_logic.append(
                        dataframe["volume"] < (dataframe["volume_mean_4"] * self.buy_volume_8)
                    )
                ...
                # Condition #9
                    ...
                    item_buy_logic.append(
                        dataframe["close"] < dataframe["bb20_2_low"] * self.buy_bb_offset_9
                    )
                ...
                # Condition #10
                    ...
                    item_buy_logic.append(
                        dataframe["close"] < dataframe["bb20_2_low"] * self.buy_bb_offset_10
                    )
                ...
                # Condition #13
                    ...
                    # Logic
                    item_buy_logic.append(
                        dataframe["close"] < dataframe["sma_30"] * self.buy_ma_offset_13
                    )
                ...
                # Condition #14
                    ...
                    item_buy_logic.append(
                        dataframe["close"] < (dataframe["bb20_2_low"] * self.buy_bb_offset_14)
                    )
                    item_buy_logic.append(
                ...
                # Condition #15
                    ...
                    # Non-Standard protections
                    item_buy_logic.append(
                        dataframe["close"] > dataframe["ema_200_1h"] * self.buy_ema_rel_15
                    )
                ...
                # Condition #17
                    ...
                    # Logic
                    item_buy_logic.append(
                        dataframe["close"] < dataframe["ema_20"] * self.buy_ma_offset_17
                    )
                    item_buy_logic.append(dataframe["ewo"] < self.buy_ewo_17)
                    item_buy_logic.append(dataframe["cti"] < self.buy_cti_17)
                    item_buy_logic.append(
                        dataframe["volume"] < (dataframe["volume_mean_4"] * self.buy_volume_17)
                    )
                ...
                # Condition #18
                    ...
                    item_buy_logic.append(
                        dataframe["close"] < (dataframe["bb20_2_low"] * self.buy_bb_offset_18)
                    )
                    item_buy_logic.append(
                        dataframe["volume"] < (dataframe["volume_mean_4"] * self.buy_volume_18)
                    )
                ...
                # Condition #20
                    ...
                    item_buy_logic.append(
                        dataframe["volume"] < (dataframe["volume_mean_4"] * self.buy_volume_20)
                    )
                ...
                # Condition #21
                    ...
                    item_buy_logic.append(
                        dataframe["volume"] < (dataframe["volume_mean_4"] * self.buy_volume_21)
                    )
                ...
                # Condition #22
                    ...
                    # Logic
                    item_buy_logic.append(
                        (dataframe["volume_mean_4"] * self.buy_volume_22) > dataframe["volume"]
                    )
                    item_buy_logic.append(
                        dataframe["close"] < dataframe["sma_30"] * self.buy_ma_offset_22
                    )
                    item_buy_logic.append(
                        dataframe["close"] < (dataframe["bb20_2_low"] * self.buy_bb_offset_22)
                    )
                ...
                # Condition #23
                    ...
                    # Logic
                    item_buy_logic.append(
                        dataframe["close"] < (dataframe["bb20_2_low"] * self.buy_bb_offset_23)
                    )
                ...
                # Condition #25
                    ...
                    item_buy_logic.append(
                        dataframe["close"] < (dataframe["sma_20"] * self.buy_25_ma_offset)
                    )
                    item_buy_logic.append(
                        dataframe["open"] > (dataframe["sma_20"] * self.buy_25_ma_offset)
                    )
                    item_buy_logic.append(
                ...
                # Condition #26
                    ...
                    # Logic
                    item_buy_logic.append(
                        dataframe["close"] < (dataframe["zema_61"] * self.buy_26_zema_low_offset)
                    )
                    ...
                    item_buy_logic.append(
                        dataframe["volume"] < (dataframe["volume_mean_4"] * self.buy_26_volume)
                    )
                ...
                # Condition #27
                    ...
                    item_buy_logic.append(
                        dataframe["rsi_14_1h"] + dataframe["rsi_14"] < self.buy_27_rsi_max
                    )
                    item_buy_logic.append(dataframe["cti"] < self.buy_27_cti)
                    item_buy_logic.append(
                        dataframe["volume"] < (dataframe["volume_mean_4"] * self.buy_27_volume)
                    )
                ...
                # Condition #28
                    ...
                    item_buy_logic.append(dataframe["moderi_64"] is True)
                    item_buy_logic.append(
                        dataframe["close"] < dataframe["hull_75"] * self.buy_28_ma_offset
                    )
                ...
                # Condition #29
                    ...
                    item_buy_logic.append(dataframe["moderi_64"] is True)
                    item_buy_logic.append(
                        dataframe["close"] < dataframe["hull_75"] * self.buy_29_ma_offset
                    )
                ...
                # Condition #30
                    ...
                    item_buy_logic.append(
                        dataframe["close"] < dataframe["zlema_68"] * self.buy_30_ma_offset
                    )
                ...
                # Condition #33 - Quick mode buy
                    ...
                    item_buy_logic.append(
                        dataframe["close"] < (dataframe["ema_13"] * self.buy_33_ma_offset)
                    )
                    item_buy_logic.append(dataframe["ewo"] > self.buy_33_ewo)
                    item_buy_logic.append(dataframe["rsi_14"] < self.buy_33_rsi)
                    item_buy_logic.append(
                        dataframe["volume"] < (dataframe["volume_mean_4"] * self.buy_33_volume)
                    )
                ...
                # Condition #42
                    ...
                    item_buy_logic.append(
                        dataframe["close"] < (dataframe["bb20_2_low"] * self.buy_42_bb_offset)
                    )
    ...
    def _set_profit_target(self, pair: str, rate: float, sell_reason: str):
        self.custom_info[pair] = {"rate": rate, "sell_reason": sell_reason}
