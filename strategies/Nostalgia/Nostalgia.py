...
class Nostalgia(IStrategy):
    ...
    buy_tail_diff_8 = DecimalParameter(3.0, 10.0, default=2.5, space='entry', decimals=1, optimize=False, load=True)
    ...
    buy_chop_min_19 = DecimalParameter(20.0, 60.0, default=26.1, space='entry', decimals=1, optimize=False, load=True)
