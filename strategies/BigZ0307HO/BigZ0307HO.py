...
class BigZ0307HO(IStrategy):
    ...
    buy_condition_11_bb_middleband = DecimalParameter(1.001, 1.02, default=1.005, space='entry', decimals=3, optimize=buy_condition_11_optimize, load=True)
    buy_condition_11_rsi = DecimalParameter(60, 76, default=68, space='entry', decimals=2, optimize=buy_condition_11_optimize, load=True)
