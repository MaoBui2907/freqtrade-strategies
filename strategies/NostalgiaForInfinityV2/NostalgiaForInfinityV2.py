...
class NostalgiaForInfinityV2(IStrategy):
    ...
    buy_bb40_bbdelta_close = DecimalParameter(
        0.005, 0.05, default=0.049, space="entry", optimize=True, load=True
    )
