...
class ObeliskIM_v1_1(IStrategy):
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            qtpylib.crossed_above(dataframe["tenkan_sen"], dataframe["kijun_sen"]), "tk_cross_up"
        ] = 3
        ...
        dataframe["ema35_ok"] = (
            (dataframe["ema3"] > dataframe["ema5"]) & (dataframe["ema5"] > dataframe["ema10"])
        ).astype("int")
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        conditions.append(
            dataframe["close"] > dataframe["recent_high"].shift()
        )  # remove me for a "good time"
